...
log SimpleName MethodInvocation StringLiteral ==> atlas enum def store v delete by guids
log SimpleName MethodInvocation SimpleName guids
debug SimpleName MethodInvocation StringLiteral ==> atlas enum def store v delete by guids
debug SimpleName MethodInvocation SimpleName guids
==> atlas enum def store v delete by guids StringLiteral MethodInvocation SimpleName guids
