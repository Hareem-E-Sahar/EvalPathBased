...
log SimpleName MethodInvocation StringLiteral ==> atlas struct def store v get by guid
log SimpleName MethodInvocation SimpleName guid
debug SimpleName MethodInvocation StringLiteral ==> atlas struct def store v get by guid
debug SimpleName MethodInvocation SimpleName guid
==> atlas struct def store v get by guid StringLiteral MethodInvocation SimpleName guid
...
no struct def exists with guid StringLiteral InfixExpression SimpleName guid
atlas base exception SimpleName SimpleType ClassInstanceCreation InfixExpression StringLiteral no struct def exists with guid
...
<== atlas struct def store v get by guid {} StringLiteral MethodInvocation SimpleName guid
<== atlas struct def store v get by guid {} StringLiteral MethodInvocation SimpleName ret
...
atlas struct def SimpleName SimpleType MethodDeclaration SimpleName get by guid
