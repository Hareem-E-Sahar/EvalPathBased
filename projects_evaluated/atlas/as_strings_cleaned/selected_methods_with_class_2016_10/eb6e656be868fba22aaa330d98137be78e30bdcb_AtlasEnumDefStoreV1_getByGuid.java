...
log SimpleName MethodInvocation StringLiteral ==> atlas enum def store v get by guid
log SimpleName MethodInvocation SimpleName guid
debug SimpleName MethodInvocation StringLiteral ==> atlas enum def store v get by guid
debug SimpleName MethodInvocation SimpleName guid
==> atlas enum def store v get by guid StringLiteral MethodInvocation SimpleName guid
...
find type vertex by guid and category SimpleName MethodInvocation QualifiedName type categoryenum
guid SimpleName MethodInvocation QualifiedName type categoryenum
...
no enumdef exists with guid StringLiteral InfixExpression SimpleName guid
atlas base exception SimpleName SimpleType ClassInstanceCreation InfixExpression StringLiteral no enumdef exists with guid
...
<== atlas enum def store v get by guid {} StringLiteral MethodInvocation SimpleName guid
<== atlas enum def store v get by guid {} StringLiteral MethodInvocation SimpleName ret
...
atlas enum def SimpleName SimpleType MethodDeclaration SimpleName get by guid
