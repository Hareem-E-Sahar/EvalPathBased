...
log SimpleName MethodInvocation StringLiteral ==> atlas type registryadd types
log SimpleName MethodInvocation SimpleName types def
debug SimpleName MethodInvocation StringLiteral ==> atlas type registryadd types
debug SimpleName MethodInvocation SimpleName types def
==> atlas type registryadd types StringLiteral MethodInvocation SimpleName types def
types def SimpleName MethodInvocation SimpleName get enum defs
add types with no ref resolve SimpleName MethodInvocation MethodInvocation SimpleName types def
add types with no ref resolve SimpleName MethodInvocation MethodInvocation SimpleName get enum defs
types def SimpleName MethodInvocation SimpleName get struct defs
add types with no ref resolve SimpleName MethodInvocation MethodInvocation SimpleName types def
add types with no ref resolve SimpleName MethodInvocation MethodInvocation SimpleName get struct defs
types def SimpleName MethodInvocation SimpleName get classification defs
add types with no ref resolve SimpleName MethodInvocation MethodInvocation SimpleName types def
add types with no ref resolve SimpleName MethodInvocation MethodInvocation SimpleName get classification defs
types def SimpleName MethodInvocation SimpleName get entity defs
add types with no ref resolve SimpleName MethodInvocation MethodInvocation SimpleName types def
add types with no ref resolve SimpleName MethodInvocation MethodInvocation SimpleName get entity defs
log SimpleName MethodInvocation SimpleName is debug enabled
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation StringLiteral <== atlas type registryadd types
log SimpleName MethodInvocation SimpleName types def
...
add types SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName atlas types def
add types SimpleName MethodDeclaration SingleVariableDeclaration SimpleName types def
