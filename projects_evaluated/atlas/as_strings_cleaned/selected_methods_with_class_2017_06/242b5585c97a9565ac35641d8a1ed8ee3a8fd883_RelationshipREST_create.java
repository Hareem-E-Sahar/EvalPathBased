...
relationship restcreate StringLiteral InfixExpression SimpleName relationship
relationship restcreate StringLiteral InfixExpression StringLiteral )
...
atlas perf tracer SimpleName MethodInvocation SimpleName perf log
atlas perf tracer SimpleName MethodInvocation InfixExpression StringLiteral relationship restcreate
...
get perf tracer SimpleName MethodInvocation InfixExpression StringLiteral relationship restcreate
...
perf log SimpleName MethodInvocation InfixExpression StringLiteral relationship restcreate
...
perf SimpleName Assignment MethodInvocation InfixExpression StringLiteral relationship restcreate
...
post SimpleName MarkerAnnotation MethodDeclaration SimpleType SimpleName atlas relationship
post SimpleName MarkerAnnotation MethodDeclaration SimpleName create
...
consumes SimpleName SingleMemberAnnotation MethodDeclaration SimpleName create
servletsjson media type QualifiedName SingleMemberAnnotation MethodDeclaration SimpleName create
...
servletsjson media type QualifiedName SingleMemberAnnotation MethodDeclaration SimpleType SimpleName atlas relationship
produces SimpleName SingleMemberAnnotation MethodDeclaration SimpleName create
servletsjson media type QualifiedName SingleMemberAnnotation MethodDeclaration SimpleName create
