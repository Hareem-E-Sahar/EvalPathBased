...
create unique required attr def SimpleName MethodInvocation StringLiteral managed type
create unique required attr def SimpleName MethodInvocation SimpleName managed type
...
types util SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName create unique required attr def
...
name StringLiteral MethodInvocation MethodInvocation MethodInvocation SimpleName create unique required attr def
...
data typesstring type QualifiedName MethodInvocation MethodInvocation MethodInvocation SimpleName create unique required attr def
...
verify system composite index SimpleName MethodInvocation StringLiteral databasename
verify system composite index SimpleName MethodInvocation BooleanLiteral false
management system SimpleName MethodInvocation StringLiteral databasename
management system SimpleName MethodInvocation BooleanLiteral false
databasename StringLiteral MethodInvocation BooleanLiteral false
verify vertex index contains SimpleName MethodInvocation SimpleName management system
verify vertex index contains SimpleName MethodInvocation StringLiteral databasename
management system SimpleName MethodInvocation StringLiteral databasename
verify system composite index SimpleName MethodInvocation SimpleName management system
verify system composite index SimpleName MethodInvocation StringLiteral databasemanaged type
verify system composite index SimpleName MethodInvocation BooleanLiteral false
management system SimpleName MethodInvocation StringLiteral databasemanaged type
management system SimpleName MethodInvocation BooleanLiteral false
databasemanaged type StringLiteral MethodInvocation BooleanLiteral false
verify vertex index contains SimpleName MethodInvocation SimpleName management system
