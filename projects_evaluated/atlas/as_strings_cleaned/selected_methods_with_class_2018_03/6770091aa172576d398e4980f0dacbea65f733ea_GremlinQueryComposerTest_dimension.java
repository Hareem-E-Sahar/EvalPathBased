expected SimpleName VariableDeclarationFragment StringLiteral gvhas type name tableorhas trait names withindimension has propagated trait names withindimensiondeduplimit to list
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName expected
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment StringLiteral gvhas type name tableorhas trait names withindimension has propagated trait names withindimensiondeduplimit to list
