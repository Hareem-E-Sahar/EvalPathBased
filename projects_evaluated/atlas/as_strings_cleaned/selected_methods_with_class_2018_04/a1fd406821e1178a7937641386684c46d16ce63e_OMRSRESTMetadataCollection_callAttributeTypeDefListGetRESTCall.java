...
rest result SimpleName VariableDeclarationFragment ClassInstanceCreation SimpleType SimpleName attribute type def list response
attribute type def list response SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName rest result
...
private Modifier MethodDeclaration SimpleType SimpleName attribute type def list response
private Modifier MethodDeclaration SimpleName call attribute type def list get rest call
...
attribute type def list response SimpleName SimpleType MethodDeclaration SimpleName call attribute type def list get rest call
attribute type def list response SimpleName SimpleType MethodDeclaration SingleVariableDeclaration SimpleName method name
attribute type def list response SimpleName SimpleType MethodDeclaration SingleVariableDeclaration SimpleName url template
attribute type def list response SimpleName SimpleType MethodDeclaration SingleVariableDeclaration SimpleName params
attribute type def list response SimpleName SimpleType MethodDeclaration SimpleType SimpleName repository error exception
call attribute type def list get rest call SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
call attribute type def list get rest call SimpleName MethodDeclaration SingleVariableDeclaration SimpleName method name
call attribute type def list get rest call SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
call attribute type def list get rest call SimpleName MethodDeclaration SingleVariableDeclaration SimpleName url template
call attribute type def list get rest call SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName object
call attribute type def list get rest call SimpleName MethodDeclaration SingleVariableDeclaration SimpleName params
call attribute type def list get rest call SimpleName MethodDeclaration SimpleType SimpleName repository error exception
call attribute type def list get rest call SimpleName MethodDeclaration Block ReturnStatement SimpleName rest result
...
public Modifier TypeDeclaration MethodDeclaration SimpleName call attribute type def list get rest call
...
test SimpleName TypeDeclaration MethodDeclaration SimpleName call attribute type def list get rest call
