...
error code SimpleName VariableDeclarationFragment QualifiedName omag error codenull local server name
omag error code SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName error code
omag error code SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment QualifiedName omag error codenull local server name
...
private Modifier MethodDeclaration SimpleName validate server name
...
void PrimitiveType MethodDeclaration SimpleName validate server name
...
validate server name SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
validate server name SimpleName MethodDeclaration SingleVariableDeclaration SimpleName server name
validate server name SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
validate server name SimpleName MethodDeclaration SingleVariableDeclaration SimpleName method name
validate server name SimpleName MethodDeclaration SimpleType SimpleName omag invalid parameter exception
...
public Modifier TypeDeclaration MethodDeclaration SimpleName validate server name
...
test SimpleName TypeDeclaration MethodDeclaration SimpleName validate server name
