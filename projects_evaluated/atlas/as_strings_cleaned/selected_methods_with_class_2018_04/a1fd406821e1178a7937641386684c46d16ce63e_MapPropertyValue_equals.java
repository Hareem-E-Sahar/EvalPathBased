...
map property value SimpleName SimpleType CastExpression SimpleName o
that SimpleName VariableDeclarationFragment CastExpression SimpleType SimpleName map property value
that SimpleName VariableDeclarationFragment CastExpression SimpleName o
map property value SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName that
objects SimpleName MethodInvocation SimpleName equals
objects SimpleName MethodInvocation SimpleName map values
objects SimpleName MethodInvocation QualifiedName thatmap values
equals SimpleName MethodInvocation SimpleName map values
equals SimpleName MethodInvocation QualifiedName thatmap values
map values SimpleName MethodInvocation QualifiedName thatmap values
