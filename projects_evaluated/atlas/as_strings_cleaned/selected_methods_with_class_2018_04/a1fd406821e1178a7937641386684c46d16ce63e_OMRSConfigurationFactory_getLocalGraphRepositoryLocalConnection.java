...
connector type guid SimpleName VariableDeclarationFragment StringLiteral - a - bd - bb efd e fb
final Modifier VariableDeclarationStatement SimpleType SimpleName string
final Modifier VariableDeclarationStatement VariableDeclarationFragment SimpleName connector type guid
final Modifier VariableDeclarationStatement VariableDeclarationFragment StringLiteral - a - bd - bb efd e fb
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName connector type guid
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment StringLiteral - a - bd - bb efd e fb
connection guid SimpleName VariableDeclarationFragment StringLiteral f fd fc f - a e c d f e
final Modifier VariableDeclarationStatement SimpleType SimpleName string
final Modifier VariableDeclarationStatement VariableDeclarationFragment SimpleName connection guid
final Modifier VariableDeclarationStatement VariableDeclarationFragment StringLiteral f fd fc f - a e c d f e
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName connection guid
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment StringLiteral f fd fc f - a e c d f e
connector type description SimpleName VariableDeclarationFragment StringLiteral omrs default graph local repository connector type
final Modifier VariableDeclarationStatement SimpleType SimpleName string
final Modifier VariableDeclarationStatement VariableDeclarationFragment SimpleName connector type description
final Modifier VariableDeclarationStatement VariableDeclarationFragment StringLiteral omrs default graph local repository connector type
...
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment StringLiteral omrs default graph local repository connector type
local atlas omrs repository connector provider SimpleName SimpleType TypeLiteral MethodInvocation SimpleName get name
...
default local graph repositoryconnector type StringLiteral InfixExpression SimpleName local server name
connector type name SimpleName VariableDeclarationFragment InfixExpression StringLiteral default local graph repositoryconnector type
...
connection description SimpleName VariableDeclarationFragment StringLiteral omrs default local graph repository connection
final Modifier VariableDeclarationStatement SimpleType SimpleName string
final Modifier VariableDeclarationStatement VariableDeclarationFragment SimpleName connection description
final Modifier VariableDeclarationStatement VariableDeclarationFragment StringLiteral omrs default local graph repository connection
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName connection description
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment StringLiteral omrs default local graph repository connection
default local graph repositoryconnection StringLiteral InfixExpression SimpleName local server name
connection name SimpleName VariableDeclarationFragment InfixExpression StringLiteral default local graph repositoryconnection
...
private Modifier MethodDeclaration SimpleName get local graph repository local connection
...
connection SimpleName SimpleType MethodDeclaration SimpleName get local graph repository local connection
connection SimpleName SimpleType MethodDeclaration SingleVariableDeclaration SimpleName local server name
get local graph repository local connection SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
get local graph repository local connection SimpleName MethodDeclaration SingleVariableDeclaration SimpleName local server name
get local graph repository local connection SimpleName MethodDeclaration Block VariableDeclarationStatement Modifier final
get local graph repository local connection SimpleName MethodDeclaration Block VariableDeclarationStatement Modifier final
get local graph repository local connection SimpleName MethodDeclaration Block VariableDeclarationStatement Modifier final
get local graph repository local connection SimpleName MethodDeclaration Block VariableDeclarationStatement Modifier final
get local graph repository local connection SimpleName MethodDeclaration Block VariableDeclarationStatement Modifier final
get local graph repository local connection SimpleName MethodDeclaration Block ReturnStatement SimpleName connection
public Modifier TypeDeclaration SimpleName test
public Modifier TypeDeclaration MethodDeclaration Modifier private
public Modifier TypeDeclaration MethodDeclaration SimpleType SimpleName connection
public Modifier TypeDeclaration MethodDeclaration SimpleName get local graph repository local connection
...
test SimpleName TypeDeclaration MethodDeclaration SimpleName get local graph repository local connection
