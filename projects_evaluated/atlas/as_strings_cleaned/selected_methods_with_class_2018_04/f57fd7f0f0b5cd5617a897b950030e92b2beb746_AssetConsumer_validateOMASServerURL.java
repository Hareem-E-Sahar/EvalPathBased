...
error code SimpleName VariableDeclarationFragment QualifiedName asset consumer error codeserver url not specified
...
asset consumer error code SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment QualifiedName asset consumer error codeserver url not specified
...
private Modifier MethodDeclaration SimpleName validate omas server url
...
void PrimitiveType MethodDeclaration SimpleName validate omas server url
...
validate omas server url SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
validate omas server url SimpleName MethodDeclaration SingleVariableDeclaration SimpleName method name
validate omas server url SimpleName MethodDeclaration SimpleType SimpleName property server exception
...
public Modifier TypeDeclaration MethodDeclaration SimpleName validate omas server url
...
test SimpleName TypeDeclaration MethodDeclaration SimpleName validate omas server url
