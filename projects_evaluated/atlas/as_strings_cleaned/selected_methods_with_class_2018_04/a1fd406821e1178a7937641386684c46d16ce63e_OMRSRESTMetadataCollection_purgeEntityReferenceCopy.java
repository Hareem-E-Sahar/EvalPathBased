...
url template SimpleName VariableDeclarationFragment StringLiteral { instancesentitiesreferencecopy purgetype def guid type def name home metadata collection id }
final Modifier VariableDeclarationStatement SimpleType SimpleName string
final Modifier VariableDeclarationStatement VariableDeclarationFragment SimpleName url template
final Modifier VariableDeclarationStatement VariableDeclarationFragment StringLiteral { instancesentitiesreferencecopy purgetype def guid type def name home metadata collection id }
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName url template
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment StringLiteral { instancesentitiesreferencecopy purgetype def guid type def name home metadata collection id }
