...
url template SimpleName VariableDeclarationFragment StringLiteral { typesattributetypedef }
final Modifier VariableDeclarationStatement SimpleType SimpleName string
final Modifier VariableDeclarationStatement VariableDeclarationFragment SimpleName url template
final Modifier VariableDeclarationStatement VariableDeclarationFragment StringLiteral { typesattributetypedef }
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName url template
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment StringLiteral { typesattributetypedef }
rest url root SimpleName InfixExpression SimpleName url template
call attribute type def get rest call SimpleName MethodInvocation SimpleName method name
call attribute type def get rest call SimpleName MethodInvocation InfixExpression SimpleName rest url root
call attribute type def get rest call SimpleName MethodInvocation InfixExpression SimpleName url template
call attribute type def get rest call SimpleName MethodInvocation SimpleName user id
call attribute type def get rest call SimpleName MethodInvocation SimpleName guid
...
rest result SimpleName VariableDeclarationFragment MethodInvocation SimpleName call attribute type def get rest call
...
attribute type def response SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName rest result
...
method name SimpleName MethodInvocation SimpleName rest result
rest result SimpleName MethodInvocation SimpleName get attribute type def
