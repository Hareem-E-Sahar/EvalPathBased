...
url template SimpleName VariableDeclarationFragment StringLiteral { typesattributetypedef obsolete type def name }
final Modifier VariableDeclarationStatement SimpleType SimpleName string
final Modifier VariableDeclarationStatement VariableDeclarationFragment SimpleName url template
final Modifier VariableDeclarationStatement VariableDeclarationFragment StringLiteral { typesattributetypedef obsolete type def name }
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName url template
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment StringLiteral { typesattributetypedef obsolete type def name }
...
call void patch rest call SimpleName MethodInvocation SimpleName obsolete type def guid
...
method name SimpleName MethodInvocation SimpleName obsolete type def guid
method name SimpleName MethodInvocation SimpleName obsolete type def name
...
rest url root SimpleName InfixExpression MethodInvocation SimpleName obsolete type def guid
url template SimpleName InfixExpression MethodInvocation SimpleName obsolete type def guid
rest url root SimpleName InfixExpression MethodInvocation SimpleName obsolete type def name
url template SimpleName InfixExpression MethodInvocation SimpleName obsolete type def name
...
rest result SimpleName VariableDeclarationFragment MethodInvocation SimpleName obsolete type def guid
rest result SimpleName VariableDeclarationFragment MethodInvocation SimpleName obsolete type def name
...
detect and throw type def not known exception SimpleName MethodInvocation SimpleName method name
detect and throw type def not known exception SimpleName MethodInvocation SimpleName rest result
method name SimpleName MethodInvocation SimpleName rest result
detect and throw type def in use exception SimpleName MethodInvocation SimpleName method name
detect and throw type def in use exception SimpleName MethodInvocation SimpleName rest result
method name SimpleName MethodInvocation SimpleName rest result
...
delete attribute type def SimpleName MethodDeclaration SimpleType SimpleName invalid parameter exception
delete attribute type def SimpleName MethodDeclaration SimpleType SimpleName repository error exception
