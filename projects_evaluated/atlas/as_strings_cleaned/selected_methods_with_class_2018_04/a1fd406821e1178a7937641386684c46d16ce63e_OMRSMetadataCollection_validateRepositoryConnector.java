...
error code SimpleName VariableDeclarationFragment QualifiedName omrs error codeno repository connector for collection
omrs error code SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName error code
omrs error code SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment QualifiedName omrs error codeno repository connector for collection
...
error code SimpleName VariableDeclarationFragment QualifiedName omrs error codeno repository validator for collection
omrs error code SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName error code
omrs error code SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment QualifiedName omrs error codeno repository validator for collection
error code SimpleName MethodInvocation SimpleName get error message id
error code SimpleName MethodInvocation SimpleName get formatted error message
error code SimpleName MethodInvocation SimpleName method name
error code SimpleName MethodInvocation SimpleName repository name
...
get system action SimpleName MethodInvocation ClassInstanceCreation MethodInvocation SimpleName error code
get system action SimpleName MethodInvocation ClassInstanceCreation MethodInvocation SimpleName get user action
error code SimpleName VariableDeclarationFragment QualifiedName omrs error codeno repository helper for collection
omrs error code SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName error code
omrs error code SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment QualifiedName omrs error codeno repository helper for collection
error code SimpleName MethodInvocation SimpleName get error message id
error code SimpleName MethodInvocation SimpleName get formatted error message
error code SimpleName MethodInvocation SimpleName method name
error code SimpleName MethodInvocation SimpleName repository name
...
void PrimitiveType MethodDeclaration SimpleName validate repository connector
...
validate repository connector SimpleName MethodDeclaration SimpleType SimpleName repository error exception
