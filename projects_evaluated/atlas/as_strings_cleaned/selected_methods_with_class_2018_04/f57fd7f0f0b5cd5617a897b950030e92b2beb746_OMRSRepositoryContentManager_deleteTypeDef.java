...
valid type id SimpleName MethodInvocation SimpleName obsolete type def guid
valid type id SimpleName MethodInvocation SimpleName obsolete type def name
source name SimpleName MethodInvocation SimpleName obsolete type def guid
source name SimpleName MethodInvocation SimpleName obsolete type def name
obsolete type def guid SimpleName MethodInvocation SimpleName obsolete type def name
known types SimpleName MethodInvocation SimpleName remove
known types SimpleName MethodInvocation SimpleName obsolete type def name
remove SimpleName MethodInvocation SimpleName obsolete type def name
active types SimpleName MethodInvocation SimpleName remove
active types SimpleName MethodInvocation SimpleName obsolete type def name
remove SimpleName MethodInvocation SimpleName obsolete type def name
log SimpleName MethodInvocation SimpleName is debug enabled
deleted active type StringLiteral InfixExpression SimpleName obsolete type def name
deleted active type StringLiteral InfixExpression StringLiteral from
deleted active type StringLiteral InfixExpression SimpleName source name
obsolete type def name SimpleName InfixExpression StringLiteral from
obsolete type def name SimpleName InfixExpression SimpleName source name
from StringLiteral InfixExpression SimpleName source name
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation InfixExpression StringLiteral deleted active type
log SimpleName MethodInvocation InfixExpression SimpleName obsolete type def name
...
debug SimpleName MethodInvocation InfixExpression StringLiteral deleted active type
debug SimpleName MethodInvocation InfixExpression SimpleName obsolete type def name
...
delete type def SimpleName MethodDeclaration SingleVariableDeclaration SimpleName source name
delete type def SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
...
source name SimpleName SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration SimpleName obsolete type def guid
source name SimpleName SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration SimpleName obsolete type def name
