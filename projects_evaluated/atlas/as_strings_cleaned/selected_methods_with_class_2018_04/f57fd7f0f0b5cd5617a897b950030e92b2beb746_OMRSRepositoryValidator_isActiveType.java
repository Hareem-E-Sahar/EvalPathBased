...
is active type SimpleName MethodInvocation SimpleName type def guid
is active type SimpleName MethodInvocation SimpleName type def name
...
is active type SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
is active type SimpleName MethodDeclaration SingleVariableDeclaration SimpleName type def guid
is active type SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
is active type SimpleName MethodDeclaration SingleVariableDeclaration SimpleName type def name
