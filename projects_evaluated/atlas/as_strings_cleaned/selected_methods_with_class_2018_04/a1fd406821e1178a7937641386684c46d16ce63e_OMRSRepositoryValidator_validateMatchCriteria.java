...
match criteria parameter name SimpleName MethodInvocation SimpleName repository name
...
match properties parameter name SimpleName MethodInvocation SimpleName repository name
method name SimpleName MethodInvocation SimpleName repository name
error code SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName error code
error code SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName get formatted error message
...
validate match criteria SimpleName MethodDeclaration SingleVariableDeclaration SimpleName repository name
validate match criteria SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
...
repository name SimpleName SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration SimpleName match criteria parameter name
repository name SimpleName SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration SimpleName match properties parameter name
repository name SimpleName SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration SimpleName match criteria
repository name SimpleName SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration SimpleName match properties
