...
name SimpleName MethodInvocation MethodInvocation SimpleName attribute type def
name SimpleName MethodInvocation MethodInvocation SimpleName get name
equals SimpleName MethodInvocation MethodInvocation SimpleName attribute type def
equals SimpleName MethodInvocation MethodInvocation SimpleName get name
attribute type def SimpleName SingleVariableDeclaration EnhancedForStatement MethodInvocation SimpleName repository store
attribute type def SimpleName SingleVariableDeclaration EnhancedForStatement MethodInvocation SimpleName get attribute type defs
error code SimpleName VariableDeclarationFragment QualifiedName omrs error codeattribute typedef name not known
omrs error code SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName error code
omrs error code SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment QualifiedName omrs error codeattribute typedef name not known
