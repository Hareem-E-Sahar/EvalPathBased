...
error code SimpleName VariableDeclarationFragment QualifiedName omag error codenull user name
omag error code SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName error code
omag error code SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment QualifiedName omag error codenull user name
...
omag not authorized exception SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName error code
omag not authorized exception SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName get http error code
omag not authorized exception SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName get name
omag not authorized exception SimpleName SimpleType ClassInstanceCreation SimpleName method name
omag not authorized exception SimpleName SimpleType ClassInstanceCreation SimpleName error message
omag not authorized exception SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName error code
omag not authorized exception SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName get system action
...
private Modifier MethodDeclaration SimpleName validate user id
...
validate user id SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
validate user id SimpleName MethodDeclaration SingleVariableDeclaration SimpleName server name
validate user id SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
validate user id SimpleName MethodDeclaration SingleVariableDeclaration SimpleName method name
validate user id SimpleName MethodDeclaration SimpleType SimpleName omag not authorized exception
...
method name SimpleName SingleVariableDeclaration MethodDeclaration SimpleType SimpleName omag not authorized exception
