...
path SimpleName MemberValuePair StringLiteral user idinstancesentityentity guidproperties
...
request mapping SimpleName NormalAnnotation MemberValuePair StringLiteral user idinstancesentityentity guidproperties
method SimpleName MemberValuePair NormalAnnotation MemberValuePair SimpleName path
method SimpleName MemberValuePair NormalAnnotation MemberValuePair StringLiteral user idinstancesentityentity guidproperties
request methodpatch QualifiedName MemberValuePair NormalAnnotation MemberValuePair SimpleName path
request methodpatch QualifiedName MemberValuePair NormalAnnotation MemberValuePair StringLiteral user idinstancesentityentity guidproperties
...
local metadata collection SimpleName MethodInvocation SimpleName update entity properties
...
response SimpleName MethodInvocation MethodInvocation SimpleName update entity properties
...
set entity SimpleName MethodInvocation MethodInvocation SimpleName update entity properties
...
user idinstancesentityentity guidproperties StringLiteral MemberValuePair NormalAnnotation MethodDeclaration Modifier public
request mapping SimpleName NormalAnnotation MethodDeclaration SimpleType SimpleName entity detail response
request mapping SimpleName NormalAnnotation MethodDeclaration SimpleName update entity properties
method SimpleName MemberValuePair NormalAnnotation MethodDeclaration SimpleName update entity properties
request methodpatch QualifiedName MemberValuePair NormalAnnotation MethodDeclaration SimpleName update entity properties
path SimpleName MemberValuePair NormalAnnotation MethodDeclaration SimpleName update entity properties
user idinstancesentityentity guidproperties StringLiteral MemberValuePair NormalAnnotation MethodDeclaration SimpleName update entity properties
...
entity detail response SimpleName SimpleType MethodDeclaration SimpleName update entity properties
...
update entity properties SimpleName MethodDeclaration SingleVariableDeclaration MarkerAnnotation SimpleName path variable
...
update entity properties SimpleName MethodDeclaration SingleVariableDeclaration MarkerAnnotation SimpleName request param
...
update entity properties SimpleName MethodDeclaration Block VariableDeclarationStatement Modifier final
update entity properties SimpleName MethodDeclaration Block ReturnStatement SimpleName response
