...
metadata collection SimpleName MethodInvocation SimpleName type def category
find type defs by category SimpleName MethodInvocation SimpleName user id
find type defs by category SimpleName MethodInvocation SimpleName type def category
user id SimpleName MethodInvocation SimpleName type def category
...
results SimpleName VariableDeclarationFragment MethodInvocation SimpleName type def category
...
public Modifier MethodDeclaration SingleVariableDeclaration SimpleName type def category
...
find type defs by category SimpleName MethodDeclaration SingleVariableDeclaration SimpleName type def category
...
user id SimpleName SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration SimpleName type def category
...
type def category SimpleName SingleVariableDeclaration MethodDeclaration SimpleType SimpleName invalid parameter exception
type def category SimpleName SingleVariableDeclaration MethodDeclaration SimpleType SimpleName repository error exception
type def category SimpleName SingleVariableDeclaration MethodDeclaration SimpleType SimpleName user not authorized exception
