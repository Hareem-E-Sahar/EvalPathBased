...
error code SimpleName VariableDeclarationFragment QualifiedName asset consumer error codeuser not authorized
...
asset consumer error code SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment QualifiedName asset consumer error codeuser not authorized
...
error code SimpleName MethodInvocation SimpleName user id
...
get formatted error message SimpleName MethodInvocation SimpleName user id
...
error code SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName user id
...
get error message id SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName user id
...
error message SimpleName VariableDeclarationFragment InfixExpression MethodInvocation SimpleName user id
...
public Modifier MethodDeclaration SimpleName handle unauthorized user
...
void PrimitiveType MethodDeclaration SimpleName handle unauthorized user
...
handle unauthorized user SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
handle unauthorized user SimpleName MethodDeclaration SingleVariableDeclaration SimpleName user id
handle unauthorized user SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
handle unauthorized user SimpleName MethodDeclaration SingleVariableDeclaration SimpleName method name
handle unauthorized user SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
handle unauthorized user SimpleName MethodDeclaration SingleVariableDeclaration SimpleName server name
handle unauthorized user SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
handle unauthorized user SimpleName MethodDeclaration SingleVariableDeclaration SimpleName service name
handle unauthorized user SimpleName MethodDeclaration SimpleType SimpleName user not authorized exception
...
user id SimpleName SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration SimpleName service name
...
server name SimpleName SingleVariableDeclaration MethodDeclaration SimpleType SimpleName user not authorized exception
service name SimpleName SingleVariableDeclaration MethodDeclaration SimpleType SimpleName user not authorized exception
public Modifier TypeDeclaration SimpleName test
public Modifier TypeDeclaration MethodDeclaration Modifier public
public Modifier TypeDeclaration MethodDeclaration PrimitiveType void
public Modifier TypeDeclaration MethodDeclaration SimpleName handle unauthorized user
...
test SimpleName TypeDeclaration MethodDeclaration SimpleName handle unauthorized user
