...
private Modifier MethodDeclaration SimpleName validate local repository
...
void PrimitiveType MethodDeclaration SimpleName validate local repository
...
validate local repository SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
validate local repository SimpleName MethodDeclaration SingleVariableDeclaration SimpleName method name
validate local repository SimpleName MethodDeclaration SimpleType SimpleName repository error exception
...
public Modifier TypeDeclaration MethodDeclaration SimpleName validate local repository
...
test SimpleName TypeDeclaration MethodDeclaration SimpleName validate local repository
