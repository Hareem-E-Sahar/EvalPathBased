...
rest result SimpleName VariableDeclarationFragment ClassInstanceCreation SimpleType SimpleName attribute type def response
...
rest template SimpleName MethodInvocation SimpleName patch for object
...
patch for object SimpleName MethodInvocation SimpleName url template
patch for object SimpleName MethodInvocation MethodInvocation SimpleName rest result
patch for object SimpleName MethodInvocation MethodInvocation SimpleName get class
patch for object SimpleName MethodInvocation SimpleName params
...
rest result SimpleName Assignment MethodInvocation SimpleName patch for object
...
private Modifier MethodDeclaration SimpleType SimpleName attribute type def response
private Modifier MethodDeclaration SimpleName call attribute type def patch rest call
...
attribute type def response SimpleName SimpleType MethodDeclaration SimpleName call attribute type def patch rest call
attribute type def response SimpleName SimpleType MethodDeclaration SingleVariableDeclaration SimpleName method name
attribute type def response SimpleName SimpleType MethodDeclaration SingleVariableDeclaration SimpleName url template
attribute type def response SimpleName SimpleType MethodDeclaration SingleVariableDeclaration SimpleName params
attribute type def response SimpleName SimpleType MethodDeclaration SimpleType SimpleName repository error exception
call attribute type def patch rest call SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
call attribute type def patch rest call SimpleName MethodDeclaration SingleVariableDeclaration SimpleName method name
call attribute type def patch rest call SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
call attribute type def patch rest call SimpleName MethodDeclaration SingleVariableDeclaration SimpleName url template
call attribute type def patch rest call SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName object
call attribute type def patch rest call SimpleName MethodDeclaration SingleVariableDeclaration SimpleName params
call attribute type def patch rest call SimpleName MethodDeclaration SimpleType SimpleName repository error exception
call attribute type def patch rest call SimpleName MethodDeclaration Block ReturnStatement SimpleName rest result
...
public Modifier TypeDeclaration MethodDeclaration SimpleName call attribute type def patch rest call
...
test SimpleName TypeDeclaration MethodDeclaration SimpleName call attribute type def patch rest call
