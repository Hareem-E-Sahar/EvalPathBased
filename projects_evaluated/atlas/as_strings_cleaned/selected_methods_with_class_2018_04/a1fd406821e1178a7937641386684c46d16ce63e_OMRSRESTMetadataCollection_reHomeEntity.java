...
url template SimpleName VariableDeclarationFragment StringLiteral { instancesentity home type def guid type def name new home metadata collection id }
final Modifier VariableDeclarationStatement SimpleType SimpleName string
final Modifier VariableDeclarationStatement VariableDeclarationFragment SimpleName url template
final Modifier VariableDeclarationStatement VariableDeclarationFragment StringLiteral { instancesentity home type def guid type def name new home metadata collection id }
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName url template
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment StringLiteral { instancesentity home type def guid type def name new home metadata collection id }
...
call entity detail patch rest call SimpleName MethodInvocation SimpleName home metadata collection id
...
method name SimpleName MethodInvocation SimpleName home metadata collection id
...
home metadata collection id SimpleName MethodInvocation SimpleName type def guid
home metadata collection id SimpleName MethodInvocation SimpleName type def name
...
rest result SimpleName VariableDeclarationFragment MethodInvocation SimpleName new home metadata collection id
