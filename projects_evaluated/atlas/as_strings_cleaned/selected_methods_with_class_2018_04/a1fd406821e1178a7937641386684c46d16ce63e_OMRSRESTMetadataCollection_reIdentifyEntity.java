...
url template SimpleName VariableDeclarationFragment StringLiteral { instancesentity identitytype def guid type def name new entity guid }
final Modifier VariableDeclarationStatement SimpleType SimpleName string
final Modifier VariableDeclarationStatement VariableDeclarationFragment SimpleName url template
final Modifier VariableDeclarationStatement VariableDeclarationFragment StringLiteral { instancesentity identitytype def guid type def name new entity guid }
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName url template
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment StringLiteral { instancesentity identitytype def guid type def name new entity guid }
...
call entity detail patch rest call SimpleName MethodInvocation SimpleName type def guid
...
rest url root SimpleName InfixExpression MethodInvocation SimpleName new entity guid
url template SimpleName InfixExpression MethodInvocation SimpleName new entity guid
...
rest result SimpleName VariableDeclarationFragment MethodInvocation SimpleName new entity guid
