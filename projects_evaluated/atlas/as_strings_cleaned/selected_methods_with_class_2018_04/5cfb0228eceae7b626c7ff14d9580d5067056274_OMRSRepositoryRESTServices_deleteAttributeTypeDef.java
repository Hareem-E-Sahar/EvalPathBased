...
path SimpleName MemberValuePair StringLiteral user idtypesattributetypedefobsolete type def guid
...
request mapping SimpleName NormalAnnotation MemberValuePair StringLiteral user idtypesattributetypedefobsolete type def guid
method SimpleName MemberValuePair NormalAnnotation MemberValuePair SimpleName path
method SimpleName MemberValuePair NormalAnnotation MemberValuePair StringLiteral user idtypesattributetypedefobsolete type def guid
request methodpatch QualifiedName MemberValuePair NormalAnnotation MemberValuePair SimpleName path
request methodpatch QualifiedName MemberValuePair NormalAnnotation MemberValuePair StringLiteral user idtypesattributetypedefobsolete type def guid
...
local metadata collection SimpleName MethodInvocation SimpleName delete attribute type def
...
delete attribute type def SimpleName MethodInvocation SimpleName user id
delete attribute type def SimpleName MethodInvocation SimpleName obsolete type def guid
delete attribute type def SimpleName MethodInvocation SimpleName obsolete type def name
...
user idtypesattributetypedefobsolete type def guid StringLiteral MemberValuePair NormalAnnotation MethodDeclaration Modifier public
request mapping SimpleName NormalAnnotation MethodDeclaration SimpleType SimpleName void response
request mapping SimpleName NormalAnnotation MethodDeclaration SimpleName delete attribute type def
method SimpleName MemberValuePair NormalAnnotation MethodDeclaration SimpleName delete attribute type def
request methodpatch QualifiedName MemberValuePair NormalAnnotation MethodDeclaration SimpleName delete attribute type def
path SimpleName MemberValuePair NormalAnnotation MethodDeclaration SimpleName delete attribute type def
user idtypesattributetypedefobsolete type def guid StringLiteral MemberValuePair NormalAnnotation MethodDeclaration SimpleName delete attribute type def
...
void response SimpleName SimpleType MethodDeclaration SimpleName delete attribute type def
...
delete attribute type def SimpleName MethodDeclaration SingleVariableDeclaration MarkerAnnotation SimpleName path variable
...
delete attribute type def SimpleName MethodDeclaration SingleVariableDeclaration MarkerAnnotation SimpleName request param
delete attribute type def SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
...
delete attribute type def SimpleName MethodDeclaration Block ReturnStatement SimpleName response
