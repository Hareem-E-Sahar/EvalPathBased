...
set server name SimpleName SuperMethodInvocation SimpleName server name
real local connector SimpleName MethodInvocation SimpleName set server name
real local connector SimpleName MethodInvocation SimpleName server name
set server name SimpleName MethodInvocation SimpleName server name
real event mapper SimpleName MethodInvocation SimpleName set server name
real event mapper SimpleName MethodInvocation SimpleName server name
set server name SimpleName MethodInvocation SimpleName server name
