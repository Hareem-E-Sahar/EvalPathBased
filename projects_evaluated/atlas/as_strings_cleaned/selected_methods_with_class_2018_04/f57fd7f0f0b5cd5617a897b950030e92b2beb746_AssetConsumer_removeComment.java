...
url template SimpleName VariableDeclarationFragment StringLiteral /{ commentsguiddelete
final Modifier VariableDeclarationStatement SimpleType SimpleName string
final Modifier VariableDeclarationStatement VariableDeclarationFragment SimpleName url template
final Modifier VariableDeclarationStatement VariableDeclarationFragment StringLiteral /{ commentsguiddelete
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName url template
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment StringLiteral /{ commentsguiddelete
...
call void post rest call SimpleName MethodInvocation SimpleName comment guid
...
void PrimitiveType MethodDeclaration SimpleName remove comment
...
remove comment SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
remove comment SimpleName MethodDeclaration SingleVariableDeclaration SimpleName comment guid
remove comment SimpleName MethodDeclaration SimpleType SimpleName invalid parameter exception
remove comment SimpleName MethodDeclaration SimpleType SimpleName property server exception
remove comment SimpleName MethodDeclaration SimpleType SimpleName user not authorized exception
