...
url template SimpleName VariableDeclarationFragment StringLiteral { typesattributetypedefsbycategorycategory }
final Modifier VariableDeclarationStatement SimpleType SimpleName string
final Modifier VariableDeclarationStatement VariableDeclarationFragment SimpleName url template
final Modifier VariableDeclarationStatement VariableDeclarationFragment StringLiteral { typesattributetypedefsbycategorycategory }
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName url template
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment StringLiteral { typesattributetypedefsbycategorycategory }
rest url root SimpleName InfixExpression SimpleName url template
call attribute type def list get rest call SimpleName MethodInvocation SimpleName method name
call attribute type def list get rest call SimpleName MethodInvocation InfixExpression SimpleName rest url root
call attribute type def list get rest call SimpleName MethodInvocation InfixExpression SimpleName url template
call attribute type def list get rest call SimpleName MethodInvocation SimpleName user id
call attribute type def list get rest call SimpleName MethodInvocation SimpleName category
...
rest result SimpleName VariableDeclarationFragment MethodInvocation SimpleName call attribute type def list get rest call
...
method name SimpleName MethodInvocation SimpleName rest result
rest result SimpleName MethodInvocation SimpleName get attribute type defs
