...
url template SimpleName VariableDeclarationFragment StringLiteral { instancesentitiesbysearchcriteriasearch criteria from entity element limit results by status limit results by classification as of time sequencing property sequencing order page size }
final Modifier VariableDeclarationStatement SimpleType SimpleName string
final Modifier VariableDeclarationStatement VariableDeclarationFragment SimpleName url template
final Modifier VariableDeclarationStatement VariableDeclarationFragment StringLiteral { instancesentitiesbysearchcriteriasearch criteria from entity element limit results by status limit results by classification as of time sequencing property sequencing order page size }
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName url template
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment StringLiteral { instancesentitiesbysearchcriteriasearch criteria from entity element limit results by status limit results by classification as of time sequencing property sequencing order page size }
