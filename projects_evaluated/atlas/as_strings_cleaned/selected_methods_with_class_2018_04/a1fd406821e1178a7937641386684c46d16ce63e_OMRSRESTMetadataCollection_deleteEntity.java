...
url template SimpleName VariableDeclarationFragment StringLiteral { instancesentity deletetype def guid type def name }
final Modifier VariableDeclarationStatement SimpleType SimpleName string
final Modifier VariableDeclarationStatement VariableDeclarationFragment SimpleName url template
final Modifier VariableDeclarationStatement VariableDeclarationFragment StringLiteral { instancesentity deletetype def guid type def name }
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName url template
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment StringLiteral { instancesentity deletetype def guid type def name }
...
call entity detail patch rest call SimpleName MethodInvocation SimpleName obsolete entity guid
...
rest url root SimpleName InfixExpression MethodInvocation SimpleName obsolete entity guid
url template SimpleName InfixExpression MethodInvocation SimpleName obsolete entity guid
...
obsolete entity guid SimpleName MethodInvocation SimpleName type def guid
obsolete entity guid SimpleName MethodInvocation SimpleName type def name
...
rest result SimpleName VariableDeclarationFragment MethodInvocation SimpleName obsolete entity guid
