...
url template SimpleName VariableDeclarationFragment StringLiteral { typesnew types }
final Modifier VariableDeclarationStatement SimpleType SimpleName string
final Modifier VariableDeclarationStatement VariableDeclarationFragment SimpleName url template
final Modifier VariableDeclarationStatement VariableDeclarationFragment StringLiteral { typesnew types }
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName url template
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment StringLiteral { typesnew types }
...
call void post rest call SimpleName MethodInvocation SimpleName new types
...
method name SimpleName MethodInvocation SimpleName new types
...
rest url root SimpleName InfixExpression MethodInvocation SimpleName new types
url template SimpleName InfixExpression MethodInvocation SimpleName new types
...
rest result SimpleName VariableDeclarationFragment MethodInvocation SimpleName new types
