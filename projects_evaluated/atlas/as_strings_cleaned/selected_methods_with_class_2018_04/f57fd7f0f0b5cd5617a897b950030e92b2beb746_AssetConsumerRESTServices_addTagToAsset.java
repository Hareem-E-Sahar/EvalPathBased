...
path SimpleName MemberValuePair StringLiteral user idassetsguidtags
...
request mapping SimpleName NormalAnnotation MemberValuePair StringLiteral user idassetsguidtags
method SimpleName MemberValuePair NormalAnnotation MemberValuePair SimpleName path
method SimpleName MemberValuePair NormalAnnotation MemberValuePair StringLiteral user idassetsguidtags
request methodpost QualifiedName MemberValuePair NormalAnnotation MemberValuePair SimpleName path
request methodpost QualifiedName MemberValuePair NormalAnnotation MemberValuePair StringLiteral user idassetsguidtags
...
feedback handler SimpleName MethodInvocation SimpleName add tag to asset
...
add tag to asset SimpleName MethodInvocation SimpleName guid
...
user idassetsguidtags StringLiteral MemberValuePair NormalAnnotation MethodDeclaration Modifier public
request mapping SimpleName NormalAnnotation MethodDeclaration SimpleType SimpleName guid response
request mapping SimpleName NormalAnnotation MethodDeclaration SimpleName add tag to asset
method SimpleName MemberValuePair NormalAnnotation MethodDeclaration SimpleName add tag to asset
request methodpost QualifiedName MemberValuePair NormalAnnotation MethodDeclaration SimpleName add tag to asset
path SimpleName MemberValuePair NormalAnnotation MethodDeclaration SimpleName add tag to asset
user idassetsguidtags StringLiteral MemberValuePair NormalAnnotation MethodDeclaration SimpleName add tag to asset
...
guid response SimpleName SimpleType MethodDeclaration SimpleName add tag to asset
...
add tag to asset SimpleName MethodDeclaration SingleVariableDeclaration MarkerAnnotation SimpleName path variable
...
add tag to asset SimpleName MethodDeclaration SingleVariableDeclaration MarkerAnnotation SimpleName path variable
add tag to asset SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
add tag to asset SimpleName MethodDeclaration SingleVariableDeclaration SimpleName guid
add tag to asset SimpleName MethodDeclaration SingleVariableDeclaration MarkerAnnotation SimpleName request param
add tag to asset SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
add tag to asset SimpleName MethodDeclaration SingleVariableDeclaration SimpleName tag name
add tag to asset SimpleName MethodDeclaration SingleVariableDeclaration NormalAnnotation SimpleName request param
add tag to asset SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
add tag to asset SimpleName MethodDeclaration SingleVariableDeclaration SimpleName tag description
add tag to asset SimpleName MethodDeclaration Block VariableDeclarationStatement Modifier final
add tag to asset SimpleName MethodDeclaration Block ReturnStatement SimpleName response
