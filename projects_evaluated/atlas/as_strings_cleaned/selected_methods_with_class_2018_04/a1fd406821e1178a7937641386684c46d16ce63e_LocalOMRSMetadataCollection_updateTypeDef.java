...
real metadata collection SimpleName MethodInvocation SimpleName update type def
real metadata collection SimpleName MethodInvocation SimpleName user id
real metadata collection SimpleName MethodInvocation SimpleName type def patch
...
updated type def SimpleName VariableDeclarationFragment MethodInvocation SimpleName real metadata collection
updated type def SimpleName VariableDeclarationFragment MethodInvocation SimpleName update type def
updated type def SimpleName VariableDeclarationFragment MethodInvocation SimpleName user id
...
local repository content manager SimpleName MethodInvocation SimpleName update type def
local repository content manager SimpleName MethodInvocation SimpleName repository name
local repository content manager SimpleName MethodInvocation SimpleName updated type def
update type def SimpleName MethodInvocation SimpleName repository name
update type def SimpleName MethodInvocation SimpleName updated type def
repository name SimpleName MethodInvocation SimpleName updated type def
outbound repository event processor SimpleName MethodInvocation SimpleName process updated type def event
...
process updated type def event SimpleName MethodInvocation SimpleName repository name
process updated type def event SimpleName MethodInvocation SimpleName metadata collection id
process updated type def event SimpleName MethodInvocation SimpleName local server name
process updated type def event SimpleName MethodInvocation SimpleName local server type
process updated type def event SimpleName MethodInvocation SimpleName local organization name
...
metadata collection id SimpleName MethodInvocation SimpleName type def patch
...
local server name SimpleName MethodInvocation SimpleName type def patch
local server type SimpleName MethodInvocation SimpleName local organization name
local server type SimpleName MethodInvocation SimpleName type def patch
local organization name SimpleName MethodInvocation SimpleName type def patch
