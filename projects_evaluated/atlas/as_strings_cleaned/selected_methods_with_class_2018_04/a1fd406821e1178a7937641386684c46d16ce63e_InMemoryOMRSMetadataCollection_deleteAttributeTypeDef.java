...
repository validator SimpleName MethodInvocation SimpleName validate attribute type def ids
repository validator SimpleName MethodInvocation SimpleName repository name
...
validate attribute type def ids SimpleName MethodInvocation SimpleName guid parameter name
validate attribute type def ids SimpleName MethodInvocation SimpleName name parameter name
validate attribute type def ids SimpleName MethodInvocation SimpleName obsolete type def guid
validate attribute type def ids SimpleName MethodInvocation SimpleName obsolete type def name
...
get attribute type def SimpleName MethodInvocation SimpleName obsolete type def guid
attribute type def SimpleName VariableDeclarationFragment MethodInvocation SimpleName repository store
attribute type def SimpleName VariableDeclarationFragment MethodInvocation SimpleName get attribute type def
attribute type def SimpleName VariableDeclarationFragment MethodInvocation SimpleName obsolete type def guid
attribute type def SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName attribute type def
...
obsolete type def guid SimpleName MethodInvocation SimpleName guid parameter name
...
error code SimpleName VariableDeclarationFragment QualifiedName omrs error codeattribute typedef in use
omrs error code SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName error code
omrs error code SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment QualifiedName omrs error codeattribute typedef in use
error code SimpleName MethodInvocation SimpleName get error message id
error code SimpleName MethodInvocation SimpleName get formatted error message
