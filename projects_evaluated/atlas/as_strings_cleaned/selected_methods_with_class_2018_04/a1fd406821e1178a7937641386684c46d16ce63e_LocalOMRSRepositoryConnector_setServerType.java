...
set server type SimpleName SuperMethodInvocation SimpleName server type
real local connector SimpleName MethodInvocation SimpleName set server type
real local connector SimpleName MethodInvocation SimpleName server type
set server type SimpleName MethodInvocation SimpleName server type
real event mapper SimpleName MethodInvocation SimpleName set server type
real event mapper SimpleName MethodInvocation SimpleName server type
set server type SimpleName MethodInvocation SimpleName server type
