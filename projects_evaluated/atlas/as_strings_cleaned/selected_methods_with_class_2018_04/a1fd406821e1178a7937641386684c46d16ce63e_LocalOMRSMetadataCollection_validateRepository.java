...
error code SimpleName VariableDeclarationFragment QualifiedName omrs error codenull content manager
omrs error code SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName error code
omrs error code SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment QualifiedName omrs error codenull content manager
error code SimpleName MethodInvocation SimpleName get error message id
error code SimpleName MethodInvocation SimpleName get formatted error message
...
private Modifier MethodDeclaration SimpleName validate repository
...
void PrimitiveType MethodDeclaration SimpleName validate repository
...
validate repository SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
validate repository SimpleName MethodDeclaration SingleVariableDeclaration SimpleName method name
validate repository SimpleName MethodDeclaration SimpleType SimpleName repository error exception
...
public Modifier TypeDeclaration MethodDeclaration SimpleName validate repository
...
test SimpleName TypeDeclaration MethodDeclaration SimpleName validate repository
