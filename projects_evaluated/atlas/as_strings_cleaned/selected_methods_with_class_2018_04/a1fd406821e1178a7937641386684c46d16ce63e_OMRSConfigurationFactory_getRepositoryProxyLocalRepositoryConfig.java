...
public Modifier MethodDeclaration SimpleName get repository proxy local repository config
...
local repository config SimpleName SimpleType MethodDeclaration SimpleName get repository proxy local repository config
...
get repository proxy local repository config SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
get repository proxy local repository config SimpleName MethodDeclaration SingleVariableDeclaration SimpleName local server name
get repository proxy local repository config SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
get repository proxy local repository config SimpleName MethodDeclaration SingleVariableDeclaration SimpleName local server url
get repository proxy local repository config SimpleName MethodDeclaration Block ReturnStatement SimpleName local repository config
...
public Modifier TypeDeclaration MethodDeclaration SimpleName get repository proxy local repository config
...
test SimpleName TypeDeclaration MethodDeclaration SimpleName get repository proxy local repository config
