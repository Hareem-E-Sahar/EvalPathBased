...
path SimpleName MemberValuePair StringLiteral user idlikesguiddelete
...
request mapping SimpleName NormalAnnotation MemberValuePair StringLiteral user idlikesguiddelete
method SimpleName MemberValuePair NormalAnnotation MemberValuePair SimpleName path
method SimpleName MemberValuePair NormalAnnotation MemberValuePair StringLiteral user idlikesguiddelete
request methodpatch QualifiedName MemberValuePair NormalAnnotation MemberValuePair SimpleName path
request methodpatch QualifiedName MemberValuePair NormalAnnotation MemberValuePair StringLiteral user idlikesguiddelete
...
feedback handler SimpleName MethodInvocation SimpleName remove like from asset
...
remove like from asset SimpleName MethodInvocation SimpleName user id
remove like from asset SimpleName MethodInvocation SimpleName guid
...
user idlikesguiddelete StringLiteral MemberValuePair NormalAnnotation MethodDeclaration Modifier public
request mapping SimpleName NormalAnnotation MethodDeclaration SimpleType SimpleName void response
request mapping SimpleName NormalAnnotation MethodDeclaration SimpleName remove like
method SimpleName MemberValuePair NormalAnnotation MethodDeclaration SimpleName remove like
request methodpatch QualifiedName MemberValuePair NormalAnnotation MethodDeclaration SimpleName remove like
path SimpleName MemberValuePair NormalAnnotation MethodDeclaration SimpleName remove like
user idlikesguiddelete StringLiteral MemberValuePair NormalAnnotation MethodDeclaration SimpleName remove like
...
void response SimpleName SimpleType MethodDeclaration SimpleName remove like
...
remove like SimpleName MethodDeclaration SingleVariableDeclaration MarkerAnnotation SimpleName path variable
...
remove like SimpleName MethodDeclaration SingleVariableDeclaration MarkerAnnotation SimpleName path variable
remove like SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
remove like SimpleName MethodDeclaration SingleVariableDeclaration SimpleName guid
remove like SimpleName MethodDeclaration Block VariableDeclarationStatement Modifier final
remove like SimpleName MethodDeclaration Block ReturnStatement SimpleName response
