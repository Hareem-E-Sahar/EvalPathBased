...
name StringLiteral MethodInvocation SimpleName col name
values SimpleName MethodInvocation SimpleName put
...
qualified name StringLiteral MethodInvocation InfixExpression StringLiteral defaulttablecol @
qualified name StringLiteral MethodInvocation InfixExpression SimpleName col name
values SimpleName MethodInvocation SimpleName put
values SimpleName MethodInvocation StringLiteral comment
values SimpleName MethodInvocation StringLiteral col comment
put SimpleName MethodInvocation StringLiteral comment
...
table instance SimpleName MethodInvocation StringLiteral qualified name
...
update entity SimpleName MethodInvocation CastExpression MethodInvocation StringLiteral qualified name
update entity SimpleName MethodInvocation SimpleName table updated
...
base resource ithive table type QualifiedName MethodInvocation CastExpression MethodInvocation StringLiteral qualified name
...
atlas clientreferenceable attribute name QualifiedName MethodInvocation CastExpression MethodInvocation StringLiteral qualified name
...
qualified name StringLiteral MethodInvocation CastExpression MethodInvocation SimpleName table updated
