...
log SimpleName MethodInvocation StringLiteral atlas authentication filter :: initialize secret provider {}
log SimpleName MethodInvocation SimpleName filter config
debug SimpleName MethodInvocation StringLiteral atlas authentication filter :: initialize secret provider {}
debug SimpleName MethodInvocation SimpleName filter config
atlas authentication filter :: initialize secret provider {} StringLiteral MethodInvocation SimpleName filter config
