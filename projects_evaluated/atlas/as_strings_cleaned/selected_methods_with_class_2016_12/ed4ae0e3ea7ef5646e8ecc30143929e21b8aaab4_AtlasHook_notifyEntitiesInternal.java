...
failed to send notification - attempt # StringLiteral InfixExpression SimpleName num retries
failed to send notification - attempt # StringLiteral InfixExpression StringLiteral error
failed to send notification - attempt # StringLiteral InfixExpression MethodInvocation SimpleName e
failed to send notification - attempt # StringLiteral InfixExpression MethodInvocation SimpleName get message
num retries SimpleName InfixExpression StringLiteral error
num retries SimpleName InfixExpression MethodInvocation SimpleName e
num retries SimpleName InfixExpression MethodInvocation SimpleName get message
...
log SimpleName MethodInvocation InfixExpression StringLiteral failed to send notification - attempt #
log SimpleName MethodInvocation InfixExpression SimpleName num retries
...
error SimpleName MethodInvocation InfixExpression StringLiteral failed to send notification - attempt #
error SimpleName MethodInvocation InfixExpression SimpleName num retries
error SimpleName MethodInvocation InfixExpression StringLiteral error
