...
arglength QualifiedName InfixExpression NumberLiteral empty
arg SimpleName ArrayAccess NumberLiteral empty
arglength QualifiedName InfixExpression ParenthesizedExpression ConditionalExpression StringLiteral col
empty NumberLiteral InfixExpression ParenthesizedExpression ConditionalExpression StringLiteral col
arg SimpleName ArrayAccess ConditionalExpression StringLiteral col
empty NumberLiteral ArrayAccess ConditionalExpression StringLiteral col
column SimpleName VariableDeclarationFragment ConditionalExpression ArrayAccess SimpleName arg
column SimpleName VariableDeclarationFragment ConditionalExpression ArrayAccess NumberLiteral empty
column SimpleName VariableDeclarationFragment ConditionalExpression StringLiteral col
...
has SimpleName MethodInvocation StringLiteral guid
...
row SimpleName MethodInvocation SimpleName get json object
row SimpleName MethodInvocation SimpleName column
get json object SimpleName MethodInvocation SimpleName column
row SimpleName MethodInvocation MethodInvocation SimpleName get string
get json object SimpleName MethodInvocation MethodInvocation SimpleName get string
column SimpleName MethodInvocation MethodInvocation SimpleName get string
row SimpleName MethodInvocation MethodInvocation StringLiteral id
get json object SimpleName MethodInvocation MethodInvocation StringLiteral id
column SimpleName MethodInvocation MethodInvocation StringLiteral id
get string SimpleName MethodInvocation StringLiteral id
...
private Modifier MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
private Modifier MethodDeclaration SingleVariableDeclaration SimpleName arg
...
string SimpleName SimpleType MethodDeclaration SingleVariableDeclaration SimpleName arg
...
assert entity is registered SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
assert entity is registered SimpleName MethodDeclaration SingleVariableDeclaration SimpleName arg
assert entity is registered SimpleName MethodDeclaration SimpleType SimpleName exception
final Modifier SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration SimpleName arg
query SimpleName SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration SimpleName arg
...
arg SimpleName SingleVariableDeclaration MethodDeclaration SimpleType SimpleName exception
