...
get table dsl query SimpleName MethodInvocation MethodInvocation SimpleName get cluster name
get table dsl query SimpleName MethodInvocation SimpleName db name
get table dsl query SimpleName MethodInvocation SimpleName table name
get table dsl query SimpleName MethodInvocation SimpleName type name
get cluster name SimpleName MethodInvocation MethodInvocation SimpleName db name
get cluster name SimpleName MethodInvocation MethodInvocation SimpleName table name
get cluster name SimpleName MethodInvocation MethodInvocation SimpleName type name
db name SimpleName MethodInvocation SimpleName table name
db name SimpleName MethodInvocation SimpleName type name
table name SimpleName MethodInvocation SimpleName type name
dsl query SimpleName VariableDeclarationFragment MethodInvocation SimpleName get table dsl query
dsl query SimpleName VariableDeclarationFragment MethodInvocation MethodInvocation SimpleName get cluster name
dsl query SimpleName VariableDeclarationFragment MethodInvocation SimpleName db name
dsl query SimpleName VariableDeclarationFragment MethodInvocation SimpleName table name
