...
setup table SimpleName MethodInvocation SimpleName hive client
setup table SimpleName MethodInvocation SimpleName test db name
setup table SimpleName MethodInvocation SimpleName test table name
hive client SimpleName MethodInvocation SimpleName test db name
...
matches referenceable property SimpleName SimpleType ClassInstanceCreation QualifiedName hive meta store bridgetable type attr
...
hive meta store bridgetable type attr QualifiedName ClassInstanceCreation MethodInvocation QualifiedName table typeexternal table
hive meta store bridgetable type attr QualifiedName ClassInstanceCreation MethodInvocation SimpleName name
arg that SimpleName MethodInvocation ClassInstanceCreation SimpleType SimpleName matches referenceable property
arg that SimpleName MethodInvocation ClassInstanceCreation QualifiedName hive meta store bridgetable type attr
