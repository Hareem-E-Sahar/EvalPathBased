...
get sd for table SimpleName MethodInvocation SimpleName database name
get sd for table SimpleName MethodInvocation SimpleName table name
database name SimpleName MethodInvocation SimpleName table name
sd referenceable SimpleName VariableDeclarationFragment MethodInvocation SimpleName get sd for table
sd referenceable SimpleName VariableDeclarationFragment MethodInvocation SimpleName database name
sd referenceable SimpleName VariableDeclarationFragment MethodInvocation SimpleName table name
referenceable SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName sd referenceable
register partitions SimpleName MethodInvocation SimpleName table referenceable
register partitions SimpleName MethodInvocation SimpleName sd referenceable
register partitions SimpleName MethodInvocation SimpleName table
table referenceable SimpleName MethodInvocation SimpleName sd referenceable
table referenceable SimpleName MethodInvocation SimpleName table
