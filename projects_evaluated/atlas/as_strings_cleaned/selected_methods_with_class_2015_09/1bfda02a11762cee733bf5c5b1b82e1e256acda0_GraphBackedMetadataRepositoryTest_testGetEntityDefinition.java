...
table SimpleName MethodInvocation SimpleName get date
table SimpleName MethodInvocation StringLiteral created
get date SimpleName MethodInvocation StringLiteral created
date SimpleName SimpleType ClassInstanceCreation QualifiedName test utilstest date in long
assert SimpleName MethodInvocation SimpleName assert equals
assert SimpleName MethodInvocation MethodInvocation SimpleName table
assert SimpleName MethodInvocation MethodInvocation SimpleName get date
assert SimpleName MethodInvocation MethodInvocation StringLiteral created
assert SimpleName MethodInvocation ClassInstanceCreation SimpleType SimpleName date
assert SimpleName MethodInvocation ClassInstanceCreation QualifiedName test utilstest date in long
assert equals SimpleName MethodInvocation MethodInvocation SimpleName table
assert equals SimpleName MethodInvocation MethodInvocation SimpleName get date
...
assert equals SimpleName MethodInvocation ClassInstanceCreation QualifiedName test utilstest date in long
table SimpleName MethodInvocation MethodInvocation ClassInstanceCreation QualifiedName test utilstest date in long
get date SimpleName MethodInvocation MethodInvocation ClassInstanceCreation QualifiedName test utilstest date in long
created StringLiteral MethodInvocation MethodInvocation ClassInstanceCreation QualifiedName test utilstest date in long
