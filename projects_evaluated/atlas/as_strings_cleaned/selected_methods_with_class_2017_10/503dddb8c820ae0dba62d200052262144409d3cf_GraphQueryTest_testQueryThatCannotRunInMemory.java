...
q SimpleName MethodInvocation QualifiedName comparision operatornot equal
q SimpleName MethodInvocation StringLiteral george
has SimpleName MethodInvocation StringLiteral name
has SimpleName MethodInvocation QualifiedName comparision operatornot equal
has SimpleName MethodInvocation StringLiteral george
name StringLiteral MethodInvocation QualifiedName comparision operatornot equal
name StringLiteral MethodInvocation StringLiteral george
comparision operatornot equal QualifiedName MethodInvocation StringLiteral george
q SimpleName MethodInvocation SimpleName has
q SimpleName MethodInvocation StringLiteral size
q SimpleName MethodInvocation StringLiteral empty
...
test SimpleName MarkerAnnotation MethodDeclaration SimpleName test query that cannot run in memory
...
public Modifier MethodDeclaration SimpleName test query that cannot run in memory
...
v SimpleName TypeParameter MethodDeclaration SimpleName test query that cannot run in memory
...
e SimpleName TypeParameter MethodDeclaration SimpleName test query that cannot run in memory
e SimpleName TypeParameter MethodDeclaration SimpleType SimpleName atlas exception
void PrimitiveType MethodDeclaration SimpleName test query that cannot run in memory
void PrimitiveType MethodDeclaration SimpleType SimpleName atlas exception
test query that cannot run in memory SimpleName MethodDeclaration SimpleType SimpleName atlas exception
...
public Modifier TypeDeclaration MethodDeclaration SimpleName test query that cannot run in memory
...
test SimpleName TypeDeclaration MethodDeclaration SimpleName test query that cannot run in memory
