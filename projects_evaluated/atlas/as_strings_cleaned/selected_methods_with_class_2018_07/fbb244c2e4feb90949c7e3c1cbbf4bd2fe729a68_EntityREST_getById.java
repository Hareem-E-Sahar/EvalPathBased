...
entity restget by id StringLiteral InfixExpression StringLiteral empty
entity restget by id StringLiteral InfixExpression SimpleName min ext info
entity restget by id StringLiteral InfixExpression StringLiteral )
guid SimpleName InfixExpression StringLiteral empty
guid SimpleName InfixExpression SimpleName min ext info
guid SimpleName InfixExpression StringLiteral )
empty StringLiteral InfixExpression SimpleName min ext info
empty StringLiteral InfixExpression StringLiteral )
min ext info SimpleName InfixExpression StringLiteral )
...
atlas perf tracer SimpleName MethodInvocation InfixExpression SimpleName min ext info
...
get perf tracer SimpleName MethodInvocation InfixExpression SimpleName min ext info
...
perf log SimpleName MethodInvocation InfixExpression SimpleName min ext info
...
perf SimpleName Assignment MethodInvocation InfixExpression SimpleName min ext info
...
get by id SimpleName MethodInvocation SimpleName min ext info
guid SimpleName MethodInvocation SimpleName min ext info
...
get by id SimpleName MethodDeclaration SingleVariableDeclaration SingleMemberAnnotation StringLiteral min ext info
get by id SimpleName MethodDeclaration SingleVariableDeclaration SingleMemberAnnotation SimpleName default value
get by id SimpleName MethodDeclaration SingleVariableDeclaration SingleMemberAnnotation StringLiteral false
get by id SimpleName MethodDeclaration SingleVariableDeclaration PrimitiveType boolean
get by id SimpleName MethodDeclaration SingleVariableDeclaration SimpleName min ext info
...
guid SimpleName SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration SimpleName min ext info
