...
log SimpleName MethodInvocation SimpleName is min ext info
debug SimpleName MethodInvocation StringLiteral ==> get by ids {})
debug SimpleName MethodInvocation SimpleName guids
debug SimpleName MethodInvocation SimpleName is min ext info
==> get by ids {}) StringLiteral MethodInvocation SimpleName guids
==> get by ids {}) StringLiteral MethodInvocation SimpleName is min ext info
guids SimpleName MethodInvocation SimpleName is min ext info
...
to atlas entities with ext info SimpleName MethodInvocation SimpleName is min ext info
guids SimpleName MethodInvocation SimpleName is min ext info
...
is min ext info SimpleName MethodInvocation SimpleName ret
...
graph transaction SimpleName MarkerAnnotation MethodDeclaration SingleVariableDeclaration SimpleName is min ext info
