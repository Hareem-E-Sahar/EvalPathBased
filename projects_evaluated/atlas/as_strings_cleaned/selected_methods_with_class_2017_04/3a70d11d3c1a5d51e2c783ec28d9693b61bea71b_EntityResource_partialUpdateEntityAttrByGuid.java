...
value SimpleName Assignment MethodInvocation SimpleName servlets
value SimpleName Assignment MethodInvocation SimpleName get request payload
value SimpleName Assignment MethodInvocation SimpleName request
preconditions SimpleName MethodInvocation SimpleName check not null
...
log SimpleName MethodInvocation StringLiteral updating entity {} for property {} = {}
...
debug SimpleName MethodInvocation StringLiteral updating entity {} for property {} = {}
...
updating entity {} for property {} = {} StringLiteral MethodInvocation SimpleName guid
updating entity {} for property {} = {} StringLiteral MethodInvocation SimpleName property
updating entity {} for property {} = {} StringLiteral MethodInvocation SimpleName value
...
entities store SimpleName MethodInvocation SimpleName property
entities store SimpleName MethodInvocation SimpleName value
...
mutation response SimpleName VariableDeclarationFragment MethodInvocation SimpleName update entity attribute by guid
mutation response SimpleName VariableDeclarationFragment MethodInvocation SimpleName guid
mutation response SimpleName VariableDeclarationFragment MethodInvocation SimpleName property
mutation response SimpleName VariableDeclarationFragment MethodInvocation SimpleName value
...
unable to add property {} to entity id {} {} StringLiteral MethodInvocation SimpleName value
...
an entity with guid does not exist {} StringLiteral MethodInvocation SimpleName value
...
private Modifier MethodDeclaration SimpleName partial update entity attr by guid
...
response SimpleName SimpleType MethodDeclaration SimpleName partial update entity attr by guid
...
partial update entity attr by guid SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
partial update entity attr by guid SimpleName MethodDeclaration SingleVariableDeclaration SimpleName property
partial update entity attr by guid SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName http servlet request
partial update entity attr by guid SimpleName MethodDeclaration SingleVariableDeclaration SimpleName request
