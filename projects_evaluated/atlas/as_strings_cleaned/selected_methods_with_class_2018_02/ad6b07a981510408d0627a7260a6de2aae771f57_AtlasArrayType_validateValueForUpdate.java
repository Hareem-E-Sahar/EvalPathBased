...
element type SimpleName MethodInvocation SimpleName validate value for update
...
validate value for update SimpleName MethodInvocation SimpleName element
...
validate value for update SimpleName MethodInvocation InfixExpression SimpleName idx
validate value for update SimpleName MethodInvocation InfixExpression StringLiteral ]
...
element type SimpleName MethodInvocation InfixExpression StringLiteral ]
element type SimpleName MethodInvocation SimpleName messages
validate value for update SimpleName MethodInvocation MethodInvocation SimpleName array
validate value for update SimpleName MethodInvocation MethodInvocation SimpleName get
validate value for update SimpleName MethodInvocation MethodInvocation SimpleName obj
validate value for update SimpleName MethodInvocation MethodInvocation SimpleName i
validate value for update SimpleName MethodInvocation InfixExpression SimpleName obj name
validate value for update SimpleName MethodInvocation InfixExpression StringLiteral [
validate value for update SimpleName MethodInvocation InfixExpression SimpleName i
validate value for update SimpleName MethodInvocation InfixExpression StringLiteral ]
validate value for update SimpleName MethodInvocation SimpleName messages
