...
log SimpleName MethodInvocation StringLiteral ==> atlas struct def store v pre delete by guid
log SimpleName MethodInvocation SimpleName guid
debug SimpleName MethodInvocation StringLiteral ==> atlas struct def store v pre delete by guid
debug SimpleName MethodInvocation SimpleName guid
==> atlas struct def store v pre delete by guid StringLiteral MethodInvocation SimpleName guid
...
delete structdef StringLiteral MethodInvocation ParenthesizedExpression ConditionalExpression SimpleName guid
...
<== atlas struct def store v pre delete by guid {} StringLiteral MethodInvocation SimpleName guid
<== atlas struct def store v pre delete by guid {} StringLiteral MethodInvocation SimpleName ret
