...
normalized val SimpleName VariableDeclarationFragment MethodInvocation SimpleName get normalized value
normalized val SimpleName VariableDeclarationFragment MethodInvocation SimpleName val
object SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName normalized val
ret SimpleName Assignment BooleanLiteral false
get normalized value SimpleName MethodInvocation SimpleName val
normalized val SimpleName VariableDeclarationFragment MethodInvocation SimpleName get normalized value
normalized val SimpleName VariableDeclarationFragment MethodInvocation SimpleName val
...
objects SimpleName MethodInvocation SimpleName normalized val
objects SimpleName MethodInvocation SimpleName normalized val
equals SimpleName MethodInvocation SimpleName normalized val
equals SimpleName MethodInvocation SimpleName normalized val
normalized val SimpleName MethodInvocation SimpleName normalized val
ret SimpleName Assignment MethodInvocation SimpleName objects
ret SimpleName Assignment MethodInvocation SimpleName equals
ret SimpleName Assignment MethodInvocation SimpleName normalized val
ret SimpleName Assignment MethodInvocation SimpleName normalized val
