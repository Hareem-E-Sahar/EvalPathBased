...
struct obj SimpleName InstanceofExpression SimpleType SimpleName atlas entity
atlas entity SimpleName SimpleType CastExpression SimpleName struct obj
entity obj SimpleName VariableDeclarationFragment CastExpression SimpleType SimpleName atlas entity
entity obj SimpleName VariableDeclarationFragment CastExpression SimpleName struct obj
atlas entity SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName entity obj
entity obj SimpleName MethodInvocation SimpleName get relationship attribute
entity obj SimpleName MethodInvocation SimpleName attr name
...
map SimpleName SimpleType CastExpression SimpleName obj
atlas type util SimpleName MethodInvocation SimpleName to relationship attributes
atlas type util SimpleName MethodInvocation CastExpression SimpleType SimpleName map
atlas type util SimpleName MethodInvocation CastExpression SimpleName obj
to relationship attributes SimpleName MethodInvocation CastExpression SimpleType SimpleName map
to relationship attributes SimpleName MethodInvocation CastExpression SimpleName obj
relationship attributes SimpleName VariableDeclarationFragment MethodInvocation SimpleName atlas type util
relationship attributes SimpleName VariableDeclarationFragment MethodInvocation SimpleName to relationship attributes
relationship attributes SimpleName VariableDeclarationFragment MethodInvocation CastExpression SimpleName obj
map SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName relationship attributes
atlas attribute def SimpleName SimpleType SingleVariableDeclaration SimpleName attribute def
struct def SimpleName MethodInvocation SimpleName get attribute defs
attribute def SimpleName MethodInvocation SimpleName get name
attr name SimpleName VariableDeclarationFragment MethodInvocation SimpleName attribute def
...
is empty SimpleName MethodInvocation SimpleName relationship attributes
