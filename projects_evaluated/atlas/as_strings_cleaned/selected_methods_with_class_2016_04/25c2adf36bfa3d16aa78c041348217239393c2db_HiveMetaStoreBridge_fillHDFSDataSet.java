...
ref SimpleName MethodInvocation SimpleName set
ref SimpleName MethodInvocation QualifiedName hive data model generatorname
ref SimpleName MethodInvocation SimpleName path uri
set SimpleName MethodInvocation QualifiedName hive data model generatorname
set SimpleName MethodInvocation SimpleName path uri
hive data model generatorname QualifiedName MethodInvocation SimpleName path uri
ref SimpleName MethodInvocation SimpleName set
