...
create hive table instance built in SimpleName MethodInvocation InfixExpression StringLiteral db
create hive table instance built in SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName random string
create hive table instance built in SimpleName MethodInvocation InfixExpression StringLiteral table
create hive table instance built in SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName random string
...
db StringLiteral InfixExpression MethodInvocation SimpleName db id
random string SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName db id
table StringLiteral InfixExpression MethodInvocation SimpleName db id
random string SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName db id
table instance SimpleName VariableDeclarationFragment MethodInvocation SimpleName create hive table instance built in
table instance SimpleName VariableDeclarationFragment MethodInvocation InfixExpression StringLiteral db
