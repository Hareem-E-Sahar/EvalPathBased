...
atlas entity header with associations SimpleName SimpleType CastExpression SimpleName o
that SimpleName VariableDeclarationFragment CastExpression SimpleType SimpleName atlas entity header with associations
that SimpleName VariableDeclarationFragment CastExpression SimpleName o
atlas entity header with associations SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName that
objects SimpleName MethodInvocation SimpleName equals
objects SimpleName MethodInvocation SimpleName classification names
objects SimpleName MethodInvocation QualifiedName thatclassification names
equals SimpleName MethodInvocation SimpleName classification names
equals SimpleName MethodInvocation QualifiedName thatclassification names
classification names SimpleName MethodInvocation QualifiedName thatclassification names
