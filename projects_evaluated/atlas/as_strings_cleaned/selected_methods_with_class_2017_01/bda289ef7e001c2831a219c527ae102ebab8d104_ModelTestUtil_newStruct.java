...
types registry SimpleName MethodInvocation SimpleName get struct type by name
...
get struct type by name SimpleName MethodInvocation MethodInvocation SimpleName struct def
get struct type by name SimpleName MethodInvocation MethodInvocation SimpleName get name
struct type SimpleName VariableDeclarationFragment MethodInvocation SimpleName types registry
struct type SimpleName VariableDeclarationFragment MethodInvocation SimpleName get struct type by name
struct type SimpleName VariableDeclarationFragment MethodInvocation MethodInvocation SimpleName struct def
...
struct type SimpleName MethodInvocation SimpleName create default value
...
log SimpleName MethodInvocation StringLiteral failed to get structtype {}
...
error SimpleName MethodInvocation StringLiteral failed to get structtype {}
error SimpleName MethodInvocation MethodInvocation SimpleName struct def
error SimpleName MethodInvocation MethodInvocation SimpleName get name
failed to get structtype {} StringLiteral MethodInvocation MethodInvocation SimpleName struct def
failed to get structtype {} StringLiteral MethodInvocation MethodInvocation SimpleName get name
