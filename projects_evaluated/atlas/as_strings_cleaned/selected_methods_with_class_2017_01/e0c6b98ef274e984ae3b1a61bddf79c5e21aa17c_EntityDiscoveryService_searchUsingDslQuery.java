...
to atlas entity headerwith associations SimpleName MethodInvocation CastExpression SimpleType SimpleName atlas vertex
to atlas entity headerwith associations SimpleName MethodInvocation CastExpression SimpleName element
ret SimpleName MethodInvocation SimpleName add entity
ret SimpleName MethodInvocation MethodInvocation SimpleName to atlas entity headerwith associations
ret SimpleName MethodInvocation MethodInvocation CastExpression SimpleName element
add entity SimpleName MethodInvocation MethodInvocation SimpleName to atlas entity headerwith associations
...
to atlas entity headerwith associations SimpleName MethodInvocation CastExpression SimpleType SimpleName atlas vertex
to atlas entity headerwith associations SimpleName MethodInvocation CastExpression SimpleName entry
ret SimpleName MethodInvocation SimpleName add entity
ret SimpleName MethodInvocation MethodInvocation SimpleName to atlas entity headerwith associations
...
atlas base exception SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName gremlin query
atlas base exception SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName query str
discovery query failed SimpleName ClassInstanceCreation MethodInvocation SimpleName gremlin query
discovery query failed SimpleName ClassInstanceCreation MethodInvocation SimpleName query str
