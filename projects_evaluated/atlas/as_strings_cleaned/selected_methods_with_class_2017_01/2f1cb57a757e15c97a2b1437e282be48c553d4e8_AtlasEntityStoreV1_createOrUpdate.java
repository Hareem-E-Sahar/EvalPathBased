...
log SimpleName MethodInvocation StringLiteral ==> atlas entity store v create or update {})
log SimpleName MethodInvocation SimpleName entities
debug SimpleName MethodInvocation StringLiteral ==> atlas entity store v create or update {})
debug SimpleName MethodInvocation SimpleName entities
==> atlas entity store v create or update {}) StringLiteral MethodInvocation SimpleName entities
list SimpleName SimpleType ParameterizedType SimpleType SimpleName atlas entity
validate and normalize SimpleName MethodInvocation SimpleName entities
normalized entities SimpleName VariableDeclarationFragment MethodInvocation SimpleName validate and normalize
normalized entities SimpleName VariableDeclarationFragment MethodInvocation SimpleName entities
pre create or update SimpleName MethodInvocation SimpleName normalized entities
ctx SimpleName VariableDeclarationFragment MethodInvocation SimpleName pre create or update
ctx SimpleName VariableDeclarationFragment MethodInvocation SimpleName normalized entities
entity mutation context SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName ctx
log SimpleName MethodInvocation SimpleName is debug enabled
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation StringLiteral <== atlas struct def store v create or update {}): {}
log SimpleName MethodInvocation SimpleName entities
debug SimpleName MethodInvocation StringLiteral <== atlas struct def store v create or update {}): {}
debug SimpleName MethodInvocation SimpleName entities
<== atlas struct def store v create or update {}): {} StringLiteral MethodInvocation SimpleName entities
graph mapper SimpleName MethodInvocation SimpleName map attributes
graph mapper SimpleName MethodInvocation SimpleName ctx
map attributes SimpleName MethodInvocation SimpleName ctx
