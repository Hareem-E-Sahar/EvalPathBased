...
atlas entities with ext info SimpleName SimpleType CastExpression SimpleName o
that SimpleName VariableDeclarationFragment CastExpression SimpleType SimpleName atlas entities with ext info
that SimpleName VariableDeclarationFragment CastExpression SimpleName o
atlas entities with ext info SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName that
objects SimpleName MethodInvocation SimpleName equals
objects SimpleName MethodInvocation SimpleName entities
objects SimpleName MethodInvocation QualifiedName thatentities
equals SimpleName MethodInvocation SimpleName entities
equals SimpleName MethodInvocation QualifiedName thatentities
entities SimpleName MethodInvocation QualifiedName thatentities
