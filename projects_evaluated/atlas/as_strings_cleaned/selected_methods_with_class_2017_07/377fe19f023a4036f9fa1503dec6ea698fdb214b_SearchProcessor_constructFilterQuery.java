...
to solr query SimpleName MethodInvocation NumberLiteral empty
type SimpleName MethodInvocation SimpleName filter criteria
type SimpleName MethodInvocation SimpleName solr attributes
type SimpleName MethodInvocation NumberLiteral empty
filter criteria SimpleName MethodInvocation SimpleName solr attributes
filter criteria SimpleName MethodInvocation NumberLiteral empty
solr attributes SimpleName MethodInvocation NumberLiteral empty
...
filter query SimpleName VariableDeclarationFragment MethodInvocation NumberLiteral empty
...
solr query SimpleName MethodInvocation SimpleName length
solr query SimpleName MethodInvocation InfixExpression NumberLiteral empty
...
solr query SimpleName MethodInvocation SimpleName append
solr query SimpleName MethodInvocation SimpleName filter query
...
append SimpleName MethodInvocation SimpleName and str
solr query SimpleName MethodInvocation SimpleName append
solr query SimpleName MethodInvocation StringLiteral v state
...
solr query SimpleName MethodInvocation MethodInvocation StringLiteral active
