...
insert into StringLiteral InfixExpression StringLiteral partitiondt = - - ) select id name from
insert into StringLiteral InfixExpression SimpleName table name
insert into StringLiteral InfixExpression StringLiteral where dt = - -
insert table name SimpleName InfixExpression StringLiteral partitiondt = - - ) select id name from
...
partitiondt = - - ) select id name from StringLiteral InfixExpression SimpleName table name
partitiondt = - - ) select id name from StringLiteral InfixExpression StringLiteral where dt = - -
...
query SimpleName VariableDeclarationFragment InfixExpression StringLiteral partitiondt = - - ) select id name from
