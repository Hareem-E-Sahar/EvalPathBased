...
type utilspair QualifiedName SimpleType ParameterizedType SimpleType SimpleName feed
...
get id SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName feed id
...
empty NumberLiteral MethodInvocation MethodInvocation MethodInvocation SimpleName get id
get id SimpleName MethodInvocation MethodInvocation SimpleName get id
input id SimpleName VariableDeclarationFragment MethodInvocation MethodInvocation SimpleName get id
...
assert equals SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName fs data types
assert equals SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName hdfs path
assert equals SimpleName MethodInvocation MethodInvocation SimpleName to string
path entity SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName to string
...
type utilspair QualifiedName MethodInvocation SimpleName feed id
type utilspair QualifiedName MethodInvocation SimpleName feed
...
type utilspair QualifiedName SimpleType ParameterizedType MethodDeclaration SimpleName get hdfs feed
