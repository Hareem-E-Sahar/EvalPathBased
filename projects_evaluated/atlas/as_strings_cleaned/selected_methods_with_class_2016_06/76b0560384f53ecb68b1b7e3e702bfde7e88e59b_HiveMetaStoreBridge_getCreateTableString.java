...
create external table StringLiteral InfixExpression StringLiteral (
...
table SimpleName MethodInvocation InfixExpression StringLiteral (
get table name SimpleName MethodInvocation InfixExpression StringLiteral (
...
( StringLiteral InfixExpression StringLiteral location
...
col list SimpleName EnhancedForStatement Block ReturnStatement SimpleName query
...
private Modifier MethodDeclaration Block EnhancedForStatement SimpleName col list
...
get create table string SimpleName MethodDeclaration Block EnhancedForStatement SimpleName col list
