...
assert process is registered SimpleName MethodInvocation QualifiedName hive operationcreateview
assert process is registered SimpleName MethodInvocation MethodInvocation SimpleName get inputs
assert process is registered SimpleName MethodInvocation MethodInvocation SimpleName table name
assert process is registered SimpleName MethodInvocation MethodInvocation QualifiedName entitytypetable
assert process is registered SimpleName MethodInvocation MethodInvocation SimpleName get outputs
assert process is registered SimpleName MethodInvocation MethodInvocation SimpleName view name
assert process is registered SimpleName MethodInvocation MethodInvocation QualifiedName entitytypetable
