...
assert SimpleName MethodInvocation StringLiteral should only be edge for employees attribute on department type vertex
assert equals SimpleName MethodInvocation SimpleName edge count
assert equals SimpleName MethodInvocation NumberLiteral empty
assert equals SimpleName MethodInvocation StringLiteral should only be edge for employees attribute on department type vertex
edge count SimpleName MethodInvocation NumberLiteral empty
edge count SimpleName MethodInvocation StringLiteral should only be edge for employees attribute on department type vertex
empty NumberLiteral MethodInvocation StringLiteral should only be edge for employees attribute on department type vertex
