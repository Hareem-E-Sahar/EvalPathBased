...
assert test disconnect unidirectional array reference from class type SimpleName MethodInvocation CastExpression MethodInvocation SimpleName table instance
...
table instance SimpleName MethodInvocation CastExpression MethodInvocation SimpleName col id
get SimpleName MethodInvocation CastExpression MethodInvocation SimpleName col id
columns StringLiteral MethodInvocation CastExpression MethodInvocation SimpleName col id
table entity SimpleName MethodInvocation SimpleName get attribute
table entity SimpleName MethodInvocation SimpleName name
get attribute SimpleName MethodInvocation SimpleName name
string SimpleName SimpleType CastExpression MethodInvocation SimpleName table entity
...
test utils v SimpleName MethodInvocation SimpleName table entity
test utils v SimpleName MethodInvocation CastExpression SimpleType SimpleName string
test utils v SimpleName MethodInvocation CastExpression MethodInvocation SimpleName column created
test utils v SimpleName MethodInvocation CastExpression MethodInvocation SimpleName get attribute
test utils v SimpleName MethodInvocation CastExpression MethodInvocation SimpleName name
create column entity SimpleName MethodInvocation SimpleName table entity
create column entity SimpleName MethodInvocation CastExpression SimpleType SimpleName string
create column entity SimpleName MethodInvocation CastExpression MethodInvocation SimpleName column created
create column entity SimpleName MethodInvocation CastExpression MethodInvocation SimpleName get attribute
create column entity SimpleName MethodInvocation CastExpression MethodInvocation SimpleName name
table entity SimpleName MethodInvocation CastExpression SimpleType SimpleName string
table entity SimpleName MethodInvocation CastExpression MethodInvocation SimpleName column created
table entity SimpleName MethodInvocation CastExpression MethodInvocation SimpleName get attribute
table entity SimpleName MethodInvocation CastExpression MethodInvocation SimpleName name
column entity new SimpleName VariableDeclarationFragment MethodInvocation SimpleName test utils v
column entity new SimpleName VariableDeclarationFragment MethodInvocation SimpleName create column entity
