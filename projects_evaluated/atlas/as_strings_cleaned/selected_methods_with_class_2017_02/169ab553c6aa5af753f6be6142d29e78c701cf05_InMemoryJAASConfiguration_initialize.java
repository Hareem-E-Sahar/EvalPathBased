...
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation StringLiteral <== in memory jaas configurationinitialize
log SimpleName MethodInvocation SimpleName application config entry map
debug SimpleName MethodInvocation StringLiteral <== in memory jaas configurationinitialize
debug SimpleName MethodInvocation SimpleName application config entry map
<== in memory jaas configurationinitialize StringLiteral MethodInvocation SimpleName application config entry map
