...
abstract notification consumergson QualifiedName MethodInvocation SimpleName to json
abstract notification consumergson QualifiedName MethodInvocation SimpleName request
to json SimpleName MethodInvocation SimpleName request
notification json SimpleName VariableDeclarationFragment MethodInvocation QualifiedName abstract notification consumergson
...
abstract notification consumergson QualifiedName MethodInvocation SimpleName from json
abstract notification consumergson QualifiedName MethodInvocation SimpleName notification json
abstract notification consumergson QualifiedName MethodInvocation TypeLiteral SimpleType QualifiedName hook notificationhook notification message
from json SimpleName MethodInvocation SimpleName notification json
from json SimpleName MethodInvocation TypeLiteral SimpleType QualifiedName hook notificationhook notification message
notification json SimpleName MethodInvocation TypeLiteral SimpleType QualifiedName hook notificationhook notification message
actual notification SimpleName VariableDeclarationFragment MethodInvocation QualifiedName abstract notification consumergson
actual notification SimpleName VariableDeclarationFragment MethodInvocation SimpleName from json
