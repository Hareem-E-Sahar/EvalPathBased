...
message SimpleName VariableDeclarationFragment MethodInvocation SimpleName consumer
message SimpleName VariableDeclarationFragment MethodInvocation SimpleName next
...
user group information SimpleName MethodInvocation MethodInvocation SimpleName message
user group information SimpleName MethodInvocation MethodInvocation SimpleName get user
create remote user SimpleName MethodInvocation MethodInvocation SimpleName message
create remote user SimpleName MethodInvocation MethodInvocation SimpleName get user
...
ugi SimpleName VariableDeclarationFragment MethodInvocation MethodInvocation SimpleName message
ugi SimpleName VariableDeclarationFragment MethodInvocation MethodInvocation SimpleName get user
user group information SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName ugi
get atlas client SimpleName MethodInvocation SimpleName ugi
atlas client SimpleName VariableDeclarationFragment MethodInvocation SimpleName get atlas client
atlas client SimpleName VariableDeclarationFragment MethodInvocation SimpleName ugi
...
entity partial update SimpleName SwitchCase SwitchStatement SwitchCase SimpleName entity full update
