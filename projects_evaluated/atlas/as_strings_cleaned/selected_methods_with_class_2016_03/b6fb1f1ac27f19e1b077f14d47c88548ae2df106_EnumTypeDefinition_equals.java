...
enum type definition SimpleName SimpleType CastExpression SimpleName o
that SimpleName VariableDeclarationFragment CastExpression SimpleType SimpleName enum type definition
that SimpleName VariableDeclarationFragment CastExpression SimpleName o
enum type definition SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName that
arrays SimpleName MethodInvocation SimpleName equals
arrays SimpleName MethodInvocation SimpleName enum values
arrays SimpleName MethodInvocation QualifiedName thatenum values
equals SimpleName MethodInvocation SimpleName enum values
equals SimpleName MethodInvocation QualifiedName thatenum values
enum values SimpleName MethodInvocation QualifiedName thatenum values
