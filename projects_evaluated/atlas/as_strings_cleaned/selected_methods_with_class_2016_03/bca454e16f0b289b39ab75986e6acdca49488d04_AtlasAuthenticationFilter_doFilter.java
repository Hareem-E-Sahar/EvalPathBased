...
servlets SimpleName MethodInvocation SimpleName get user from request
...
user SimpleName VariableDeclarationFragment MethodInvocation SimpleName servlets
...
final Modifier VariableDeclarationStatement VariableDeclarationFragment MethodInvocation SimpleName get user from request
...
response SimpleName CastExpression ParenthesizedExpression MethodInvocation StringLiteral param username cant be empty
...
send error SimpleName MethodInvocation StringLiteral param username cant be empty
responsestatusbad request QualifiedName MethodInvocation MethodInvocation StringLiteral param username cant be empty
get status code SimpleName MethodInvocation MethodInvocation StringLiteral param username cant be empty
http request SimpleName MethodInvocation SimpleName get method
http request SimpleName MethodInvocation SimpleName get request uri
user SimpleName InfixExpression StringLiteral :
user SimpleName InfixExpression MethodInvocation SimpleName http request
user SimpleName InfixExpression MethodInvocation SimpleName get method
user SimpleName InfixExpression MethodInvocation SimpleName http request
user SimpleName InfixExpression MethodInvocation SimpleName get request uri
...
ndc SimpleName MethodInvocation InfixExpression SimpleName user
...
push SimpleName MethodInvocation InfixExpression SimpleName user
...
request from authenticated user {} url StringLiteral MethodInvocation SimpleName user
...
user SimpleName MethodInvocation MethodInvocation SimpleName servlets
user SimpleName MethodInvocation MethodInvocation SimpleName get request uri
user SimpleName MethodInvocation MethodInvocation SimpleName http request
