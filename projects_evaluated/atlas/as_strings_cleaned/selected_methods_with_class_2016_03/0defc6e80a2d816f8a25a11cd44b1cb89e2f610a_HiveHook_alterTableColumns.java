...
dgi bridgehive client QualifiedName MethodInvocation MethodInvocation SimpleName new table
...
updated table SimpleName VariableDeclarationFragment MethodInvocation QualifiedName dgi bridgehive client
updated table SimpleName VariableDeclarationFragment MethodInvocation SimpleName get table
updated table SimpleName VariableDeclarationFragment MethodInvocation MethodInvocation SimpleName new table
updated table SimpleName VariableDeclarationFragment MethodInvocation MethodInvocation SimpleName get db name
updated table SimpleName VariableDeclarationFragment MethodInvocation MethodInvocation SimpleName new table
updated table SimpleName VariableDeclarationFragment MethodInvocation MethodInvocation SimpleName get table name
table SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName updated table
write entity SimpleName MethodInvocation SimpleName set t
write entity SimpleName MethodInvocation SimpleName updated table
set t SimpleName MethodInvocation SimpleName updated table
...
private Modifier MethodDeclaration SimpleName alter table columns
...
void PrimitiveType MethodDeclaration SimpleName alter table columns
...
alter table columns SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName hive meta store bridge
alter table columns SimpleName MethodDeclaration SingleVariableDeclaration SimpleName dgi bridge
alter table columns SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName hive event
alter table columns SimpleName MethodDeclaration SingleVariableDeclaration SimpleName event
alter table columns SimpleName MethodDeclaration SimpleType SimpleName exception
alter table columns SimpleName MethodDeclaration Block EnhancedForStatement QualifiedName eventoutputs
...
public Modifier TypeDeclaration MethodDeclaration SimpleName alter table columns
...
test SimpleName TypeDeclaration MethodDeclaration SimpleName alter table columns
