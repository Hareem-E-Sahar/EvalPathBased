...
hook notificationentity create request QualifiedName SimpleType ClassInstanceCreation SimpleName entities
...
notif interface SimpleName MethodInvocation ClassInstanceCreation SimpleType QualifiedName hook notificationentity create request
notif interface SimpleName MethodInvocation ClassInstanceCreation SimpleName entities
send SimpleName MethodInvocation QualifiedName notification interfacenotification typehook
send SimpleName MethodInvocation ClassInstanceCreation SimpleType QualifiedName hook notificationentity create request
send SimpleName MethodInvocation ClassInstanceCreation SimpleName entities
notification interfacenotification typehook QualifiedName MethodInvocation ClassInstanceCreation SimpleType QualifiedName hook notificationentity create request
notification interfacenotification typehook QualifiedName MethodInvocation ClassInstanceCreation SimpleName entities
