...
sd ref SimpleName MethodInvocation QualifiedName hive data model generatorstorage num buckets
get SimpleName MethodInvocation QualifiedName hive data model generatorstorage num buckets
...
scalamathbig int QualifiedName SimpleType CastExpression MethodInvocation QualifiedName hive data model generatorstorage num buckets
...
verify bucket sorting properties SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
verify bucket sorting properties SimpleName MethodDeclaration SingleVariableDeclaration SimpleName table name
...
table name SimpleName SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration SimpleName bucket col names
table name SimpleName SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration SimpleName sortcol names
