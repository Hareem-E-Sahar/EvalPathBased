...
hive data model generator SimpleName VariableDeclarationFragment ClassInstanceCreation SimpleType SimpleName hive data model generator
hive data model generator SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName hive data model generator
hive data model generator SimpleName MethodInvocation SimpleName get model as json
model as json SimpleName VariableDeclarationFragment MethodInvocation SimpleName hive data model generator
...
hive data model as json = StringLiteral InfixExpression SimpleName model as json
systemout QualifiedName MethodInvocation SimpleName println
systemout QualifiedName MethodInvocation InfixExpression StringLiteral hive data model as json =
systemout QualifiedName MethodInvocation InfixExpression SimpleName model as json
println SimpleName MethodInvocation InfixExpression StringLiteral hive data model as json =
println SimpleName MethodInvocation InfixExpression SimpleName model as json
hive data model generator SimpleName MethodInvocation SimpleName get types def
types def SimpleName VariableDeclarationFragment MethodInvocation SimpleName hive data model generator
