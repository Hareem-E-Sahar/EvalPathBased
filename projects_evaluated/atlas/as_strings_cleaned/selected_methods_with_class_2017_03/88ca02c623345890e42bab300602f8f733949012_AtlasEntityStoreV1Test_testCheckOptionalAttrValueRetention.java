...
get entity from store SimpleName MethodInvocation MethodInvocation SimpleName response
get entity from store SimpleName MethodInvocation MethodInvocation SimpleName get first created entity by type name
get entity from store SimpleName MethodInvocation MethodInvocation QualifiedName test utils v database type
first entity created SimpleName VariableDeclarationFragment MethodInvocation SimpleName get entity from store
first entity created SimpleName VariableDeclarationFragment MethodInvocation MethodInvocation SimpleName response
first entity created SimpleName VariableDeclarationFragment MethodInvocation MethodInvocation SimpleName get first created entity by type name
first entity created SimpleName VariableDeclarationFragment MethodInvocation MethodInvocation QualifiedName test utils v database type
atlas entity SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName first entity created
...
response SimpleName MethodInvocation QualifiedName test utils v database type
get first updated entity by type name SimpleName MethodInvocation QualifiedName test utils v database type
get entity from store SimpleName MethodInvocation MethodInvocation SimpleName response
get entity from store SimpleName MethodInvocation MethodInvocation SimpleName get first updated entity by type name
get entity from store SimpleName MethodInvocation MethodInvocation QualifiedName test utils v database type
first entity updated SimpleName VariableDeclarationFragment MethodInvocation SimpleName get entity from store
first entity updated SimpleName VariableDeclarationFragment MethodInvocation MethodInvocation SimpleName response
first entity updated SimpleName VariableDeclarationFragment MethodInvocation MethodInvocation SimpleName get first updated entity by type name
first entity updated SimpleName VariableDeclarationFragment MethodInvocation MethodInvocation QualifiedName test utils v database type
atlas entity SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName first entity updated
assert SimpleName MethodInvocation SimpleName assert not null
assert SimpleName MethodInvocation SimpleName first entity updated
assert not null SimpleName MethodInvocation SimpleName first entity updated
