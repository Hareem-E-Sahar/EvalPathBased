...
string SimpleName MethodInvocation SimpleName get by name template
string SimpleName MethodInvocation SimpleName atlas path
string SimpleName MethodInvocation SimpleName name
format SimpleName MethodInvocation SimpleName get by name template
format SimpleName MethodInvocation SimpleName atlas path
format SimpleName MethodInvocation SimpleName name
get by name template SimpleName MethodInvocation SimpleName atlas path
get by name template SimpleName MethodInvocation SimpleName name
atlas path SimpleName MethodInvocation SimpleName name
...
api info SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName get by name template
api info SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName atlas path
api info SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName name
...
get by name template SimpleName MethodInvocation ClassInstanceCreation QualifiedName http methodget
atlas path SimpleName MethodInvocation ClassInstanceCreation QualifiedName http methodget
name SimpleName MethodInvocation ClassInstanceCreation QualifiedName http methodget
...
get by name template SimpleName MethodInvocation ClassInstanceCreation QualifiedName responsestatusok
atlas path SimpleName MethodInvocation ClassInstanceCreation QualifiedName responsestatusok
name SimpleName MethodInvocation ClassInstanceCreation QualifiedName responsestatusok
...
api info SimpleName VariableDeclarationFragment ClassInstanceCreation MethodInvocation SimpleName get by name template
api info SimpleName VariableDeclarationFragment ClassInstanceCreation MethodInvocation SimpleName atlas path
api info SimpleName VariableDeclarationFragment ClassInstanceCreation MethodInvocation SimpleName name
...
private Modifier MethodDeclaration SimpleName get type def by name
...
t SimpleName TypeParameter MethodDeclaration SimpleName get type def by name
...
get type def by name SimpleName MethodDeclaration SingleVariableDeclaration Modifier final
...
get type def by name SimpleName MethodDeclaration SingleVariableDeclaration SimpleName type def class
get type def by name SimpleName MethodDeclaration SimpleType SimpleName atlas service exception
final Modifier SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration SimpleName type def class
name SimpleName SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration SimpleName type def class
