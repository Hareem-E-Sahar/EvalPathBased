...
configuration SimpleName MethodInvocation StringLiteral atlasauthenticationmethodkerberossupportkeytabbrowserlogin
configuration SimpleName MethodInvocation BooleanLiteral false
get boolean SimpleName MethodInvocation StringLiteral atlasauthenticationmethodkerberossupportkeytabbrowserlogin
get boolean SimpleName MethodInvocation BooleanLiteral false
atlasauthenticationmethodkerberossupportkeytabbrowserlogin StringLiteral MethodInvocation BooleanLiteral false
support key tab browser login SimpleName Assignment MethodInvocation SimpleName configuration
support key tab browser login SimpleName Assignment MethodInvocation SimpleName get boolean
support key tab browser login SimpleName Assignment MethodInvocation StringLiteral atlasauthenticationmethodkerberossupportkeytabbrowserlogin
support key tab browser login SimpleName Assignment MethodInvocation BooleanLiteral false
configuration SimpleName MethodInvocation SimpleName get string
