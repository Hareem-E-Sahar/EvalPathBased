...
get resource SimpleName MethodInvocation QualifiedName api v list entity audit
...
api v list entity audit QualifiedName MethodInvocation SimpleName entity id
api v list entity audit QualifiedName MethodInvocation SimpleName uri entity audit
...
resource SimpleName VariableDeclarationFragment MethodInvocation QualifiedName api v list entity audit
...
call api with resource SimpleName MethodInvocation QualifiedName api v list entity audit
call api with resource SimpleName MethodInvocation SimpleName resource
api v list entity audit QualifiedName MethodInvocation SimpleName resource
json response SimpleName VariableDeclarationFragment MethodInvocation SimpleName call api with resource
json response SimpleName VariableDeclarationFragment MethodInvocation QualifiedName api v list entity audit
