...
atlas client v SimpleName MethodInvocation QualifiedName atlas clientapi v name lineage outputs graph
...
call api with body and params SimpleName MethodInvocation QualifiedName atlas clientapi v name lineage outputs graph
...
atlas clientapi v name lineage outputs graph QualifiedName MethodInvocation SimpleName sales fact table
atlas clientapi v name lineage outputs graph QualifiedName MethodInvocation StringLiteral outputs
atlas clientapi v name lineage outputs graph QualifiedName MethodInvocation StringLiteral graph
...
response SimpleName VariableDeclarationFragment MethodInvocation QualifiedName atlas clientapi v name lineage outputs graph
