...
db ref SimpleName MethodInvocation MethodInvocation SimpleName get id
get id SimpleName MethodInvocation MethodInvocation SimpleName get id
log SimpleName MethodInvocation SimpleName info
log SimpleName MethodInvocation StringLiteral database {} is already registered with id {}. updating it
log SimpleName MethodInvocation SimpleName database name
log SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName db ref
...
info SimpleName MethodInvocation StringLiteral database {} is already registered with id {}. updating it
info SimpleName MethodInvocation SimpleName database name
info SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName db ref
...
database {} is already registered with id {}. updating it StringLiteral MethodInvocation SimpleName database name
database {} is already registered with id {}. updating it StringLiteral MethodInvocation MethodInvocation MethodInvocation SimpleName db ref
database {} is already registered with id {}. updating it StringLiteral MethodInvocation MethodInvocation MethodInvocation SimpleName get id
database {} is already registered with id {}. updating it StringLiteral MethodInvocation MethodInvocation SimpleName get id
database name SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName db ref
database name SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName get id
database name SimpleName MethodInvocation MethodInvocation SimpleName get id
create or update db instance SimpleName MethodInvocation SimpleName db
create or update db instance SimpleName MethodInvocation SimpleName db ref
db SimpleName MethodInvocation SimpleName db ref
db ref SimpleName Assignment MethodInvocation SimpleName create or update db instance
db ref SimpleName Assignment MethodInvocation SimpleName db
db ref SimpleName Assignment MethodInvocation SimpleName db ref
update instance SimpleName MethodInvocation SimpleName db ref
