...
json entities SimpleName MethodInvocation SimpleName size
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation StringLiteral update entities count entity json
log SimpleName MethodInvocation MethodInvocation SimpleName json entities
log SimpleName MethodInvocation MethodInvocation SimpleName size
log SimpleName MethodInvocation SimpleName entity json
debug SimpleName MethodInvocation StringLiteral update entities count entity json
debug SimpleName MethodInvocation MethodInvocation SimpleName json entities
...
update entities count entity json StringLiteral MethodInvocation MethodInvocation SimpleName json entities
update entities count entity json StringLiteral MethodInvocation MethodInvocation SimpleName size
update entities count entity json StringLiteral MethodInvocation SimpleName entity json
json entities SimpleName MethodInvocation MethodInvocation SimpleName entity json
size SimpleName MethodInvocation MethodInvocation SimpleName entity json
i SimpleName VariableDeclarationFragment NumberLiteral empty
int PrimitiveType VariableDeclarationExpression VariableDeclarationFragment SimpleName i
int PrimitiveType VariableDeclarationExpression VariableDeclarationFragment NumberLiteral empty
i SimpleName InfixExpression QualifiedName json stringslength
json strings SimpleName ArrayAccess SimpleName i
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation StringLiteral update entities entity
log SimpleName MethodInvocation SimpleName i
log SimpleName MethodInvocation ArrayAccess SimpleName json strings
log SimpleName MethodInvocation ArrayAccess SimpleName i
debug SimpleName MethodInvocation StringLiteral update entities entity
debug SimpleName MethodInvocation SimpleName i
debug SimpleName MethodInvocation ArrayAccess SimpleName json strings
debug SimpleName MethodInvocation ArrayAccess SimpleName i
update entities entity StringLiteral MethodInvocation SimpleName i
update entities entity StringLiteral MethodInvocation ArrayAccess SimpleName json strings
update entities entity StringLiteral MethodInvocation ArrayAccess SimpleName i
i SimpleName MethodInvocation ArrayAccess SimpleName json strings
i SimpleName MethodInvocation ArrayAccess SimpleName i
int PrimitiveType VariableDeclarationExpression ForStatement InfixExpression SimpleName i
int PrimitiveType VariableDeclarationExpression ForStatement InfixExpression QualifiedName json stringslength
int PrimitiveType VariableDeclarationExpression ForStatement PostfixExpression SimpleName i
i SimpleName InfixExpression ForStatement PostfixExpression SimpleName i
json stringslength QualifiedName InfixExpression ForStatement PostfixExpression SimpleName i
