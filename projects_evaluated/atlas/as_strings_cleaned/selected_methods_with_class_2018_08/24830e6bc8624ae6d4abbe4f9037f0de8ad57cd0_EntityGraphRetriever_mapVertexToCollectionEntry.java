...
atlas edge SimpleName SimpleType CastExpression MethodInvocation SimpleName is min ext info
value SimpleName CastExpression MethodInvocation SimpleName is min ext info
...
array element SimpleName MethodInvocation SwitchStatement SwitchCase SimpleName map
...
value SimpleName SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration PrimitiveType boolean
value SimpleName SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration SimpleName is min ext info
...
edge label SimpleName SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration PrimitiveType boolean
edge label SimpleName SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration SimpleName is min ext info
...
edge direction SimpleName SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration Modifier final
edge direction SimpleName SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration PrimitiveType boolean
edge direction SimpleName SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration SimpleName is min ext info
