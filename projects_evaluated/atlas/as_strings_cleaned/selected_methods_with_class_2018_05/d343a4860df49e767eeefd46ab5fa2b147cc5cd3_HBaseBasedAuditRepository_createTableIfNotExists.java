...
column family SimpleName MethodInvocation SimpleName set data block encoding
column family SimpleName MethodInvocation QualifiedName data block encodingfast diff
set data block encoding SimpleName MethodInvocation QualifiedName data block encodingfast diff
column family SimpleName MethodInvocation SimpleName set compression type
column family SimpleName MethodInvocation QualifiedName compressionalgorithmgz
set compression type SimpleName MethodInvocation QualifiedName compressionalgorithmgz
column family SimpleName MethodInvocation SimpleName set bloom filter type
column family SimpleName MethodInvocation QualifiedName bloom typerow
set bloom filter type SimpleName MethodInvocation QualifiedName bloom typerow
