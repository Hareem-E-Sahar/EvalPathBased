test utils v SimpleName MethodInvocation SimpleName define type with complex collection attributes
create types def SimpleName MethodInvocation SimpleName test types defs
test utils v SimpleName MethodInvocation SimpleName create complex collection attr entity
complex collection attr entity SimpleName Assignment MethodInvocation SimpleName test utils v
complex collection attr entity SimpleName Assignment MethodInvocation SimpleName create complex collection attr entity
test utils v SimpleName MethodInvocation SimpleName create complex collection attr entity
complex collection attr entity for delete SimpleName Assignment MethodInvocation SimpleName test utils v
complex collection attr entity for delete SimpleName Assignment MethodInvocation SimpleName create complex collection attr entity
