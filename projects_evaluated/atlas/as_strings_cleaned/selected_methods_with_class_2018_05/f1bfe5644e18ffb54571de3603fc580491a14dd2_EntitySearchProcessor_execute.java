...
final Modifier VariableDeclarationStatement VariableDeclarationFragment SimpleName is last result page
boolean PrimitiveType VariableDeclarationStatement VariableDeclarationFragment SimpleName is last result page
...
entity vertices SimpleName MethodInvocation InfixExpression SimpleName limit
size SimpleName MethodInvocation InfixExpression SimpleName limit
is last result page SimpleName Assignment InfixExpression MethodInvocation SimpleName entity vertices
is last result page SimpleName Assignment InfixExpression MethodInvocation SimpleName size
is last result page SimpleName Assignment InfixExpression SimpleName limit
...
collection utils SimpleName MethodInvocation SimpleName filter
collection utils SimpleName MethodInvocation SimpleName entity vertices
collection utils SimpleName MethodInvocation SimpleName graph query predicate
filter SimpleName MethodInvocation SimpleName entity vertices
filter SimpleName MethodInvocation SimpleName graph query predicate
entity vertices SimpleName MethodInvocation SimpleName graph query predicate
...
final Modifier VariableDeclarationStatement Block IfStatement SimpleName is last result page
boolean PrimitiveType VariableDeclarationStatement Block IfStatement SimpleName is last result page
