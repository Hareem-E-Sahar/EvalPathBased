...
log SimpleName MethodInvocation StringLiteral type system reset invoked by type registry changes
info SimpleName MethodInvocation StringLiteral type system reset invoked by type registry changes
...
types def SimpleName MethodInvocation BooleanLiteral false
...
types added SimpleName MethodInvocation SimpleName size
number of types got from transient type system StringLiteral InfixExpression MethodInvocation SimpleName types added
number of types got from transient type system StringLiteral InfixExpression MethodInvocation SimpleName size
log SimpleName MethodInvocation SimpleName info
log SimpleName MethodInvocation InfixExpression StringLiteral number of types got from transient type system
log SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName types added
log SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName size
info SimpleName MethodInvocation InfixExpression StringLiteral number of types got from transient type system
info SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName types added
...
log SimpleName MethodInvocation StringLiteral failed to restore typesystem after type registry changes
log SimpleName MethodInvocation SimpleName e
error SimpleName MethodInvocation StringLiteral failed to restore typesystem after type registry changes
error SimpleName MethodInvocation SimpleName e
failed to restore typesystem after type registry changes StringLiteral MethodInvocation SimpleName e
