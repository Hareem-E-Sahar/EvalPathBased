...
pre create result SimpleName InstanceofExpression SimpleType SimpleName atlas vertex
pre create SimpleName MethodInvocation SimpleName struct def
vertex SimpleName Assignment MethodInvocation SimpleName pre create
vertex SimpleName Assignment MethodInvocation SimpleName struct def
atlas vertex SimpleName SimpleType CastExpression SimpleName pre create result
vertex SimpleName Assignment CastExpression SimpleType SimpleName atlas vertex
vertex SimpleName Assignment CastExpression SimpleName pre create result
