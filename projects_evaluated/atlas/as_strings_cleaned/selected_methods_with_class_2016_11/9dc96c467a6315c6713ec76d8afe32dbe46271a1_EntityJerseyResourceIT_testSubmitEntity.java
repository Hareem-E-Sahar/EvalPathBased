...
db instance SimpleName VariableDeclarationFragment MethodInvocation SimpleName create hive db instance
db instance SimpleName VariableDeclarationFragment MethodInvocation SimpleName database name
referenceable SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName db instance
create instance SimpleName MethodInvocation SimpleName db instance
...
uuid SimpleName MethodInvocation MethodInvocation SimpleName db id
uuid SimpleName MethodInvocation MethodInvocation SimpleName get id
from string SimpleName MethodInvocation MethodInvocation SimpleName db id
from string SimpleName MethodInvocation MethodInvocation SimpleName get id
...
assert not null SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName db id
assert not null SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName get id
db instance SimpleName MethodInvocation SimpleName replace with new id
db instance SimpleName MethodInvocation SimpleName db id
...
db id SimpleName MethodInvocation SimpleName get id
response is not a guid StringLiteral InfixExpression MethodInvocation SimpleName db id
response is not a guid StringLiteral InfixExpression MethodInvocation SimpleName get id
...
assert SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName db id
assert SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName get id
fail SimpleName MethodInvocation InfixExpression StringLiteral response is not a guid
fail SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName db id
fail SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName get id
...
db instance SimpleName MethodInvocation SimpleName table name
table instance SimpleName Assignment MethodInvocation SimpleName create hive table instance
table instance SimpleName Assignment MethodInvocation SimpleName db instance
