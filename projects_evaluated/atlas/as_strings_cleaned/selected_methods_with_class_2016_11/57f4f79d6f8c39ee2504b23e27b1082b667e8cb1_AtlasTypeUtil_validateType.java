...
type name SimpleName VariableDeclarationFragment MethodInvocation SimpleName type def
...
is valid type name SimpleName MethodInvocation SimpleName type name
...
atlas error codetype name invalid format QualifiedName ClassInstanceCreation SimpleName type name
...
type name SimpleName ClassInstanceCreation MethodInvocation MethodInvocation SimpleName type def
type name SimpleName ClassInstanceCreation MethodInvocation MethodInvocation SimpleName get category
type name SimpleName ClassInstanceCreation MethodInvocation SimpleName name
