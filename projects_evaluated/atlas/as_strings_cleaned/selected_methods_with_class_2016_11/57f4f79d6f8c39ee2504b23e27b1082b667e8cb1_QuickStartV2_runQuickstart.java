...
quick start v SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName quick start v
authentication util SimpleName MethodInvocation SimpleName is kerberos authentication enabled
quick start v SimpleName SimpleType ClassInstanceCreation SimpleName urls
quick start v SimpleName SimpleType ClassInstanceCreation SimpleName basic auth username password
urls SimpleName ClassInstanceCreation SimpleName basic auth username password
quick start v SimpleName Assignment ClassInstanceCreation SimpleType SimpleName quick start v
quick start v SimpleName Assignment ClassInstanceCreation SimpleName urls
quick start v SimpleName Assignment ClassInstanceCreation SimpleName basic auth username password
quick start v SimpleName SimpleType ClassInstanceCreation SimpleName urls
quick start v SimpleName Assignment ClassInstanceCreation SimpleType SimpleName quick start v
quick start v SimpleName Assignment ClassInstanceCreation SimpleName urls
quick start v SimpleName MethodInvocation SimpleName create types
quick start v SimpleName MethodInvocation SimpleName create entities
quick start v SimpleName MethodInvocation SimpleName search
quick start v SimpleName MethodInvocation SimpleName lineage
