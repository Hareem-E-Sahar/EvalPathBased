...
atlas client v SimpleName MethodInvocation QualifiedName atlas clientapiname lineage inputs graph
...
call api with body and params SimpleName MethodInvocation QualifiedName atlas clientapiname lineage inputs graph
...
atlas clientapiname lineage inputs graph QualifiedName MethodInvocation SimpleName sales monthly table
atlas clientapiname lineage inputs graph QualifiedName MethodInvocation StringLiteral inputs
atlas clientapiname lineage inputs graph QualifiedName MethodInvocation StringLiteral graph
...
response SimpleName VariableDeclarationFragment MethodInvocation QualifiedName atlas clientapiname lineage inputs graph
