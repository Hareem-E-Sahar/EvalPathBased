...
cid SimpleName VariableDeclarationFragment MethodInvocation SimpleName long
cid SimpleName VariableDeclarationFragment MethodInvocation SimpleName parse long
cid SimpleName VariableDeclarationFragment MethodInvocation ClassInstanceCreation SimpleName current value
cid SimpleName VariableDeclarationFragment MethodInvocation ClassInstanceCreation QualifiedName standard charsetsutf
long PrimitiveType VariableDeclarationStatement VariableDeclarationFragment SimpleName cid
...
cid SimpleName InfixExpression SimpleName flush id
...
long SimpleName MethodInvocation MethodInvocation QualifiedName standard charsetsutf
to string SimpleName MethodInvocation MethodInvocation QualifiedName standard charsetsutf
flush id SimpleName MethodInvocation MethodInvocation QualifiedName standard charsetsutf
get bytes SimpleName MethodInvocation QualifiedName standard charsetsutf
long SimpleName MethodInvocation SimpleName to string
long SimpleName MethodInvocation SimpleName cid
to string SimpleName MethodInvocation SimpleName cid
long SimpleName MethodInvocation MethodInvocation SimpleName get bytes
to string SimpleName MethodInvocation MethodInvocation SimpleName get bytes
cid SimpleName MethodInvocation MethodInvocation SimpleName get bytes
long SimpleName MethodInvocation MethodInvocation QualifiedName standard charsetsutf
to string SimpleName MethodInvocation MethodInvocation QualifiedName standard charsetsutf
cid SimpleName MethodInvocation MethodInvocation QualifiedName standard charsetsutf
get bytes SimpleName MethodInvocation QualifiedName standard charsetsutf
