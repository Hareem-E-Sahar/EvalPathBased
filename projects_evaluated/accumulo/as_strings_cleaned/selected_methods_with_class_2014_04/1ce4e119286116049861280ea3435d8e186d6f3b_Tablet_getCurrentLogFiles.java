...
result SimpleName MethodInvocation MethodInvocation SimpleName get file name
...
public Modifier MethodDeclaration SimpleName get current log files
...
set SimpleName SimpleType ParameterizedType MethodDeclaration SimpleName get current log files
string SimpleName SimpleType ParameterizedType MethodDeclaration SimpleName get current log files
get current log files SimpleName MethodDeclaration Block SynchronizedStatement SimpleName current logs
get current log files SimpleName MethodDeclaration Block ReturnStatement SimpleName result
public Modifier TypeDeclaration SimpleName test
public Modifier TypeDeclaration MethodDeclaration Modifier public
public Modifier TypeDeclaration MethodDeclaration SimpleName get current log files
test SimpleName TypeDeclaration MethodDeclaration Modifier public
test SimpleName TypeDeclaration MethodDeclaration SimpleName get current log files
