...
replication table id SimpleName MethodInvocation SimpleName equals
replication table id SimpleName MethodInvocation MethodInvocation SimpleName observed log
replication table id SimpleName MethodInvocation MethodInvocation SimpleName get value
equals SimpleName MethodInvocation MethodInvocation SimpleName observed log
equals SimpleName MethodInvocation MethodInvocation SimpleName get value
observed logs SimpleName MethodInvocation SimpleName remove
metadata log distribution StringLiteral InfixExpression SimpleName logs
logs SimpleName MethodInvocation SimpleName key set
assert SimpleName MethodInvocation SimpleName assert equals
assert SimpleName MethodInvocation InfixExpression StringLiteral metadata log distribution
assert SimpleName MethodInvocation InfixExpression SimpleName logs
assert SimpleName MethodInvocation MethodInvocation SimpleName logs
assert SimpleName MethodInvocation MethodInvocation SimpleName key set
assert SimpleName MethodInvocation SimpleName repl files
assert equals SimpleName MethodInvocation InfixExpression StringLiteral metadata log distribution
assert equals SimpleName MethodInvocation InfixExpression SimpleName logs
assert equals SimpleName MethodInvocation MethodInvocation SimpleName logs
assert equals SimpleName MethodInvocation MethodInvocation SimpleName key set
assert equals SimpleName MethodInvocation SimpleName repl files
metadata log distribution StringLiteral InfixExpression MethodInvocation MethodInvocation SimpleName logs
metadata log distribution StringLiteral InfixExpression MethodInvocation MethodInvocation SimpleName key set
logs SimpleName InfixExpression MethodInvocation MethodInvocation SimpleName logs
logs SimpleName InfixExpression MethodInvocation MethodInvocation SimpleName key set
metadata log distribution StringLiteral InfixExpression MethodInvocation SimpleName repl files
logs SimpleName InfixExpression MethodInvocation SimpleName repl files
logs SimpleName MethodInvocation MethodInvocation SimpleName repl files
key set SimpleName MethodInvocation MethodInvocation SimpleName repl files
entry SimpleName SimpleType ParameterizedType SimpleType SimpleName key
entry SimpleName SimpleType ParameterizedType SimpleType SimpleName value
