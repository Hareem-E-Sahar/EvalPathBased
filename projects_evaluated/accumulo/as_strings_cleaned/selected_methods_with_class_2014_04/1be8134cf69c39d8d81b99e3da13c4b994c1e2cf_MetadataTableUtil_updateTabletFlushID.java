...
flush id SimpleName InfixExpression StringLiteral empty
...
flush id SimpleName InfixExpression ParenthesizedExpression MethodInvocation QualifiedName standard charsetsutf
...
tablets sectionserver column familyflush column QualifiedName MethodInvocation ClassInstanceCreation MethodInvocation QualifiedName standard charsetsutf
...
public Modifier MethodDeclaration SimpleName update tablet flush id
...
static Modifier MethodDeclaration SimpleName update tablet flush id
...
static Modifier MethodDeclaration SingleVariableDeclaration SimpleName flush id
...
void PrimitiveType MethodDeclaration SimpleName update tablet flush id
...
void PrimitiveType MethodDeclaration SingleVariableDeclaration SimpleName flush id
...
update tablet flush id SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName key extent
update tablet flush id SimpleName MethodDeclaration SingleVariableDeclaration SimpleName extent
update tablet flush id SimpleName MethodDeclaration SingleVariableDeclaration PrimitiveType long
update tablet flush id SimpleName MethodDeclaration SingleVariableDeclaration SimpleName flush id
update tablet flush id SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName credentials
update tablet flush id SimpleName MethodDeclaration SingleVariableDeclaration SimpleName credentials
update tablet flush id SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName zoo lock
update tablet flush id SimpleName MethodDeclaration SingleVariableDeclaration SimpleName zoo lock
extent SimpleName SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration PrimitiveType long
extent SimpleName SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration SimpleName flush id
...
flush id SimpleName SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration SimpleName credentials
long PrimitiveType SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration SimpleName zoo lock
flush id SimpleName SingleVariableDeclaration MethodDeclaration SingleVariableDeclaration SimpleName zoo lock
...
public Modifier TypeDeclaration MethodDeclaration SimpleName update tablet flush id
...
test SimpleName TypeDeclaration MethodDeclaration SimpleName update tablet flush id
