...
collection SimpleName SimpleType ParameterizedType SimpleType SimpleName remote logger
collection SimpleName SimpleType ParameterizedType SingleVariableDeclaration SimpleName more
remote logger SimpleName SimpleType ParameterizedType SingleVariableDeclaration SimpleName more
...
mem table SimpleName InfixExpression QualifiedName tablet memoryother mem table
add to other SimpleName Assignment BooleanLiteral true
mem table SimpleName InfixExpression QualifiedName tablet memorymem table
...
other logs SimpleName MethodInvocation SimpleName logger
contains SimpleName MethodInvocation SimpleName logger
remote logger SimpleName SimpleType SingleVariableDeclaration EnhancedForStatement SimpleName more
...
private Modifier MethodDeclaration SimpleName begin updating logs used
...
private Modifier MethodDeclaration SingleVariableDeclaration SimpleName more
private Modifier MethodDeclaration SingleVariableDeclaration PrimitiveType boolean
private Modifier MethodDeclaration SingleVariableDeclaration SimpleName minc finish
