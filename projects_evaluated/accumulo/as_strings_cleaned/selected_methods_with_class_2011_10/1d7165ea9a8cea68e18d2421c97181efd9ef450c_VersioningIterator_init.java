...
num versions SimpleName FieldAccess Assignment NumberLiteral empty
options SimpleName MethodInvocation SimpleName get
options SimpleName MethodInvocation StringLiteral max versions
get SimpleName MethodInvocation StringLiteral max versions
max ver string SimpleName VariableDeclarationFragment MethodInvocation SimpleName options
max ver string SimpleName VariableDeclarationFragment MethodInvocation SimpleName get
max ver string SimpleName VariableDeclarationFragment MethodInvocation StringLiteral max versions
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName max ver string
integer SimpleName MethodInvocation SimpleName parse int
integer SimpleName MethodInvocation SimpleName max ver string
parse int SimpleName MethodInvocation SimpleName max ver string
max versions SimpleName FieldAccess Assignment MethodInvocation SimpleName integer
max versions SimpleName FieldAccess Assignment MethodInvocation SimpleName parse int
max versions SimpleName FieldAccess Assignment MethodInvocation SimpleName max ver string
max versions SimpleName FieldAccess Assignment NumberLiteral empty
max versions SimpleName InfixExpression NumberLiteral empty
illegal argument exception SimpleName SimpleType ClassInstanceCreation StringLiteral max versions for versioning iterator must be >=
