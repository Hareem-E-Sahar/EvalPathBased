...
infinite start key SimpleName Assignment MethodInvocation SimpleName in
infinite start key SimpleName Assignment MethodInvocation SimpleName read boolean
in SimpleName MethodInvocation SimpleName read boolean
infinite stop key SimpleName Assignment MethodInvocation SimpleName in
infinite stop key SimpleName Assignment MethodInvocation SimpleName read boolean
start SimpleName Assignment ClassInstanceCreation SimpleType SimpleName key
start SimpleName MethodInvocation SimpleName read fields
start SimpleName MethodInvocation SimpleName in
read fields SimpleName MethodInvocation SimpleName in
stop SimpleName Assignment ClassInstanceCreation SimpleType SimpleName key
stop SimpleName MethodInvocation SimpleName read fields
stop SimpleName MethodInvocation SimpleName in
read fields SimpleName MethodInvocation SimpleName in
in SimpleName MethodInvocation SimpleName read boolean
start key inclusive SimpleName Assignment MethodInvocation SimpleName in
start key inclusive SimpleName Assignment MethodInvocation SimpleName read boolean
in SimpleName MethodInvocation SimpleName read boolean
stop key inclusive SimpleName Assignment MethodInvocation SimpleName in
stop key inclusive SimpleName Assignment MethodInvocation SimpleName read boolean
