...
root SimpleName MethodInvocation MethodInvocation InfixExpression StringLiteral $
length SimpleName MethodInvocation MethodInvocation InfixExpression StringLiteral $
path SimpleName MethodInvocation InfixExpression SimpleName eid
substring SimpleName MethodInvocation InfixExpression SimpleName eid
root SimpleName MethodInvocation MethodInvocation InfixExpression SimpleName eid
length SimpleName MethodInvocation MethodInvocation InfixExpression SimpleName eid
/ StringLiteral InfixExpression SimpleName node
/ StringLiteral InfixExpression StringLiteral $
/ StringLiteral InfixExpression SimpleName eid
node SimpleName InfixExpression StringLiteral $
node SimpleName InfixExpression SimpleName eid
$ StringLiteral InfixExpression SimpleName eid
