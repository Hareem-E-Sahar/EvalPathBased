...
o SimpleName InstanceofExpression SimpleType SimpleName byte sequence
byte sequence SimpleName SimpleType CastExpression SimpleName o
obs SimpleName VariableDeclarationFragment CastExpression SimpleType SimpleName byte sequence
obs SimpleName VariableDeclarationFragment CastExpression SimpleName o
byte sequence SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName obs
...
length SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName obs
length SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName length
compare to SimpleName MethodInvocation SimpleName obs
compare to SimpleName MethodInvocation InfixExpression NumberLiteral empty
obs SimpleName MethodInvocation InfixExpression NumberLiteral empty
