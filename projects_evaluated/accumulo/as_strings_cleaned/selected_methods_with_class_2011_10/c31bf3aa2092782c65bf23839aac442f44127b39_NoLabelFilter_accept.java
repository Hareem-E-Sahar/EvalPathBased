...
label SimpleName VariableDeclarationFragment ClassInstanceCreation SimpleType SimpleName column visibility
label SimpleName VariableDeclarationFragment ClassInstanceCreation MethodInvocation SimpleName k
label SimpleName VariableDeclarationFragment ClassInstanceCreation MethodInvocation SimpleName get column visibility
column visibility SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName label
label SimpleName MethodInvocation SimpleName get expression
label SimpleName MethodInvocation FieldAccess SimpleName length
get expression SimpleName MethodInvocation FieldAccess SimpleName length
label SimpleName MethodInvocation FieldAccess InfixExpression NumberLiteral empty
