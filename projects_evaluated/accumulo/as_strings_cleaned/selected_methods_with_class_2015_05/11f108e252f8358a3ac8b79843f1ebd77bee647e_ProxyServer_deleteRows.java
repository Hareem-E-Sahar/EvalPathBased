...
login SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName delete rows
...
delete rows SimpleName MethodInvocation MethodInvocation SimpleName byte buffer util
delete rows SimpleName MethodInvocation MethodInvocation SimpleName to text
delete rows SimpleName MethodInvocation MethodInvocation SimpleName start row
delete rows SimpleName MethodInvocation MethodInvocation SimpleName byte buffer util
delete rows SimpleName MethodInvocation MethodInvocation SimpleName to text
delete rows SimpleName MethodInvocation MethodInvocation SimpleName end row
...
delete rows SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName byte buffer
delete rows SimpleName MethodDeclaration SingleVariableDeclaration SimpleName login
...
delete rows SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName byte buffer
delete rows SimpleName MethodDeclaration SingleVariableDeclaration SimpleName start row
delete rows SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName byte buffer
delete rows SimpleName MethodDeclaration SingleVariableDeclaration SimpleName end row
delete rows SimpleName MethodDeclaration SimpleType QualifiedName orgapacheaccumuloproxythriftaccumulo exception
