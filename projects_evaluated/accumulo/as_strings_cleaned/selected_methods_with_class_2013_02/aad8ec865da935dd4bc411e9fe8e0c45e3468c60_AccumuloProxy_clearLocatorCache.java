...
orgapachethriftasyncasync method callback QualifiedName SimpleType ParameterizedType SimpleType SimpleName clear locator cache call
...
clear locator cache call SimpleName SimpleType ParameterizedType SingleVariableDeclaration SimpleName result handler
clear locator cache call SimpleName SimpleType ClassInstanceCreation SimpleName login
clear locator cache call SimpleName SimpleType ClassInstanceCreation SimpleName table name
clear locator cache call SimpleName SimpleType ClassInstanceCreation SimpleName result handler
clear locator cache call SimpleName SimpleType ClassInstanceCreation SimpleName protocol factory
...
method call SimpleName VariableDeclarationFragment ClassInstanceCreation SimpleType SimpleName clear locator cache call
...
clear locator cache call SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName method call
...
clear locator cache SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName byte buffer
clear locator cache SimpleName MethodDeclaration SingleVariableDeclaration SimpleName login
...
clear locator cache SimpleName MethodDeclaration SingleVariableDeclaration SimpleName result handler
clear locator cache SimpleName MethodDeclaration SimpleType QualifiedName orgapachethriftt exception
