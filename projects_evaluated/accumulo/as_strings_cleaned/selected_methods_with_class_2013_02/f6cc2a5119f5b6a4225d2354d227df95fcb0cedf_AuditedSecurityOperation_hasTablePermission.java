...
has table permission SimpleName SuperMethodInvocation SimpleName credentials
has table permission SimpleName SuperMethodInvocation SimpleName user
has table permission SimpleName SuperMethodInvocation SimpleName table
has table permission SimpleName SuperMethodInvocation SimpleName permission
...
result SimpleName VariableDeclarationFragment SuperMethodInvocation SimpleName has table permission
...
result SimpleName VariableDeclarationFragment SuperMethodInvocation SimpleName table
...
boolean PrimitiveType VariableDeclarationStatement VariableDeclarationFragment SuperMethodInvocation SimpleName has table permission
...
boolean PrimitiveType VariableDeclarationStatement VariableDeclarationFragment SuperMethodInvocation SimpleName table
...
audit SimpleName MethodInvocation StringLiteral checked permission s on table s for s
...
credentials SimpleName MethodInvocation StringLiteral checked permission s on table s for s
...
checked permission s on table s for s StringLiteral MethodInvocation SimpleName permission
checked permission s on table s for s StringLiteral MethodInvocation SimpleName table
checked permission s on table s for s StringLiteral MethodInvocation SimpleName user
...
has table permission SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName credentials
...
has table permission SimpleName MethodDeclaration SimpleType SimpleName thrift security exception
