check class result SimpleName SimpleType SingleVariableDeclaration SimpleName other
...
check class result SimpleName SimpleType CastExpression SimpleName other
typed other SimpleName VariableDeclarationFragment CastExpression SimpleType SimpleName check class result
typed other SimpleName VariableDeclarationFragment CastExpression SimpleName other
check class result SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName typed other
...
public Modifier MethodDeclaration SingleVariableDeclaration SimpleType SimpleName check class result
...
int PrimitiveType MethodDeclaration SingleVariableDeclaration SimpleType SimpleName check class result
...
compare to SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName check class result
