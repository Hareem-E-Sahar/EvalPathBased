...
table configuration SimpleName MethodInvocation QualifiedName propertytable scan maxmem
get memory in bytes SimpleName MethodInvocation QualifiedName propertytable scan maxmem
max results size SimpleName VariableDeclarationFragment MethodInvocation SimpleName table configuration
...
long PrimitiveType VariableDeclarationStatement VariableDeclarationFragment MethodInvocation SimpleName table configuration
...
batch SimpleName SimpleType ClassInstanceCreation SimpleName skip continue key
batch SimpleName SimpleType ClassInstanceCreation SimpleName results
batch SimpleName SimpleType ClassInstanceCreation SimpleName continue key
batch SimpleName SimpleType ClassInstanceCreation SimpleName result bytes
skip continue key SimpleName ClassInstanceCreation SimpleName results
skip continue key SimpleName ClassInstanceCreation SimpleName continue key
skip continue key SimpleName ClassInstanceCreation SimpleName result bytes
results SimpleName ClassInstanceCreation SimpleName continue key
results SimpleName ClassInstanceCreation SimpleName result bytes
continue key SimpleName ClassInstanceCreation SimpleName result bytes
...
boolean PrimitiveType VariableDeclarationStatement Block IfStatement SimpleName end of tablet reached
boolean PrimitiveType VariableDeclarationStatement Block IfStatement SimpleName end of tablet reached
