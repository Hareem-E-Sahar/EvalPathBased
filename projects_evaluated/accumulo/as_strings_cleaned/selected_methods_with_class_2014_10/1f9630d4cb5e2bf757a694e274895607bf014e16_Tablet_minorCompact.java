...
get datafile manager SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName get
get datafile sizes SimpleName MethodInvocation MethodInvocation SimpleName get
get datafile manager SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName merge file
...
minor compactor SimpleName SimpleType ClassInstanceCreation SimpleName tmp datafile
...
mem table SimpleName ClassInstanceCreation SimpleName minc reason
mem table SimpleName ClassInstanceCreation SimpleName table configuration
...
merge file SimpleName ClassInstanceCreation SimpleName table configuration
dfv SimpleName ClassInstanceCreation SimpleName tmp datafile
dfv SimpleName ClassInstanceCreation SimpleName minc reason
dfv SimpleName ClassInstanceCreation SimpleName table configuration
tmp datafile SimpleName ClassInstanceCreation SimpleName minc reason
tmp datafile SimpleName ClassInstanceCreation SimpleName table configuration
minc reason SimpleName ClassInstanceCreation SimpleName table configuration
...
compactor SimpleName VariableDeclarationFragment ClassInstanceCreation SimpleName table configuration
...
get datafile manager SimpleName MethodInvocation MethodInvocation SimpleName bring minor compaction online
get datafile manager SimpleName MethodInvocation MethodInvocation SimpleName tmp datafile
get datafile manager SimpleName MethodInvocation MethodInvocation SimpleName new datafile
get datafile manager SimpleName MethodInvocation MethodInvocation SimpleName merge file
...
failed SimpleName Assignment BooleanLiteral true
runtime exception SimpleName SimpleType ClassInstanceCreation SimpleName e
get tablet memory SimpleName MethodInvocation MethodInvocation SimpleName finalize min c
...
get tablet server SimpleName MethodInvocation MethodInvocation SimpleName get min c metrics
min c metrics SimpleName VariableDeclarationFragment MethodInvocation MethodInvocation SimpleName get tablet server
min c metrics SimpleName VariableDeclarationFragment MethodInvocation SimpleName get min c metrics
tablet server min c metrics SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName min c metrics
min c metrics SimpleName MethodInvocation SimpleName is enabled
last minor compaction finish time SimpleName InfixExpression SimpleName start
min c metrics SimpleName MethodInvocation SimpleName add
min c metrics SimpleName MethodInvocation QualifiedName tablet server min c metricsminc
min c metrics SimpleName MethodInvocation ParenthesizedExpression InfixExpression SimpleName last minor compaction finish time
min c metrics SimpleName MethodInvocation ParenthesizedExpression InfixExpression SimpleName start
...
min c metrics SimpleName MethodInvocation SimpleName add
min c metrics SimpleName MethodInvocation QualifiedName tablet server min c metricsqueue
min c metrics SimpleName MethodInvocation ParenthesizedExpression InfixExpression SimpleName start
min c metrics SimpleName MethodInvocation ParenthesizedExpression InfixExpression SimpleName queued
...
data file value SimpleName SimpleType MethodDeclaration SingleVariableDeclaration SimpleName new datafile
...
minor compact SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName file ref
minor compact SimpleName MethodDeclaration SingleVariableDeclaration SimpleName merge file
