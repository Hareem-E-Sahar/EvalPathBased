...
master SimpleName ThisExpression FieldAccess SimpleName next event
master SimpleName ThisExpression FieldAccess MethodInvocation SimpleName event
next event SimpleName FieldAccess MethodInvocation SimpleName event
master SimpleName ThisExpression FieldAccess MethodInvocation StringLiteral stopped event loop
next event SimpleName FieldAccess MethodInvocation StringLiteral stopped event loop
event SimpleName MethodInvocation StringLiteral stopped event loop
...
schedule SimpleName MethodInvocation NumberLiteral l
runnable SimpleName SimpleType ClassInstanceCreation MethodInvocation NumberLiteral l
runnable SimpleName SimpleType ClassInstanceCreation MethodInvocation NumberLiteral l
