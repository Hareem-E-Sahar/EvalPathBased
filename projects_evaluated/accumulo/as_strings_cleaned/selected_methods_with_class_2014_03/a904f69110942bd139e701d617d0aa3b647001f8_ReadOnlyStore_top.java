...
read only repo wrapper SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName store
read only repo wrapper SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName top
read only repo wrapper SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName tid
...
public Modifier MethodDeclaration ParameterizedType SimpleType SimpleName read only repo
...
read only repo SimpleName SimpleType ParameterizedType MethodDeclaration SimpleName top
