...
gc cycle stats SimpleName SimpleType CastExpression SimpleName value
set last SimpleName MethodInvocation CastExpression SimpleType SimpleName gc cycle stats
set last SimpleName MethodInvocation CastExpression SimpleName value
gc cycle stats SimpleName SimpleType CastExpression SimpleName value
set last log SimpleName MethodInvocation CastExpression SimpleType SimpleName gc cycle stats
set last log SimpleName MethodInvocation CastExpression SimpleName value
gc cycle stats SimpleName SimpleType CastExpression SimpleName value
set current SimpleName MethodInvocation CastExpression SimpleType SimpleName gc cycle stats
set current SimpleName MethodInvocation CastExpression SimpleName value
gc cycle stats SimpleName SimpleType CastExpression SimpleName value
set current log SimpleName MethodInvocation CastExpression SimpleType SimpleName gc cycle stats
set current log SimpleName MethodInvocation CastExpression SimpleName value
field SimpleName SwitchStatement SwitchCase SimpleName last
field SimpleName SwitchStatement IfStatement InfixExpression SimpleName value
field SimpleName SwitchStatement SwitchCase SimpleName last log
field SimpleName SwitchStatement IfStatement InfixExpression SimpleName value
last SimpleName SwitchCase SwitchStatement SwitchCase SimpleName last log
last log SimpleName SwitchCase SwitchStatement SwitchCase SimpleName current
current SimpleName SwitchCase SwitchStatement SwitchCase SimpleName current log
