...
set running SimpleName MethodInvocation CastExpression SimpleType SimpleName integer
set running SimpleName MethodInvocation CastExpression SimpleName value
integer SimpleName SimpleType CastExpression SimpleName value
set queued SimpleName MethodInvocation CastExpression SimpleType SimpleName integer
set queued SimpleName MethodInvocation CastExpression SimpleName value
field SimpleName SwitchStatement SwitchCase SimpleName running
field SimpleName SwitchStatement IfStatement InfixExpression SimpleName value
field SimpleName SwitchStatement SwitchCase SimpleName queued
field SimpleName SwitchStatement IfStatement InfixExpression SimpleName value
running SimpleName SwitchCase SwitchStatement SwitchCase SimpleName queued
