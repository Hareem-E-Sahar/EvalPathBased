...
set scan id SimpleName MethodInvocation CastExpression SimpleType SimpleName long
set scan id SimpleName MethodInvocation CastExpression SimpleName value
scan result SimpleName SimpleType CastExpression SimpleName value
set result SimpleName MethodInvocation CastExpression SimpleType SimpleName scan result
set result SimpleName MethodInvocation CastExpression SimpleName value
field SimpleName SwitchStatement SwitchCase SimpleName scan id
field SimpleName SwitchStatement IfStatement InfixExpression SimpleName value
field SimpleName SwitchStatement SwitchCase SimpleName result
field SimpleName SwitchStatement IfStatement InfixExpression SimpleName value
scan id SimpleName SwitchCase SwitchStatement SwitchCase SimpleName result
