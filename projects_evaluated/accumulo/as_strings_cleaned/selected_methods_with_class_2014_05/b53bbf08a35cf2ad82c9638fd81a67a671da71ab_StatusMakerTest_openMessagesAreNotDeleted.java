...
time created SimpleName VariableDeclarationFragment NumberLiteral empty
long PrimitiveType VariableDeclarationStatement VariableDeclarationFragment SimpleName time created
...
status util SimpleName MethodInvocation SimpleName file created value
status util SimpleName MethodInvocation SimpleName time created
file created value SimpleName MethodInvocation SimpleName time created
...
m SimpleName MethodInvocation MethodInvocation SimpleName file created value
m SimpleName MethodInvocation MethodInvocation SimpleName time created
...
put SimpleName MethodInvocation MethodInvocation SimpleName file created value
put SimpleName MethodInvocation MethodInvocation SimpleName time created
...
replication sectioncolf QualifiedName MethodInvocation MethodInvocation SimpleName file created value
replication sectioncolf QualifiedName MethodInvocation MethodInvocation SimpleName time created
...
long PrimitiveType VariableDeclarationStatement Block EnhancedForStatement SimpleName files
...
open messages are not deleted SimpleName MethodDeclaration Block VariableDeclarationStatement PrimitiveType long
