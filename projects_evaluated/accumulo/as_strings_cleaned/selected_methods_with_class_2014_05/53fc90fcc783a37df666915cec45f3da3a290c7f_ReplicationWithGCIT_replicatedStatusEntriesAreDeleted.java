...
boolean PrimitiveType VariableDeclarationStatement VariableDeclarationFragment SimpleName found results
boolean PrimitiveType VariableDeclarationStatement VariableDeclarationFragment BooleanLiteral false
i SimpleName VariableDeclarationFragment NumberLiteral empty
int PrimitiveType VariableDeclarationExpression VariableDeclarationFragment SimpleName i
int PrimitiveType VariableDeclarationExpression VariableDeclarationFragment NumberLiteral empty
i SimpleName InfixExpression NumberLiteral empty
i SimpleName InfixExpression InfixExpression PrefixExpression SimpleName found results
empty NumberLiteral InfixExpression InfixExpression PrefixExpression SimpleName found results
conn SimpleName MethodInvocation SimpleName create scanner
...
iterables SimpleName MethodInvocation InfixExpression NumberLiteral empty
size SimpleName MethodInvocation InfixExpression NumberLiteral empty
s SimpleName MethodInvocation InfixExpression NumberLiteral empty
found results SimpleName Assignment BooleanLiteral true
thread SimpleName MethodInvocation SimpleName sleep
thread SimpleName MethodInvocation NumberLiteral empty
sleep SimpleName MethodInvocation NumberLiteral empty
int PrimitiveType VariableDeclarationExpression ForStatement PostfixExpression SimpleName i
assert SimpleName MethodInvocation SimpleName assert true
assert SimpleName MethodInvocation StringLiteral did not find any replication entries in the metadata table
assert SimpleName MethodInvocation SimpleName found results
assert true SimpleName MethodInvocation StringLiteral did not find any replication entries in the metadata table
assert true SimpleName MethodInvocation SimpleName found results
did not find any replication entries in the metadata table StringLiteral MethodInvocation SimpleName found results
found results SimpleName Assignment BooleanLiteral false
i SimpleName VariableDeclarationFragment NumberLiteral empty
int PrimitiveType VariableDeclarationExpression VariableDeclarationFragment SimpleName i
int PrimitiveType VariableDeclarationExpression VariableDeclarationFragment NumberLiteral empty
i SimpleName InfixExpression NumberLiteral empty
...
int PrimitiveType VariableDeclarationExpression ForStatement PostfixExpression SimpleName i
assert SimpleName MethodInvocation SimpleName assert true
assert SimpleName MethodInvocation StringLiteral did not find any replication entries in the replication table
assert SimpleName MethodInvocation SimpleName found results
assert true SimpleName MethodInvocation StringLiteral did not find any replication entries in the replication table
assert true SimpleName MethodInvocation SimpleName found results
did not find any replication entries in the replication table StringLiteral MethodInvocation SimpleName found results
conn SimpleName MethodInvocation SimpleName create scanner
conn SimpleName MethodInvocation QualifiedName metadata tablename
conn SimpleName MethodInvocation QualifiedName authorizationsempty
create scanner SimpleName MethodInvocation QualifiedName metadata tablename
