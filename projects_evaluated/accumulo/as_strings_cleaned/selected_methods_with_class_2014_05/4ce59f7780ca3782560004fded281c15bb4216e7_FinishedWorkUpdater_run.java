...
batch writer SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName meta bw
repl bw SimpleName VariableDeclarationFragment VariableDeclarationStatement VariableDeclarationFragment SimpleName meta bw
...
meta bw SimpleName Assignment MethodInvocation SimpleName conn
meta bw SimpleName Assignment MethodInvocation SimpleName create batch writer
meta bw SimpleName Assignment MethodInvocation QualifiedName metadata tablename
...
replication section SimpleName MethodInvocation InfixExpression SimpleName buffer
get row prefix SimpleName MethodInvocation InfixExpression SimpleName buffer
mutation SimpleName SimpleType ClassInstanceCreation InfixExpression SimpleName buffer
meta mutation SimpleName VariableDeclarationFragment ClassInstanceCreation SimpleType SimpleName mutation
meta mutation SimpleName VariableDeclarationFragment ClassInstanceCreation InfixExpression SimpleName buffer
mutation SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName meta mutation
...
meta mutation SimpleName MethodInvocation SimpleName put
meta mutation SimpleName MethodInvocation QualifiedName replication sectioncolf
meta mutation SimpleName MethodInvocation SimpleName buffer
meta mutation SimpleName MethodInvocation SimpleName serialized updated status
put SimpleName MethodInvocation QualifiedName replication sectioncolf
put SimpleName MethodInvocation SimpleName buffer
put SimpleName MethodInvocation SimpleName serialized updated status
replication sectioncolf QualifiedName MethodInvocation SimpleName buffer
replication sectioncolf QualifiedName MethodInvocation SimpleName serialized updated status
buffer SimpleName MethodInvocation SimpleName serialized updated status
meta bw SimpleName MethodInvocation SimpleName add mutation
meta bw SimpleName MethodInvocation SimpleName meta mutation
add mutation SimpleName MethodInvocation SimpleName meta mutation
meta bw SimpleName MethodInvocation SimpleName flush
mutations rejected exception SimpleName SimpleType SingleVariableDeclaration SimpleName e
log SimpleName MethodInvocation SimpleName error
log SimpleName MethodInvocation StringLiteral error writing mutations to update metadata status messages will retry
log SimpleName MethodInvocation SimpleName e
error SimpleName MethodInvocation StringLiteral error writing mutations to update metadata status messages will retry
error SimpleName MethodInvocation SimpleName e
error writing mutations to update metadata status messages will retry StringLiteral MethodInvocation SimpleName e
...
meta bw SimpleName MethodInvocation SimpleName close
mutations rejected exception SimpleName SimpleType SingleVariableDeclaration SimpleName e
log SimpleName MethodInvocation SimpleName error
log SimpleName MethodInvocation StringLiteral error writing mutations to update replication status messages in replication section will retry
log SimpleName MethodInvocation SimpleName e
error SimpleName MethodInvocation StringLiteral error writing mutations to update replication status messages in replication section will retry
error SimpleName MethodInvocation SimpleName e
error writing mutations to update replication status messages in replication section will retry StringLiteral MethodInvocation SimpleName e
