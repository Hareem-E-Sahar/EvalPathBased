...
metadata tabledirectory column QualifiedName ArrayInitializer QualifiedName metadata tableprev row column
metadata tabledirectory column QualifiedName ArrayInitializer QualifiedName metadata tablesplit ratio column
metadata tabledirectory column QualifiedName ArrayInitializer QualifiedName metadata tableold prev row column
metadata tabledirectory column QualifiedName ArrayInitializer QualifiedName metadata tabletime column
metadata tableprev row column QualifiedName ArrayInitializer QualifiedName metadata tablesplit ratio column
metadata tableprev row column QualifiedName ArrayInitializer QualifiedName metadata tableold prev row column
metadata tableprev row column QualifiedName ArrayInitializer QualifiedName metadata tabletime column
metadata tablesplit ratio column QualifiedName ArrayInitializer QualifiedName metadata tableold prev row column
metadata tablesplit ratio column QualifiedName ArrayInitializer QualifiedName metadata tabletime column
metadata tableold prev row column QualifiedName ArrayInitializer QualifiedName metadata tabletime column
arrays SimpleName MethodInvocation SimpleName as list
arrays SimpleName MethodInvocation ArrayCreation ArrayInitializer QualifiedName metadata tabledirectory column
arrays SimpleName MethodInvocation ArrayCreation ArrayInitializer QualifiedName metadata tableprev row column
arrays SimpleName MethodInvocation ArrayCreation ArrayInitializer QualifiedName metadata tablesplit ratio column
arrays SimpleName MethodInvocation ArrayCreation ArrayInitializer QualifiedName metadata tableold prev row column
arrays SimpleName MethodInvocation ArrayCreation ArrayInitializer QualifiedName metadata tabletime column
as list SimpleName MethodInvocation ArrayCreation ArrayInitializer QualifiedName metadata tabledirectory column
as list SimpleName MethodInvocation ArrayCreation ArrayInitializer QualifiedName metadata tableprev row column
as list SimpleName MethodInvocation ArrayCreation ArrayInitializer QualifiedName metadata tablesplit ratio column
as list SimpleName MethodInvocation ArrayCreation ArrayInitializer QualifiedName metadata tableold prev row column
as list SimpleName MethodInvocation ArrayCreation ArrayInitializer QualifiedName metadata tabletime column
...
security constants SimpleName MethodInvocation ClassInstanceCreation QualifiedName metadata tableid
get system credentials SimpleName MethodInvocation ClassInstanceCreation QualifiedName metadata tableid
security constants SimpleName MethodInvocation ClassInstanceCreation QualifiedName authorizationsempty
get system credentials SimpleName MethodInvocation ClassInstanceCreation QualifiedName authorizationsempty
...
entry SimpleName MethodInvocation SimpleName get key
metadata tableold prev row column QualifiedName MethodInvocation SimpleName has columns
metadata tableold prev row column QualifiedName MethodInvocation MethodInvocation SimpleName entry
metadata tableold prev row column QualifiedName MethodInvocation MethodInvocation SimpleName get key
