...
set boolean SimpleName MethodInvocation MethodInvocation QualifiedName featurescan create tables
...
featurescan create tables QualifiedName MethodInvocation MethodInvocation SimpleName enable feature
public Modifier MethodDeclaration Modifier static
public Modifier MethodDeclaration PrimitiveType void
public Modifier MethodDeclaration SimpleName set create tables
...
static Modifier MethodDeclaration SimpleName set create tables
...
void PrimitiveType MethodDeclaration SimpleName set create tables
...
set create tables SimpleName MethodDeclaration SingleVariableDeclaration ParameterizedType WildcardType ?
set create tables SimpleName MethodDeclaration SingleVariableDeclaration SimpleName implementing class
set create tables SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName configuration
set create tables SimpleName MethodDeclaration SingleVariableDeclaration SimpleName conf
set create tables SimpleName MethodDeclaration SingleVariableDeclaration PrimitiveType boolean
set create tables SimpleName MethodDeclaration SingleVariableDeclaration SimpleName enable feature
...
public Modifier TypeDeclaration MethodDeclaration SimpleName set create tables
...
test SimpleName TypeDeclaration MethodDeclaration SimpleName set create tables
