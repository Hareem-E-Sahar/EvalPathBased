...
create user s StringLiteral MethodInvocation MethodInvocation SimpleName token
create user s StringLiteral MethodInvocation MethodInvocation SimpleName get principal
...
create user SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName instance token wrapper
create user SimpleName MethodDeclaration SingleVariableDeclaration SimpleName credentials
create user SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName security token
