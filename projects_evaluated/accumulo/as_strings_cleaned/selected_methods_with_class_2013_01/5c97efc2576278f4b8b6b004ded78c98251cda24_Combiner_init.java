...
combine all columns SimpleName Assignment BooleanLiteral false
...
must specify StringLiteral InfixExpression SimpleName columns option
must specify StringLiteral InfixExpression StringLiteral option
columns option SimpleName InfixExpression StringLiteral option
illegal argument exception SimpleName SimpleType ClassInstanceCreation InfixExpression StringLiteral must specify
illegal argument exception SimpleName SimpleType ClassInstanceCreation InfixExpression SimpleName columns option
illegal argument exception SimpleName SimpleType ClassInstanceCreation InfixExpression StringLiteral option
options SimpleName MethodInvocation SimpleName get
options SimpleName MethodInvocation SimpleName columns option
...
the StringLiteral InfixExpression SimpleName columns option
the StringLiteral InfixExpression StringLiteral must not be empty
columns option SimpleName InfixExpression StringLiteral must not be empty
illegal argument exception SimpleName SimpleType ClassInstanceCreation InfixExpression StringLiteral the
illegal argument exception SimpleName SimpleType ClassInstanceCreation InfixExpression SimpleName columns option
illegal argument exception SimpleName SimpleType ClassInstanceCreation InfixExpression StringLiteral must not be empty
...
arrays SimpleName MethodInvocation MethodInvocation SimpleName encoded columns
...
as list SimpleName MethodInvocation MethodInvocation SimpleName encoded columns
...
column set SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName arrays
column set SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName as list
combiners SimpleName Assignment ClassInstanceCreation SimpleType SimpleName column set
combiners SimpleName Assignment ClassInstanceCreation MethodInvocation SimpleName arrays
combiners SimpleName Assignment ClassInstanceCreation MethodInvocation SimpleName as list
