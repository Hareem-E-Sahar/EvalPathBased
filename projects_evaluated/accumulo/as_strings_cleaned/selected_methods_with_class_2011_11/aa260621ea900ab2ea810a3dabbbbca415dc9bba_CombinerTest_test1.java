...
encoder SimpleName VariableDeclarationFragment SimpleName var num encoder
...
long combiner SimpleName MethodInvocation QualifiedName summing combinertypevarnum
set encoding type SimpleName MethodInvocation SimpleName is
set encoding type SimpleName MethodInvocation QualifiedName summing combinertypevarnum
is SimpleName MethodInvocation QualifiedName summing combinertypevarnum
iterator settingcolumn QualifiedName SimpleType ClassInstanceCreation StringLiteral empty
...
collections SimpleName MethodInvocation ClassInstanceCreation StringLiteral empty
singleton list SimpleName MethodInvocation ClassInstanceCreation SimpleType QualifiedName iterator settingcolumn
singleton list SimpleName MethodInvocation ClassInstanceCreation StringLiteral empty
...
combiner SimpleName MethodInvocation MethodInvocation ClassInstanceCreation StringLiteral empty
...
set columns SimpleName MethodInvocation MethodInvocation ClassInstanceCreation StringLiteral empty
...
is SimpleName MethodInvocation MethodInvocation ClassInstanceCreation StringLiteral empty
