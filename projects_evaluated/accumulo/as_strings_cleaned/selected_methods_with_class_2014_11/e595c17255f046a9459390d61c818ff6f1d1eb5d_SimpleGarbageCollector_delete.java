...
executors SimpleName MethodInvocation MethodInvocation SimpleName get num delete threads
...
new fixed thread pool SimpleName MethodInvocation MethodInvocation SimpleName get num delete threads
...
get num delete threads SimpleName MethodInvocation MethodInvocation ClassInstanceCreation StringLiteral deleting
...
delete thread pool SimpleName VariableDeclarationFragment MethodInvocation MethodInvocation SimpleName get num delete threads
...
archive or move to trash SimpleName MethodInvocation SimpleName full path
...
archive or move to trash SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName fs
archive or move to trash SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName delete recursively
archive or move to trash SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName full path
...
tablet dir SimpleName MethodInvocation QualifiedName constantsclone prefix
...
log SimpleName MethodInvocation InfixExpression SimpleName full path
debug SimpleName MethodInvocation InfixExpression StringLiteral file doesnt exist
debug SimpleName MethodInvocation InfixExpression SimpleName full path
