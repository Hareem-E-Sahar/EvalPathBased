...
empty NumberLiteral InfixExpression SimpleName timeout
start time SimpleName InfixExpression InfixExpression InfixExpression NumberLiteral empty
start time SimpleName InfixExpression InfixExpression InfixExpression SimpleName timeout
failed to connect to zookeeper ( StringLiteral InfixExpression SimpleName host
failed to connect to zookeeper ( StringLiteral InfixExpression StringLiteral ) within x zookeeper timeout period
failed to connect to zookeeper ( StringLiteral InfixExpression SimpleName timeout
host SimpleName InfixExpression StringLiteral ) within x zookeeper timeout period
host SimpleName InfixExpression SimpleName timeout
) within x zookeeper timeout period StringLiteral InfixExpression SimpleName timeout
runtime exception SimpleName SimpleType ClassInstanceCreation InfixExpression StringLiteral failed to connect to zookeeper (
runtime exception SimpleName SimpleType ClassInstanceCreation InfixExpression SimpleName host
runtime exception SimpleName SimpleType ClassInstanceCreation InfixExpression StringLiteral ) within x zookeeper timeout period
runtime exception SimpleName SimpleType ClassInstanceCreation InfixExpression SimpleName timeout
...
long PrimitiveType VariableDeclarationStatement Block WhileStatement SimpleName try again
long PrimitiveType VariableDeclarationStatement Block ReturnStatement SimpleName zoo keeper
...
connect SimpleName MethodDeclaration Block VariableDeclarationStatement PrimitiveType int
connect SimpleName MethodDeclaration Block VariableDeclarationStatement PrimitiveType long
