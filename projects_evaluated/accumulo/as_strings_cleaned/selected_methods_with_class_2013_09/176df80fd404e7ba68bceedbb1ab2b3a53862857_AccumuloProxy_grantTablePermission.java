...
grant table permission call SimpleName SimpleType ClassInstanceCreation SimpleName login
grant table permission call SimpleName SimpleType ClassInstanceCreation SimpleName user
grant table permission call SimpleName SimpleType ClassInstanceCreation SimpleName table
grant table permission call SimpleName SimpleType ClassInstanceCreation SimpleName perm
grant table permission call SimpleName SimpleType ClassInstanceCreation SimpleName result handler
login SimpleName ClassInstanceCreation SimpleName user
login SimpleName ClassInstanceCreation SimpleName table
login SimpleName ClassInstanceCreation SimpleName perm
login SimpleName ClassInstanceCreation SimpleName result handler
user SimpleName ClassInstanceCreation SimpleName table
...
grant table permission SimpleName MethodDeclaration SingleVariableDeclaration SimpleName result handler
