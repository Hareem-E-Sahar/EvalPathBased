...
column slice filter SimpleName SimpleType CastExpression SuperMethodInvocation SimpleName deep copy
column slice filter SimpleName SimpleType CastExpression SuperMethodInvocation SimpleName env
result SimpleName VariableDeclarationFragment CastExpression SimpleType SimpleName column slice filter
result SimpleName VariableDeclarationFragment CastExpression SuperMethodInvocation SimpleName deep copy
result SimpleName VariableDeclarationFragment CastExpression SuperMethodInvocation SimpleName env
column slice filter SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName result
resultstart bound QualifiedName Assignment SimpleName start bound
resultstart inclusive QualifiedName Assignment SimpleName start inclusive
resultend bound QualifiedName Assignment SimpleName end bound
resultend inclusive QualifiedName Assignment SimpleName end inclusive
...
deep copy SimpleName MethodDeclaration Block ReturnStatement SimpleName result
