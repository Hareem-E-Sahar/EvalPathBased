...
logger SimpleName MethodInvocation SimpleName get log files
logger SimpleName MethodInvocation SimpleName loggers
get log files SimpleName MethodInvocation SimpleName loggers
set SimpleName SimpleType ParameterizedType SimpleType SimpleName string
hash set SimpleName SimpleType ParameterizedType SimpleType SimpleName string
string SimpleName SimpleType SingleVariableDeclaration SimpleName logger
path SimpleName SimpleType ClassInstanceCreation SimpleName logger
path SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName get name
logger SimpleName ClassInstanceCreation MethodInvocation SimpleName get name
logger uui ds SimpleName MethodInvocation SimpleName add
logger uui ds SimpleName MethodInvocation MethodInvocation ClassInstanceCreation SimpleName logger
logger uui ds SimpleName MethodInvocation MethodInvocation SimpleName get name
add SimpleName MethodInvocation MethodInvocation ClassInstanceCreation SimpleName logger
...
loggers SimpleName EnhancedForStatement ExpressionStatement MethodInvocation SimpleName logger uui ds
loggers SimpleName EnhancedForStatement ExpressionStatement MethodInvocation SimpleName add
...
uuid SimpleName VariableDeclarationFragment MethodInvocation ClassInstanceCreation SimpleName filename
uuid SimpleName VariableDeclarationFragment MethodInvocation SimpleName get name
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName uuid
logger uui ds SimpleName MethodInvocation SimpleName contains
logger uui ds SimpleName MethodInvocation SimpleName uuid
contains SimpleName MethodInvocation SimpleName uuid
logger uui ds SimpleName MethodInvocation IfStatement ContinueStatement SimpleName next file
contains SimpleName MethodInvocation IfStatement ContinueStatement SimpleName next file
uuid SimpleName MethodInvocation IfStatement ContinueStatement SimpleName next file
...
tablet SimpleName MethodInvocation SimpleName get current log files
current SimpleName MethodInvocation SimpleName contains
current SimpleName MethodInvocation SimpleName uuid
contains SimpleName MethodInvocation SimpleName uuid
...
current SimpleName SingleVariableDeclaration EnhancedForStatement MethodInvocation SimpleName get current log files
...
tablet server SimpleName ThisExpression MethodInvocation MethodInvocation SimpleName get boolean
get configuration SimpleName MethodInvocation MethodInvocation SimpleName get boolean
tablet server SimpleName ThisExpression MethodInvocation MethodInvocation QualifiedName propertytserv archive walogs
get configuration SimpleName MethodInvocation MethodInvocation QualifiedName propertytserv archive walogs
...
tablet server SimpleName ThisExpression MethodInvocation MethodInvocation SimpleName get boolean
get configuration SimpleName MethodInvocation MethodInvocation SimpleName get boolean
tablet server SimpleName ThisExpression MethodInvocation MethodInvocation QualifiedName propertygc trash ignore
get configuration SimpleName MethodInvocation MethodInvocation QualifiedName propertygc trash ignore
...
loggers SimpleName EnhancedForStatement Block LabeledStatement SimpleName next file
...
remove logs SimpleName MethodDeclaration Block EnhancedForStatement SimpleName loggers
