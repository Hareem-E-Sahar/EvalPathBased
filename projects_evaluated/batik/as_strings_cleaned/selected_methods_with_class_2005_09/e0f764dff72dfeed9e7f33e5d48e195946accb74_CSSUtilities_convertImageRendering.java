...
get computed style SimpleName MethodInvocation QualifiedName svgcss engineimage rendering index
e SimpleName MethodInvocation QualifiedName svgcss engineimage rendering index
...
v SimpleName VariableDeclarationFragment MethodInvocation QualifiedName svgcss engineimage rendering index
...
hints SimpleName MethodInvocation SimpleName put
hints SimpleName MethodInvocation QualifiedName rendering hintskey interpolation
hints SimpleName MethodInvocation QualifiedName rendering hintsvalue interpolation nearest neighbor
put SimpleName MethodInvocation QualifiedName rendering hintskey interpolation
put SimpleName MethodInvocation QualifiedName rendering hintsvalue interpolation nearest neighbor
rendering hintskey interpolation QualifiedName MethodInvocation QualifiedName rendering hintsvalue interpolation nearest neighbor
hints SimpleName MethodInvocation SimpleName put
hints SimpleName MethodInvocation QualifiedName rendering hintskey rendering
...
hints SimpleName MethodInvocation SimpleName put
hints SimpleName MethodInvocation QualifiedName rendering hintskey interpolation
hints SimpleName MethodInvocation QualifiedName rendering hintsvalue interpolation bicubic
put SimpleName MethodInvocation QualifiedName rendering hintskey interpolation
put SimpleName MethodInvocation QualifiedName rendering hintsvalue interpolation bicubic
...
public Modifier MethodDeclaration SimpleName convert image rendering
...
static Modifier MethodDeclaration SimpleName convert image rendering
...
rendering hints SimpleName SimpleType MethodDeclaration SimpleName convert image rendering
...
convert image rendering SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName element
convert image rendering SimpleName MethodDeclaration SingleVariableDeclaration SimpleName e
convert image rendering SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName rendering hints
convert image rendering SimpleName MethodDeclaration SingleVariableDeclaration SimpleName hints
convert image rendering SimpleName MethodDeclaration Block VariableDeclarationStatement PrimitiveType int
convert image rendering SimpleName MethodDeclaration Block ReturnStatement SimpleName hints
...
public Modifier TypeDeclaration MethodDeclaration SimpleName convert image rendering
...
test SimpleName TypeDeclaration MethodDeclaration SimpleName convert image rendering
