...
svgom use shadow root SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName root
svgom use shadow root SimpleName SimpleType ClassInstanceCreation SimpleName document
svgom use shadow root SimpleName SimpleType ClassInstanceCreation SimpleName e
svgom use shadow root SimpleName SimpleType ClassInstanceCreation SimpleName is local
...
root SimpleName Assignment ClassInstanceCreation SimpleType SimpleName svgom use shadow root
...
ue SimpleName MethodInvocation SimpleName get css first child
old root SimpleName VariableDeclarationFragment MethodInvocation SimpleName ue
old root SimpleName VariableDeclarationFragment MethodInvocation SimpleName get css first child
...
ue SimpleName MethodInvocation SimpleName set use shadow tree
ue SimpleName MethodInvocation SimpleName root
set use shadow tree SimpleName MethodInvocation SimpleName root
...
node event target SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment QualifiedName ltarget
...
node event target SimpleName SimpleType CastExpression SimpleName ref element
...
dom attr modified StringLiteral MethodInvocation BooleanLiteral true
l SimpleName MethodInvocation BooleanLiteral true
the ctx SimpleName MethodInvocation SimpleName store event listener ns
the ctx SimpleName MethodInvocation SimpleName target
the ctx SimpleName MethodInvocation QualifiedName xml constantsxml events namespace uri
...
store event listener ns SimpleName MethodInvocation StringLiteral dom attr modified
...
store event listener ns SimpleName MethodInvocation SimpleName target
store event listener ns SimpleName MethodInvocation QualifiedName xml constantsxml events namespace uri
store event listener ns SimpleName MethodInvocation StringLiteral dom node inserted
store event listener ns SimpleName MethodInvocation SimpleName l
store event listener ns SimpleName MethodInvocation BooleanLiteral true
target SimpleName MethodInvocation QualifiedName xml constantsxml events namespace uri
target SimpleName MethodInvocation StringLiteral dom node inserted
