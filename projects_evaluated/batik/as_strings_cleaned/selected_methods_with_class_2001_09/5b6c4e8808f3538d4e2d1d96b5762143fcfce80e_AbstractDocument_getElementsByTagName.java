...
t SimpleName MethodInvocation SimpleName get
...
elements by tag name SimpleName SimpleType CastExpression MethodInvocation SimpleName t
elements by tag name SimpleName SimpleType CastExpression MethodInvocation SimpleName get
elements by tag name SimpleName SimpleType CastExpression MethodInvocation SimpleName ns
elements by tag name SimpleName SimpleType CastExpression MethodInvocation SimpleName ln
public Modifier MethodDeclaration SimpleType SimpleName elements by tag name
...
elements by tag name SimpleName SimpleType MethodDeclaration SimpleName get elements by tag name
elements by tag name SimpleName SimpleType MethodDeclaration SingleVariableDeclaration SimpleName n
elements by tag name SimpleName SimpleType MethodDeclaration SingleVariableDeclaration SimpleName ns
elements by tag name SimpleName SimpleType MethodDeclaration SingleVariableDeclaration SimpleName ln
get elements by tag name SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName node
get elements by tag name SimpleName MethodDeclaration SingleVariableDeclaration SimpleName n
get elements by tag name SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
get elements by tag name SimpleName MethodDeclaration SingleVariableDeclaration SimpleName ns
get elements by tag name SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName string
get elements by tag name SimpleName MethodDeclaration SingleVariableDeclaration SimpleName ln
...
public Modifier TypeDeclaration MethodDeclaration SimpleType SimpleName elements by tag name
...
test SimpleName TypeDeclaration MethodDeclaration SimpleType SimpleName elements by tag name
