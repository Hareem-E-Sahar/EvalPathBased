...
evt target SimpleName MethodInvocation SimpleName add event listener
...
add event listener SimpleName MethodInvocation SimpleName child node removed event listener
...
store event listener SimpleName MethodInvocation SimpleName evt target
store event listener SimpleName MethodInvocation StringLiteral dom node removed
store event listener SimpleName MethodInvocation SimpleName child node removed event listener
...
add event listener SimpleName MethodInvocation StringLiteral dom subtree modified
add event listener SimpleName MethodInvocation SimpleName subtree modified event listener
...
store event listener SimpleName MethodInvocation SimpleName evt target
store event listener SimpleName MethodInvocation StringLiteral dom subtree modified
store event listener SimpleName MethodInvocation SimpleName subtree modified event listener
