...
result SimpleName MethodInvocation SimpleName set dynamic state
result SimpleName MethodInvocation QualifiedName bridge contextdynamic
set dynamic state SimpleName MethodInvocation QualifiedName bridge contextdynamic
result SimpleName MethodInvocation SimpleName set dynamic state
result SimpleName MethodInvocation QualifiedName bridge contextinteractive
set dynamic state SimpleName MethodInvocation QualifiedName bridge contextinteractive
is dynamic document SimpleName IfStatement ExpressionStatement MethodInvocation SimpleName result
...
is interactive document SimpleName IfStatement Block ReturnStatement SimpleName result
...
create bridge context SimpleName MethodDeclaration Block IfStatement SimpleName is interactive document
