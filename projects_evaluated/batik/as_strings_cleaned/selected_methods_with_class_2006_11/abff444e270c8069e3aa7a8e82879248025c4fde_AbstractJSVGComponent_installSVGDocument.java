...
create bridge context SimpleName MethodInvocation CastExpression SimpleType SimpleName svgom document
create bridge context SimpleName MethodInvocation CastExpression SimpleName doc
bridge context SimpleName Assignment MethodInvocation SimpleName create bridge context
bridge context SimpleName Assignment MethodInvocation CastExpression SimpleName doc
is dynamic document SimpleName Assignment BooleanLiteral false
is interactive document SimpleName Assignment BooleanLiteral false
is dynamic document SimpleName Assignment BooleanLiteral false
...
is dynamic document SimpleName InfixExpression MethodInvocation SimpleName bridge context
is dynamic document SimpleName InfixExpression MethodInvocation SimpleName is interactive document
is dynamic document SimpleName InfixExpression MethodInvocation SimpleName doc
is interactive document SimpleName Assignment InfixExpression SimpleName is dynamic document
is interactive document SimpleName Assignment InfixExpression MethodInvocation SimpleName bridge context
is interactive document SimpleName Assignment InfixExpression MethodInvocation SimpleName is interactive document
is interactive document SimpleName Assignment InfixExpression MethodInvocation SimpleName doc
...
update zoom and pan enable SimpleName MethodInvocation SimpleName doc
