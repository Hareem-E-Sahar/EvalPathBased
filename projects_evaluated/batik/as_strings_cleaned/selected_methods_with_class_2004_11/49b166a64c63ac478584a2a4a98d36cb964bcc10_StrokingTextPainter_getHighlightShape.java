...
error SimpleName SimpleType ClassInstanceCreation StringLiteral markers are from different text nodes
...
get text runs SimpleName MethodInvocation MethodInvocation SimpleName text node
get text runs SimpleName MethodInvocation MethodInvocation SimpleName get attributed character iterator
text node SimpleName MethodInvocation MethodInvocation SimpleName text node
text node SimpleName MethodInvocation MethodInvocation SimpleName get attributed character iterator
...
text runs SimpleName VariableDeclarationFragment MethodInvocation MethodInvocation SimpleName text node
text runs SimpleName VariableDeclarationFragment MethodInvocation MethodInvocation SimpleName get attributed character iterator
