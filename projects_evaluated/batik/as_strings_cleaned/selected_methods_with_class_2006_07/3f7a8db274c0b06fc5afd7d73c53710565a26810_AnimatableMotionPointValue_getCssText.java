...
s SimpleName VariableDeclarationFragment MethodInvocation SimpleName x
...
float SimpleName MethodInvocation SimpleName to string
float SimpleName MethodInvocation SimpleName y
to string SimpleName MethodInvocation SimpleName y
s SimpleName Assignment MethodInvocation SimpleName float
s SimpleName Assignment MethodInvocation SimpleName to string
s SimpleName Assignment MethodInvocation SimpleName y
s SimpleName MethodInvocation SimpleName ends with
s SimpleName MethodInvocation StringLiteral .
ends with SimpleName MethodInvocation StringLiteral .
s SimpleName MethodInvocation SimpleName length
...
append SimpleName MethodInvocation CharacterLiteral empty
float SimpleName MethodInvocation SimpleName to string
float SimpleName MethodInvocation SimpleName angle
to string SimpleName MethodInvocation SimpleName angle
s SimpleName Assignment MethodInvocation SimpleName float
s SimpleName Assignment MethodInvocation SimpleName to string
s SimpleName Assignment MethodInvocation SimpleName angle
s SimpleName MethodInvocation SimpleName ends with
s SimpleName MethodInvocation StringLiteral .
ends with SimpleName MethodInvocation StringLiteral .
s SimpleName MethodInvocation SimpleName length
