...
animatable boolean value SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName res
animatable boolean value SimpleName SimpleType ClassInstanceCreation SimpleName target
res SimpleName Assignment ClassInstanceCreation SimpleType SimpleName animatable boolean value
res SimpleName Assignment ClassInstanceCreation SimpleName target
animatable boolean value SimpleName SimpleType CastExpression SimpleName result
res SimpleName Assignment CastExpression SimpleType SimpleName animatable boolean value
res SimpleName Assignment CastExpression SimpleName result
boolean PrimitiveType VariableDeclarationStatement VariableDeclarationFragment SimpleName new value
...
animatable boolean value SimpleName SimpleType CastExpression SimpleName to
to value SimpleName VariableDeclarationFragment CastExpression SimpleType SimpleName animatable boolean value
to value SimpleName VariableDeclarationFragment CastExpression SimpleName to
animatable boolean value SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName to value
