...
animatable rect value SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName res
animatable rect value SimpleName SimpleType ClassInstanceCreation SimpleName target
res SimpleName Assignment ClassInstanceCreation SimpleType SimpleName animatable rect value
res SimpleName Assignment ClassInstanceCreation SimpleName target
animatable rect value SimpleName SimpleType CastExpression SimpleName result
res SimpleName Assignment CastExpression SimpleType SimpleName animatable rect value
...
float PrimitiveType VariableDeclarationStatement VariableDeclarationFragment SimpleName new width
float PrimitiveType VariableDeclarationStatement VariableDeclarationFragment SimpleName new height
new x SimpleName VariableDeclarationFragment VariableDeclarationStatement VariableDeclarationFragment SimpleName new y
new x SimpleName VariableDeclarationFragment VariableDeclarationStatement VariableDeclarationFragment SimpleName new width
new x SimpleName VariableDeclarationFragment VariableDeclarationStatement VariableDeclarationFragment SimpleName new height
new y SimpleName VariableDeclarationFragment VariableDeclarationStatement VariableDeclarationFragment SimpleName new width
new y SimpleName VariableDeclarationFragment VariableDeclarationStatement VariableDeclarationFragment SimpleName new height
new width SimpleName VariableDeclarationFragment VariableDeclarationStatement VariableDeclarationFragment SimpleName new height
...
animatable rect value SimpleName SimpleType CastExpression SimpleName to
to value SimpleName VariableDeclarationFragment CastExpression SimpleType SimpleName animatable rect value
to value SimpleName VariableDeclarationFragment CastExpression SimpleName to
animatable rect value SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName to value
new x SimpleName Assignment QualifiedName to valuex
new y SimpleName Assignment QualifiedName to valuey
new width SimpleName Assignment QualifiedName to valuewidth
new height SimpleName Assignment QualifiedName to valueheight
new x SimpleName Assignment SimpleName x
new y SimpleName Assignment SimpleName y
new width SimpleName Assignment SimpleName width
new height SimpleName Assignment SimpleName height
...
reswidth QualifiedName InfixExpression SimpleName new width
resheight QualifiedName InfixExpression SimpleName new height
resx QualifiedName Assignment SimpleName new x
resy QualifiedName Assignment SimpleName new y
reswidth QualifiedName Assignment SimpleName new width
resheight QualifiedName Assignment SimpleName new height
