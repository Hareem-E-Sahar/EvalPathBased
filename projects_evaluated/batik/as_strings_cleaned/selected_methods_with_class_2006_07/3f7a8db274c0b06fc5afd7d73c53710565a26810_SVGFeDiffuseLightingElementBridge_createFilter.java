...
convert number SimpleName MethodInvocation SimpleName filter element
convert number SimpleName MethodInvocation SimpleName svg diffuse constant attribute
convert number SimpleName MethodInvocation NumberLiteral empty
convert number SimpleName MethodInvocation SimpleName ctx
filter element SimpleName MethodInvocation SimpleName svg diffuse constant attribute
filter element SimpleName MethodInvocation NumberLiteral empty
filter element SimpleName MethodInvocation SimpleName ctx
svg diffuse constant attribute SimpleName MethodInvocation NumberLiteral empty
svg diffuse constant attribute SimpleName MethodInvocation SimpleName ctx
empty NumberLiteral MethodInvocation SimpleName ctx
diffuse constant SimpleName VariableDeclarationFragment MethodInvocation SimpleName convert number
diffuse constant SimpleName VariableDeclarationFragment MethodInvocation SimpleName filter element
diffuse constant SimpleName VariableDeclarationFragment MethodInvocation SimpleName svg diffuse constant attribute
diffuse constant SimpleName VariableDeclarationFragment MethodInvocation NumberLiteral empty
diffuse constant SimpleName VariableDeclarationFragment MethodInvocation SimpleName ctx
float PrimitiveType VariableDeclarationStatement VariableDeclarationFragment SimpleName diffuse constant
float PrimitiveType VariableDeclarationStatement VariableDeclarationFragment MethodInvocation SimpleName convert number
float PrimitiveType VariableDeclarationStatement VariableDeclarationFragment MethodInvocation SimpleName filter element
float PrimitiveType VariableDeclarationStatement VariableDeclarationFragment MethodInvocation SimpleName svg diffuse constant attribute
float PrimitiveType VariableDeclarationStatement VariableDeclarationFragment MethodInvocation NumberLiteral empty
float PrimitiveType VariableDeclarationStatement VariableDeclarationFragment MethodInvocation SimpleName ctx
...
diffuse lighting rable bit SimpleName SimpleType ClassInstanceCreation SimpleName in
diffuse lighting rable bit SimpleName SimpleType ClassInstanceCreation SimpleName primitive region
diffuse lighting rable bit SimpleName SimpleType ClassInstanceCreation SimpleName light
diffuse lighting rable bit SimpleName SimpleType ClassInstanceCreation SimpleName diffuse constant
diffuse lighting rable bit SimpleName SimpleType ClassInstanceCreation SimpleName surface scale
in SimpleName ClassInstanceCreation SimpleName primitive region
in SimpleName ClassInstanceCreation SimpleName light
in SimpleName ClassInstanceCreation SimpleName diffuse constant
in SimpleName ClassInstanceCreation SimpleName surface scale
in SimpleName ClassInstanceCreation SimpleName kernel unit length
primitive region SimpleName ClassInstanceCreation SimpleName light
primitive region SimpleName ClassInstanceCreation SimpleName diffuse constant
...
light SimpleName ClassInstanceCreation SimpleName diffuse constant
...
diffuse constant SimpleName ClassInstanceCreation SimpleName surface scale
diffuse constant SimpleName ClassInstanceCreation SimpleName kernel unit length
surface scale SimpleName ClassInstanceCreation SimpleName kernel unit length
filter SimpleName VariableDeclarationFragment ClassInstanceCreation SimpleType SimpleName diffuse lighting rable bit
...
filter SimpleName VariableDeclarationFragment ClassInstanceCreation SimpleName diffuse constant
