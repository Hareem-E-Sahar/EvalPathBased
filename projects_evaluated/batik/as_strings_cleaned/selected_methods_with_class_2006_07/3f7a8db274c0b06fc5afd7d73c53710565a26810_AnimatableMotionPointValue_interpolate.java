...
animatable motion point value SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName res
animatable motion point value SimpleName SimpleType ClassInstanceCreation SimpleName target
res SimpleName Assignment ClassInstanceCreation SimpleType SimpleName animatable motion point value
res SimpleName Assignment ClassInstanceCreation SimpleName target
animatable motion point value SimpleName SimpleType CastExpression SimpleName result
res SimpleName Assignment CastExpression SimpleType SimpleName animatable motion point value
res SimpleName Assignment CastExpression SimpleName result
new x SimpleName VariableDeclarationFragment SimpleName x
new y SimpleName VariableDeclarationFragment SimpleName y
new angle SimpleName VariableDeclarationFragment SimpleName angle
...
float PrimitiveType VariableDeclarationStatement VariableDeclarationFragment SimpleName new angle
float PrimitiveType VariableDeclarationStatement VariableDeclarationFragment SimpleName angle
new x SimpleName VariableDeclarationFragment VariableDeclarationStatement VariableDeclarationFragment SimpleName new y
new x SimpleName VariableDeclarationFragment VariableDeclarationStatement VariableDeclarationFragment SimpleName y
x SimpleName VariableDeclarationFragment VariableDeclarationStatement VariableDeclarationFragment SimpleName new y
x SimpleName VariableDeclarationFragment VariableDeclarationStatement VariableDeclarationFragment SimpleName y
new x SimpleName VariableDeclarationFragment VariableDeclarationStatement VariableDeclarationFragment SimpleName new angle
new x SimpleName VariableDeclarationFragment VariableDeclarationStatement VariableDeclarationFragment SimpleName angle
x SimpleName VariableDeclarationFragment VariableDeclarationStatement VariableDeclarationFragment SimpleName new angle
x SimpleName VariableDeclarationFragment VariableDeclarationStatement VariableDeclarationFragment SimpleName angle
new y SimpleName VariableDeclarationFragment VariableDeclarationStatement VariableDeclarationFragment SimpleName new angle
new y SimpleName VariableDeclarationFragment VariableDeclarationStatement VariableDeclarationFragment SimpleName angle
y SimpleName VariableDeclarationFragment VariableDeclarationStatement VariableDeclarationFragment SimpleName new angle
y SimpleName VariableDeclarationFragment VariableDeclarationStatement VariableDeclarationFragment SimpleName angle
angle count SimpleName VariableDeclarationFragment NumberLiteral empty
int PrimitiveType VariableDeclarationStatement VariableDeclarationFragment SimpleName angle count
int PrimitiveType VariableDeclarationStatement VariableDeclarationFragment NumberLiteral empty
animatable motion point value SimpleName SimpleType CastExpression SimpleName to
to value SimpleName VariableDeclarationFragment CastExpression SimpleType SimpleName animatable motion point value
to value SimpleName VariableDeclarationFragment CastExpression SimpleName to
animatable motion point value SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName to value
to valuex QualifiedName InfixExpression SimpleName x
interpolation SimpleName InfixExpression ParenthesizedExpression InfixExpression QualifiedName to valuex
interpolation SimpleName InfixExpression ParenthesizedExpression InfixExpression SimpleName x
new x SimpleName Assignment InfixExpression SimpleName interpolation
to valuey QualifiedName InfixExpression SimpleName y
interpolation SimpleName InfixExpression ParenthesizedExpression InfixExpression QualifiedName to valuey
interpolation SimpleName InfixExpression ParenthesizedExpression InfixExpression SimpleName y
new y SimpleName Assignment InfixExpression SimpleName interpolation
new angle SimpleName Assignment QualifiedName to valueangle
multiplier SimpleName InfixExpression NumberLiteral empty
accumulation SimpleName InfixExpression InfixExpression InfixExpression SimpleName multiplier
accumulation SimpleName InfixExpression InfixExpression InfixExpression NumberLiteral empty
animatable motion point value SimpleName SimpleType CastExpression SimpleName accumulation
acc value SimpleName VariableDeclarationFragment CastExpression SimpleType SimpleName animatable motion point value
acc value SimpleName VariableDeclarationFragment CastExpression SimpleName accumulation
animatable motion point value SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName acc value
multiplier SimpleName InfixExpression QualifiedName acc valuex
new x SimpleName Assignment InfixExpression SimpleName multiplier
new x SimpleName Assignment InfixExpression QualifiedName acc valuex
multiplier SimpleName InfixExpression QualifiedName acc valuey
new y SimpleName Assignment InfixExpression SimpleName multiplier
new y SimpleName Assignment InfixExpression QualifiedName acc valuey
new angle SimpleName Assignment QualifiedName acc valueangle
new angle SimpleName Assignment SimpleName angle count
resx QualifiedName InfixExpression SimpleName new x
resy QualifiedName InfixExpression SimpleName new y
resx QualifiedName InfixExpression InfixExpression InfixExpression QualifiedName resy
resx QualifiedName InfixExpression InfixExpression InfixExpression SimpleName new y
new x SimpleName InfixExpression InfixExpression InfixExpression QualifiedName resy
new x SimpleName InfixExpression InfixExpression InfixExpression SimpleName new y
resangle QualifiedName InfixExpression SimpleName new angle
resx QualifiedName Assignment SimpleName new x
resy QualifiedName Assignment SimpleName new y
resangle QualifiedName Assignment SimpleName new angle
