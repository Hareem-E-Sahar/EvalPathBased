...
animatable string value SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName res
animatable string value SimpleName SimpleType ClassInstanceCreation SimpleName target
res SimpleName Assignment ClassInstanceCreation SimpleType SimpleName animatable string value
res SimpleName Assignment ClassInstanceCreation SimpleName target
animatable string value SimpleName SimpleType CastExpression SimpleName result
res SimpleName Assignment CastExpression SimpleType SimpleName animatable string value
res SimpleName Assignment CastExpression SimpleName result
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName new string
...
animatable string value SimpleName SimpleType CastExpression SimpleName to
to value SimpleName VariableDeclarationFragment CastExpression SimpleType SimpleName animatable string value
to value SimpleName VariableDeclarationFragment CastExpression SimpleName to
animatable string value SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName to value
new string SimpleName Assignment QualifiedName to valuestring
new string SimpleName Assignment SimpleName string
resstring QualifiedName MethodInvocation SimpleName equals
resstring QualifiedName MethodInvocation SimpleName new string
equals SimpleName MethodInvocation SimpleName new string
resstring QualifiedName Assignment SimpleName new string
