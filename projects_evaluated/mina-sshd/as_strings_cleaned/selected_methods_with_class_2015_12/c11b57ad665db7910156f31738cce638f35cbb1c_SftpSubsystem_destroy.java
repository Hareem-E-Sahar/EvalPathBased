...
destroy - mark as closed StringLiteral MethodInvocation MethodInvocation SimpleName get server session
...
listener SimpleName MethodInvocation SimpleName destroying
listener SimpleName MethodInvocation MethodInvocation SimpleName get server session
destroying SimpleName MethodInvocation MethodInvocation SimpleName get server session
...
log SimpleName MethodInvocation StringLiteral destroy failed ({}) to announce destruction event {}
log SimpleName MethodInvocation MethodInvocation SimpleName get server session
...
warn SimpleName MethodInvocation StringLiteral destroy failed ({}) to announce destruction event {}
...
destroy failed ({}) to announce destruction event {} StringLiteral MethodInvocation MethodInvocation SimpleName get server session
destroy failed ({}) to announce destruction event {} StringLiteral MethodInvocation MethodInvocation MethodInvocation SimpleName e
destroy failed ({}) to announce destruction event {} StringLiteral MethodInvocation MethodInvocation MethodInvocation SimpleName get class
destroy failed ({}) to announce destruction event {} StringLiteral MethodInvocation MethodInvocation SimpleName get simple name
destroy failed ({}) to announce destruction event {} StringLiteral MethodInvocation MethodInvocation SimpleName e
destroy failed ({}) to announce destruction event {} StringLiteral MethodInvocation MethodInvocation SimpleName get message
...
log SimpleName MethodInvocation SimpleName is debug enabled
destroy StringLiteral InfixExpression MethodInvocation SimpleName get server session
destroy StringLiteral InfixExpression StringLiteral ) destruction announcement failure details
get server session SimpleName MethodInvocation InfixExpression StringLiteral ) destruction announcement failure details
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation InfixExpression StringLiteral destroy
log SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName get server session
log SimpleName MethodInvocation InfixExpression StringLiteral ) destruction announcement failure details
log SimpleName MethodInvocation SimpleName e
debug SimpleName MethodInvocation InfixExpression StringLiteral destroy
debug SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName get server session
debug SimpleName MethodInvocation InfixExpression StringLiteral ) destruction announcement failure details
debug SimpleName MethodInvocation SimpleName e
destroy StringLiteral InfixExpression MethodInvocation SimpleName e
get server session SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName e
) destruction announcement failure details StringLiteral InfixExpression MethodInvocation SimpleName e
...
log SimpleName MethodInvocation SimpleName is debug enabled
destroy StringLiteral InfixExpression MethodInvocation SimpleName get server session
destroy StringLiteral InfixExpression StringLiteral ) - cancel pending future
destroy StringLiteral InfixExpression SimpleName result
get server session SimpleName MethodInvocation InfixExpression StringLiteral ) - cancel pending future
get server session SimpleName MethodInvocation InfixExpression SimpleName result
) - cancel pending future StringLiteral InfixExpression SimpleName result
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation InfixExpression StringLiteral destroy
log SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName get server session
log SimpleName MethodInvocation InfixExpression StringLiteral ) - cancel pending future
log SimpleName MethodInvocation InfixExpression SimpleName result
debug SimpleName MethodInvocation InfixExpression StringLiteral destroy
debug SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName get server session
debug SimpleName MethodInvocation InfixExpression StringLiteral ) - cancel pending future
...
destroy StringLiteral InfixExpression MethodInvocation SimpleName get server session
destroy StringLiteral InfixExpression StringLiteral ) - shutdown executor service - runners count
destroy StringLiteral InfixExpression MethodInvocation SimpleName runners
destroy StringLiteral InfixExpression MethodInvocation SimpleName size
get server session SimpleName MethodInvocation InfixExpression StringLiteral ) - shutdown executor service - runners count
get server session SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName runners
get server session SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName size
) - shutdown executor service - runners count StringLiteral InfixExpression MethodInvocation SimpleName runners
) - shutdown executor service - runners count StringLiteral InfixExpression MethodInvocation SimpleName size
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation InfixExpression StringLiteral destroy
log SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName get server session
log SimpleName MethodInvocation InfixExpression StringLiteral ) - shutdown executor service - runners count
...
debug SimpleName MethodInvocation InfixExpression StringLiteral destroy
debug SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName get server session
debug SimpleName MethodInvocation InfixExpression StringLiteral ) - shutdown executor service - runners count
...
log SimpleName MethodInvocation SimpleName is debug enabled
destroy StringLiteral InfixExpression MethodInvocation SimpleName get server session
destroy StringLiteral InfixExpression StringLiteral ) closing the file system is not supported
get server session SimpleName MethodInvocation InfixExpression StringLiteral ) closing the file system is not supported
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation InfixExpression StringLiteral destroy
log SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName get server session
log SimpleName MethodInvocation InfixExpression StringLiteral ) closing the file system is not supported
debug SimpleName MethodInvocation InfixExpression StringLiteral destroy
debug SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName get server session
debug SimpleName MethodInvocation InfixExpression StringLiteral ) closing the file system is not supported
...
e SimpleName MethodInvocation SimpleName get message
destroy StringLiteral InfixExpression MethodInvocation SimpleName get server session
destroy StringLiteral InfixExpression StringLiteral )
destroy StringLiteral InfixExpression StringLiteral failed (
destroy StringLiteral InfixExpression MethodInvocation MethodInvocation SimpleName e
destroy StringLiteral InfixExpression MethodInvocation MethodInvocation SimpleName get class
destroy StringLiteral InfixExpression MethodInvocation SimpleName get simple name
destroy StringLiteral InfixExpression StringLiteral )
get server session SimpleName MethodInvocation InfixExpression StringLiteral )
get server session SimpleName MethodInvocation InfixExpression StringLiteral failed (
get server session SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName get simple name
get server session SimpleName MethodInvocation InfixExpression StringLiteral )
get server session SimpleName MethodInvocation InfixExpression StringLiteral to close file system
...
) StringLiteral InfixExpression StringLiteral to close file system
...
failed ( StringLiteral InfixExpression StringLiteral to close file system
...
e SimpleName MethodInvocation MethodInvocation InfixExpression StringLiteral to close file system
get class SimpleName MethodInvocation MethodInvocation InfixExpression StringLiteral to close file system
get simple name SimpleName MethodInvocation InfixExpression StringLiteral to close file system
...
to close file system StringLiteral InfixExpression MethodInvocation SimpleName e
to close file system StringLiteral InfixExpression MethodInvocation SimpleName get message
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation InfixExpression StringLiteral destroy
log SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName get server session
...
log SimpleName MethodInvocation InfixExpression StringLiteral )
log SimpleName MethodInvocation InfixExpression StringLiteral to close file system
...
debug SimpleName MethodInvocation InfixExpression StringLiteral )
debug SimpleName MethodInvocation InfixExpression StringLiteral to close file system
