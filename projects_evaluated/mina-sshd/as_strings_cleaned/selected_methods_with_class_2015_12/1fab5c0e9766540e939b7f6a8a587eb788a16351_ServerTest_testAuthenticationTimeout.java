...
auth timeout SimpleName VariableDeclarationFragment MethodInvocation QualifiedName time unitseconds
auth timeout SimpleName VariableDeclarationFragment MethodInvocation SimpleName to millis
auth timeout SimpleName VariableDeclarationFragment MethodInvocation NumberLiteral l
...
long PrimitiveType VariableDeclarationStatement VariableDeclarationFragment SimpleName auth timeout
...
property resolver utils SimpleName MethodInvocation SimpleName auth timeout
...
l NumberLiteral InfixExpression SimpleName auth timeout
...
enum set SimpleName MethodInvocation MethodInvocation InfixExpression SimpleName auth timeout
of SimpleName MethodInvocation MethodInvocation InfixExpression NumberLiteral l
of SimpleName MethodInvocation MethodInvocation InfixExpression SimpleName auth timeout
client sessionclient session eventclosed QualifiedName MethodInvocation MethodInvocation InfixExpression NumberLiteral l
client sessionclient session eventclosed QualifiedName MethodInvocation MethodInvocation InfixExpression SimpleName auth timeout
