...
failed ( StringLiteral InfixExpression StringLiteral ) to close agent
...
e SimpleName MethodInvocation MethodInvocation InfixExpression StringLiteral ) to close agent
get class SimpleName MethodInvocation MethodInvocation InfixExpression StringLiteral ) to close agent
get simple name SimpleName MethodInvocation InfixExpression StringLiteral ) to close agent
...
) to close agent StringLiteral InfixExpression MethodInvocation SimpleName e
) to close agent StringLiteral InfixExpression MethodInvocation SimpleName get message
runtime exception SimpleName SimpleType ClassInstanceCreation InfixExpression StringLiteral failed (
runtime exception SimpleName SimpleType ClassInstanceCreation InfixExpression StringLiteral ) to close agent
...
) to close agent StringLiteral InfixExpression ClassInstanceCreation SimpleName e
