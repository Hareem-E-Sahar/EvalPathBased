...
log SimpleName MethodInvocation StringLiteral process auth data request send ssh msg userauth pk ok reply for {}: type fingerprint
...
debug SimpleName MethodInvocation StringLiteral process auth data request send ssh msg userauth pk ok reply for {}: type fingerprint
...
process auth data request send ssh msg userauth pk ok reply for {}: type fingerprint StringLiteral MethodInvocation SimpleName session
process auth data request send ssh msg userauth pk ok reply for {}: type fingerprint StringLiteral MethodInvocation SimpleName service
process auth data request send ssh msg userauth pk ok reply for {}: type fingerprint StringLiteral MethodInvocation SimpleName name
process auth data request send ssh msg userauth pk ok reply for {}: type fingerprint StringLiteral MethodInvocation SimpleName algo
process auth data request send ssh msg userauth pk ok reply for {}: type fingerprint StringLiteral MethodInvocation MethodInvocation SimpleName key utils
process auth data request send ssh msg userauth pk ok reply for {}: type fingerprint StringLiteral MethodInvocation MethodInvocation SimpleName get finger print
process auth data request send ssh msg userauth pk ok reply for {}: type fingerprint StringLiteral MethodInvocation MethodInvocation SimpleName key
