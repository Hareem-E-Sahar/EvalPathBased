...
local path SimpleName VariableDeclarationFragment MethodInvocation MethodInvocation SimpleName assert hierarchy target folder exists
local path SimpleName VariableDeclarationFragment MethodInvocation MethodInvocation SimpleName lcl sftp
local path SimpleName VariableDeclarationFragment MethodInvocation SimpleName resolve
local path SimpleName VariableDeclarationFragment MethodInvocation StringLiteral filetxt
...
standard charsetsutf QualifiedName MethodInvocation ClassInstanceCreation MethodInvocation SimpleName remote path
...
extra data SimpleName MethodInvocation QualifiedName standard charsetsutf
get bytes SimpleName MethodInvocation QualifiedName standard charsetsutf
