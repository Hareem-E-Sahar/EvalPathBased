...
log SimpleName MethodInvocation StringLiteral do l statid ssh fxp lstat path flags x
...
debug SimpleName MethodInvocation StringLiteral do l statid ssh fxp lstat path flags x
...
do l statid ssh fxp lstat path flags x StringLiteral MethodInvocation MethodInvocation SimpleName get server session
do l statid ssh fxp lstat path flags x StringLiteral MethodInvocation SimpleName id
do l statid ssh fxp lstat path flags x StringLiteral MethodInvocation SimpleName path
do l statid ssh fxp lstat path flags x StringLiteral MethodInvocation SimpleName p
do l statid ssh fxp lstat path flags x StringLiteral MethodInvocation MethodInvocation SimpleName integer
do l statid ssh fxp lstat path flags x StringLiteral MethodInvocation MethodInvocation SimpleName to hex string
do l statid ssh fxp lstat path flags x StringLiteral MethodInvocation MethodInvocation SimpleName flags
