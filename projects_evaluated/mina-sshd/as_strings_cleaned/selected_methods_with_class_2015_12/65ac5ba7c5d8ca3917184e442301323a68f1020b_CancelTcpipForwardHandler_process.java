...
process {} reply StringLiteral InfixExpression SimpleName want reply
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation InfixExpression StringLiteral process {} reply
...
debug SimpleName MethodInvocation InfixExpression StringLiteral process {} reply
...
process {} reply StringLiteral InfixExpression MethodInvocation SimpleName connection service
want reply SimpleName InfixExpression MethodInvocation SimpleName connection service
process {} reply StringLiteral InfixExpression MethodInvocation SimpleName request
want reply SimpleName InfixExpression MethodInvocation SimpleName request
process {} reply StringLiteral InfixExpression MethodInvocation SimpleName socket address
want reply SimpleName InfixExpression MethodInvocation SimpleName socket address
process {} reply StringLiteral InfixExpression MethodInvocation SimpleName want reply
want reply SimpleName InfixExpression MethodInvocation SimpleName want reply
