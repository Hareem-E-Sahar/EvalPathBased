...
putty request handler SimpleName MethodInvocation SimpleName is putty client
putty request handler SimpleName MethodInvocation MethodInvocation SimpleName get server session
is putty client SimpleName MethodInvocation MethodInvocation SimpleName get server session
putty request handler SimpleName MethodInvocation SimpleName resolve shell tty options
putty request handler SimpleName MethodInvocation SimpleName modes
resolve shell tty options SimpleName MethodInvocation SimpleName modes
