...
failed ( StringLiteral InfixExpression StringLiteral ) to announce destruction event
...
e SimpleName MethodInvocation MethodInvocation InfixExpression StringLiteral ) to announce destruction event
get class SimpleName MethodInvocation MethodInvocation InfixExpression StringLiteral ) to announce destruction event
get simple name SimpleName MethodInvocation InfixExpression StringLiteral ) to announce destruction event
...
) to announce destruction event StringLiteral InfixExpression MethodInvocation SimpleName e
) to announce destruction event StringLiteral InfixExpression MethodInvocation SimpleName get message
...
log SimpleName MethodInvocation InfixExpression StringLiteral ) to announce destruction event
...
warn SimpleName MethodInvocation InfixExpression StringLiteral ) to announce destruction event
