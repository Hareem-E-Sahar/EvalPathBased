...
host config entrynegation char pattern QualifiedName MethodInvocation InfixExpression SimpleName test host
host config entry SimpleName MethodInvocation SimpleName to pattern
host config entry SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName string
host config entry SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName value of
host config entry SimpleName MethodInvocation InfixExpression MethodInvocation QualifiedName host config entrynegation char pattern
host config entry SimpleName MethodInvocation InfixExpression SimpleName test host
...
to pattern SimpleName MethodInvocation InfixExpression MethodInvocation QualifiedName host config entrynegation char pattern
...
patterns SimpleName MethodInvocation MethodInvocation SimpleName host config entry
...
add SimpleName MethodInvocation MethodInvocation SimpleName host config entry
...
host config entry SimpleName MethodInvocation SimpleName to pattern
host config entry SimpleName MethodInvocation SimpleName sb
...
host config entry SimpleName MethodInvocation SimpleName test host
host config entry SimpleName MethodInvocation SimpleName patterns
...
assert false SimpleName MethodInvocation MethodInvocation SimpleName host config entry
...
unexpected match for StringLiteral InfixExpression MethodInvocation MethodInvocation SimpleName host config entry
...
patterns SimpleName InfixExpression MethodInvocation MethodInvocation SimpleName host config entry
