...
log SimpleName MethodInvocation StringLiteral do open pty send agent forwarding request
debug SimpleName MethodInvocation StringLiteral do open pty send agent forwarding request
...
log SimpleName MethodInvocation SimpleName is debug enabled
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation StringLiteral do open pty send ssh msg channel request ptyreq type cols lines height width modes
log SimpleName MethodInvocation SimpleName pty type
log SimpleName MethodInvocation SimpleName pty columns
debug SimpleName MethodInvocation StringLiteral do open pty send ssh msg channel request ptyreq type cols lines height width modes
...
do open pty send ssh msg channel request ptyreq type cols lines height width modes StringLiteral MethodInvocation SimpleName pty type
do open pty send ssh msg channel request ptyreq type cols lines height width modes StringLiteral MethodInvocation SimpleName pty columns
do open pty send ssh msg channel request ptyreq type cols lines height width modes StringLiteral MethodInvocation SimpleName pty lines
do open pty send ssh msg channel request ptyreq type cols lines height width modes StringLiteral MethodInvocation SimpleName pty height
...
log SimpleName MethodInvocation SimpleName is debug enabled
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation StringLiteral do open pty send ssh msg channel request env {}
log SimpleName MethodInvocation SimpleName env
debug SimpleName MethodInvocation StringLiteral do open pty send ssh msg channel request env {}
debug SimpleName MethodInvocation SimpleName env
do open pty send ssh msg channel request env {} StringLiteral MethodInvocation SimpleName env
