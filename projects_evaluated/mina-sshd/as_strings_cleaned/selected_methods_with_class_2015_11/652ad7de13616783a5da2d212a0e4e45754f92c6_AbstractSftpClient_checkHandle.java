...
int PrimitiveType VariableDeclarationStatement VariableDeclarationFragment MethodInvocation SimpleName buffer
int PrimitiveType VariableDeclarationStatement VariableDeclarationFragment MethodInvocation SimpleName get int
type SimpleName InfixExpression QualifiedName sftp constantsssh fxp handle
...
check handleid - status {} [{}] {} StringLiteral MethodInvocation MethodInvocation SimpleName get client channel
check handleid - status {} [{}] {} StringLiteral MethodInvocation SimpleName id
check handleid - status {} [{}] {} StringLiteral MethodInvocation MethodInvocation SimpleName sftp constants
check handleid - status {} [{}] {} StringLiteral MethodInvocation MethodInvocation SimpleName get status name
...
handle unexpected handle packet SimpleName MethodInvocation SimpleName id
handle unexpected handle packet SimpleName MethodInvocation SimpleName type
handle unexpected handle packet SimpleName MethodInvocation SimpleName length
handle unexpected handle packet SimpleName MethodInvocation SimpleName buffer
