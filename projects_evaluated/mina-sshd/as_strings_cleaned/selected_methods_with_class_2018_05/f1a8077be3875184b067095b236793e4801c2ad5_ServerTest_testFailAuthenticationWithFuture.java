...
assert true SimpleName MethodInvocation StringLiteral number of trials below max
...
number of trials below max StringLiteral MethodInvocation InfixExpression SimpleName nb trials
number of trials below max StringLiteral MethodInvocation InfixExpression NumberLiteral empty
...
authentication wait failed StringLiteral MethodInvocation MethodInvocation NumberLiteral l
authentication wait failed StringLiteral MethodInvocation MethodInvocation QualifiedName time unitseconds
...
auth future SimpleName MethodInvocation SimpleName get exception
t SimpleName VariableDeclarationFragment MethodInvocation SimpleName auth future
...
assert not null SimpleName MethodInvocation SimpleName t
missing auth future exception StringLiteral MethodInvocation SimpleName t
