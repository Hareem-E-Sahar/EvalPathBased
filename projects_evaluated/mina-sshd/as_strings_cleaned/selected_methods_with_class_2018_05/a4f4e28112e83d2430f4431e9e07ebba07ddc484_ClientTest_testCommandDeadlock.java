...
ssh exception SimpleName SimpleType UnionType SimpleType SimpleName ssh channel closed exception
ssh exception SimpleName SimpleType UnionType SingleVariableDeclaration SimpleName e
ssh channel closed exception SimpleName SimpleType UnionType SingleVariableDeclaration SimpleName e
...
output debug message SimpleName MethodInvocation StringLiteral s - ignore s s
output debug message SimpleName MethodInvocation MethodInvocation SimpleName get current test name
...
s - ignore s s StringLiteral MethodInvocation MethodInvocation SimpleName get current test name
s - ignore s s StringLiteral MethodInvocation MethodInvocation MethodInvocation SimpleName e
s - ignore s s StringLiteral MethodInvocation MethodInvocation MethodInvocation SimpleName get class
s - ignore s s StringLiteral MethodInvocation MethodInvocation SimpleName get simple name
s - ignore s s StringLiteral MethodInvocation MethodInvocation SimpleName e
s - ignore s s StringLiteral MethodInvocation MethodInvocation SimpleName get message
get current test name SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName get simple name
get current test name SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName e
get current test name SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName get message
...
mask SimpleName VariableDeclarationFragment MethodInvocation QualifiedName client channel eventclosed
collection SimpleName SimpleType ParameterizedType SimpleType SimpleName client channel event
...
channel SimpleName MethodInvocation SimpleName mask
channel SimpleName MethodInvocation MethodInvocation QualifiedName time unitseconds
...
missing close event StringLiteral InfixExpression SimpleName result
...
assert true SimpleName MethodInvocation InfixExpression StringLiteral missing close event
...
missing close event StringLiteral InfixExpression MethodInvocation MethodInvocation SimpleName result
missing close event StringLiteral InfixExpression MethodInvocation MethodInvocation SimpleName contains all
missing close event StringLiteral InfixExpression MethodInvocation MethodInvocation SimpleName mask
