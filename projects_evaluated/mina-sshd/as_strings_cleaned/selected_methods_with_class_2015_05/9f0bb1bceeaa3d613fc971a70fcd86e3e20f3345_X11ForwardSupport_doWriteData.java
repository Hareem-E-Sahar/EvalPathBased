...
server session SimpleName MethodInvocation ClassInstanceCreation SimpleType SimpleName byte array buffer
server session SimpleName MethodInvocation ClassInstanceCreation SimpleName data
server session SimpleName MethodInvocation ClassInstanceCreation SimpleName off
server session SimpleName MethodInvocation ClassInstanceCreation SimpleName len
