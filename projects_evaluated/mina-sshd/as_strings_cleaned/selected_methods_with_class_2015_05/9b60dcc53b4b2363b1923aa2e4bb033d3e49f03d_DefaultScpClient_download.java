...
interrupted while await channel open for download of StringLiteral InfixExpression SimpleName remote
interrupted while await channel open for download of StringLiteral InfixExpression StringLiteral to
interrupted while await channel open for download of StringLiteral InfixExpression SimpleName local
remote SimpleName InfixExpression StringLiteral to
remote SimpleName InfixExpression SimpleName local
to StringLiteral InfixExpression SimpleName local
interrupted io exception SimpleName SimpleType ClassInstanceCreation InfixExpression StringLiteral interrupted while await channel open for download of
...
interrupted io exception SimpleName SimpleType ClassInstanceCreation InfixExpression SimpleName local
interrupted io exception SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName init cause
interrupted while await channel open for download of StringLiteral InfixExpression ClassInstanceCreation MethodInvocation SimpleName init cause
...
local SimpleName InfixExpression ClassInstanceCreation MethodInvocation SimpleName init cause
interrupted io exception SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName e
interrupted while await channel open for download of StringLiteral InfixExpression ClassInstanceCreation MethodInvocation SimpleName e
...
local SimpleName InfixExpression ClassInstanceCreation MethodInvocation SimpleName e
