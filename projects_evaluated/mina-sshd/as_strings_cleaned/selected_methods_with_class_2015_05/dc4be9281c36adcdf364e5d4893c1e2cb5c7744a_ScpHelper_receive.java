...
target directory StringLiteral InfixExpression StringLiteral is most like inaccessible
path SimpleName MethodInvocation InfixExpression StringLiteral is most like inaccessible
to string SimpleName MethodInvocation InfixExpression StringLiteral is most like inaccessible
ssh exception SimpleName SimpleType ClassInstanceCreation InfixExpression StringLiteral target directory
ssh exception SimpleName SimpleType ClassInstanceCreation InfixExpression StringLiteral is most like inaccessible
...
path SimpleName MethodInvocation InfixExpression StringLiteral does not exist
