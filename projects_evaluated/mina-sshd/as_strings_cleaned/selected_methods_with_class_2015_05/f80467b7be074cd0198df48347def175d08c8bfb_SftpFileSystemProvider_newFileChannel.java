...
collection SimpleName SimpleType ParameterizedType SimpleType QualifiedName sftp clientopen mode
...
option SimpleName InfixExpression QualifiedName standard open optionsparse
new file channel StringLiteral InfixExpression SimpleName path
new file channel StringLiteral InfixExpression StringLiteral ) unsupported open option
new file channel StringLiteral InfixExpression SimpleName option
path SimpleName InfixExpression StringLiteral ) unsupported open option
path SimpleName InfixExpression SimpleName option
) unsupported open option StringLiteral InfixExpression SimpleName option
illegal argument exception SimpleName SimpleType ClassInstanceCreation InfixExpression StringLiteral new file channel
...
sftp file channel SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName to sftp path
sftp file channel SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName path
sftp file channel SimpleName SimpleType ClassInstanceCreation SimpleName modes
to sftp path SimpleName MethodInvocation ClassInstanceCreation SimpleName modes
path SimpleName MethodInvocation ClassInstanceCreation SimpleName modes
