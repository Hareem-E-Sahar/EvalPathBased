...
int PrimitiveType VariableDeclarationStatement VariableDeclarationFragment MethodInvocation SimpleName buffer
int PrimitiveType VariableDeclarationStatement VariableDeclarationFragment MethodInvocation SimpleName get int
host to connect SimpleName ArrayInitializer SimpleName port to connect
host to connect SimpleName ArrayInitializer SimpleName originator ip address
host to connect SimpleName ArrayInitializer SimpleName originator port
port to connect SimpleName ArrayInitializer SimpleName originator ip address
port to connect SimpleName ArrayInitializer SimpleName originator port
originator ip address SimpleName ArrayInitializer SimpleName originator port
...
log SimpleName MethodInvocation ArrayCreation ArrayInitializer SimpleName port to connect
log SimpleName MethodInvocation ArrayCreation ArrayInitializer SimpleName originator ip address
log SimpleName MethodInvocation ArrayCreation ArrayInitializer SimpleName originator port
...
info SimpleName MethodInvocation ArrayCreation ArrayInitializer SimpleName port to connect
info SimpleName MethodInvocation ArrayCreation ArrayInitializer SimpleName originator ip address
info SimpleName MethodInvocation ArrayCreation ArrayInitializer SimpleName originator port
...
receiving request for direct tcpip host to connect port to connect originator ip address originator port StringLiteral MethodInvocation ArrayCreation ArrayInitializer SimpleName port to connect
...
receiving request for direct tcpip host to connect port to connect originator ip address originator port StringLiteral MethodInvocation ArrayCreation ArrayInitializer SimpleName originator port
...
ignoring write to channel {} in closing state StringLiteral MethodInvocation SimpleName id
