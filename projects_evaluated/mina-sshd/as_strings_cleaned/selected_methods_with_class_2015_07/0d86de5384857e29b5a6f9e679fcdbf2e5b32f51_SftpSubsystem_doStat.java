...
log SimpleName MethodInvocation StringLiteral received ssh fxp stat path flags x
...
debug SimpleName MethodInvocation StringLiteral received ssh fxp stat path flags x
...
received ssh fxp stat path flags x StringLiteral MethodInvocation SimpleName path
received ssh fxp stat path flags x StringLiteral MethodInvocation MethodInvocation SimpleName integer
received ssh fxp stat path flags x StringLiteral MethodInvocation MethodInvocation SimpleName to hex string
received ssh fxp stat path flags x StringLiteral MethodInvocation MethodInvocation SimpleName flags
