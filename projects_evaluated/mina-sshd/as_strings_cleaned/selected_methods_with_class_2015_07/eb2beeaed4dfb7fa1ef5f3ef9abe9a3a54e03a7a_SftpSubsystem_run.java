...
bad length to read StringLiteral InfixExpression SimpleName length
illegal argument exception SimpleName SimpleType ClassInstanceCreation InfixExpression StringLiteral bad length to read
...
premature eof while read length StringLiteral InfixExpression SimpleName length
premature eof while read length StringLiteral InfixExpression StringLiteral while remain
premature eof while read length StringLiteral InfixExpression SimpleName nb
length SimpleName InfixExpression StringLiteral while remain
length SimpleName InfixExpression SimpleName nb
while remain StringLiteral InfixExpression SimpleName nb
illegal argument exception SimpleName SimpleType ClassInstanceCreation InfixExpression StringLiteral premature eof while read length
illegal argument exception SimpleName SimpleType ClassInstanceCreation InfixExpression SimpleName length
illegal argument exception SimpleName SimpleType ClassInstanceCreation InfixExpression StringLiteral while remain
