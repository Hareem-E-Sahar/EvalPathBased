...
local dir SimpleName MethodInvocation StringLiteral zerotxt
resolve SimpleName MethodInvocation StringLiteral zerotxt
...
zero local SimpleName VariableDeclarationFragment MethodInvocation StringLiteral zerotxt
...
file channel SimpleName MethodInvocation SimpleName zero local
...
open SimpleName MethodInvocation SimpleName zero local
...
zero local SimpleName MethodInvocation QualifiedName standard open optioncreate
zero local SimpleName MethodInvocation QualifiedName standard open optionwrite
zero local SimpleName MethodInvocation QualifiedName standard open optiontruncate existing
...
fch SimpleName VariableDeclarationFragment MethodInvocation SimpleName zero local
...
nonzero size for local file StringLiteral InfixExpression SimpleName zero local
files SimpleName MethodInvocation SimpleName size
files SimpleName MethodInvocation SimpleName zero local
size SimpleName MethodInvocation SimpleName zero local
assert equals SimpleName MethodInvocation InfixExpression StringLiteral nonzero size for local file
assert equals SimpleName MethodInvocation InfixExpression SimpleName zero local
...
zero local SimpleName InfixExpression MethodInvocation NumberLiteral l
nonzero size for local file StringLiteral InfixExpression MethodInvocation MethodInvocation SimpleName files
nonzero size for local file StringLiteral InfixExpression MethodInvocation MethodInvocation SimpleName size
nonzero size for local file StringLiteral InfixExpression MethodInvocation MethodInvocation SimpleName zero local
zero local SimpleName InfixExpression MethodInvocation MethodInvocation SimpleName files
zero local SimpleName InfixExpression MethodInvocation MethodInvocation SimpleName size
zero local SimpleName InfixExpression MethodInvocation MethodInvocation SimpleName zero local
...
exists SimpleName MethodInvocation SimpleName zero remote
files SimpleName MethodInvocation SimpleName delete
files SimpleName MethodInvocation SimpleName zero remote
delete SimpleName MethodInvocation SimpleName zero remote
...
upload SimpleName MethodInvocation MethodInvocation SimpleName zero local
...
zero local SimpleName MethodInvocation MethodInvocation SimpleName remote path
