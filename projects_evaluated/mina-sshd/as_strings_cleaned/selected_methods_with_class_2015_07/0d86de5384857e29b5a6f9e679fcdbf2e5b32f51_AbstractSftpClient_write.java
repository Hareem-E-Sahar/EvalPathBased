...
write StringLiteral InfixExpression SimpleName len
write StringLiteral InfixExpression StringLiteral ] stream is closed
path SimpleName InfixExpression StringLiteral len
path SimpleName InfixExpression SimpleName len
path SimpleName InfixExpression StringLiteral ] stream is closed
len StringLiteral InfixExpression SimpleName len
len StringLiteral InfixExpression StringLiteral ] stream is closed
len SimpleName InfixExpression StringLiteral ] stream is closed
io exception SimpleName SimpleType ClassInstanceCreation InfixExpression StringLiteral write
io exception SimpleName SimpleType ClassInstanceCreation InfixExpression SimpleName path
io exception SimpleName SimpleType ClassInstanceCreation InfixExpression StringLiteral len
...
io exception SimpleName SimpleType ClassInstanceCreation InfixExpression SimpleName path
io exception SimpleName SimpleType ClassInstanceCreation InfixExpression StringLiteral ) stream is closed
abstract sftp client SimpleName ThisExpression MethodInvocation SimpleName write
