...
client sessionclosed QualifiedName InfixExpression MethodInvocation MethodInvocation QualifiedName time unitseconds
client sessionclosed QualifiedName InfixExpression MethodInvocation MethodInvocation SimpleName to millis
client sessionclosed QualifiedName InfixExpression MethodInvocation MethodInvocation NumberLiteral l
client sessionwait auth QualifiedName InfixExpression MethodInvocation MethodInvocation QualifiedName time unitseconds
client sessionwait auth QualifiedName InfixExpression MethodInvocation MethodInvocation SimpleName to millis
client sessionwait auth QualifiedName InfixExpression MethodInvocation MethodInvocation NumberLiteral l
...
timeout exception SimpleName SimpleType ClassInstanceCreation StringLiteral client session timeout signalled
