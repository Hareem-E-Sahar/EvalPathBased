...
log SimpleName MethodInvocation StringLiteral send agent forwarding request - recipient
...
debug SimpleName MethodInvocation StringLiteral send agent forwarding request - recipient
...
send agent forwarding request - recipient StringLiteral MethodInvocation MethodInvocation SimpleName integer
send agent forwarding request - recipient StringLiteral MethodInvocation MethodInvocation SimpleName value of
send agent forwarding request - recipient StringLiteral MethodInvocation MethodInvocation SimpleName recipient
...
log SimpleName MethodInvocation SimpleName is debug enabled
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation StringLiteral send ssh msg channel request ptyreq type cols lines height width modes
log SimpleName MethodInvocation SimpleName pty type
log SimpleName MethodInvocation SimpleName pty columns
log SimpleName MethodInvocation SimpleName pty lines
debug SimpleName MethodInvocation StringLiteral send ssh msg channel request ptyreq type cols lines height width modes
...
debug SimpleName MethodInvocation SimpleName pty height
send ssh msg channel request ptyreq type cols lines height width modes StringLiteral MethodInvocation SimpleName pty type
send ssh msg channel request ptyreq type cols lines height width modes StringLiteral MethodInvocation SimpleName pty columns
send ssh msg channel request ptyreq type cols lines height width modes StringLiteral MethodInvocation SimpleName pty lines
send ssh msg channel request ptyreq type cols lines height width modes StringLiteral MethodInvocation SimpleName pty height
send ssh msg channel request ptyreq type cols lines height width modes StringLiteral MethodInvocation SimpleName pty width
...
send ssh msg channel request env {} StringLiteral MethodInvocation SimpleName env
