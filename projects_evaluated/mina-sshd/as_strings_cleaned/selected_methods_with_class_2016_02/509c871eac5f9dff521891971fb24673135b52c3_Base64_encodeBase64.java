...
number utils SimpleName MethodInvocation SimpleName binary data
length SimpleName MethodInvocation SimpleName binary data
length data bytes SimpleName VariableDeclarationFragment MethodInvocation SimpleName number utils
length data bytes SimpleName VariableDeclarationFragment MethodInvocation SimpleName length
length data bytes SimpleName VariableDeclarationFragment MethodInvocation SimpleName binary data
int PrimitiveType VariableDeclarationStatement VariableDeclarationFragment SimpleName length data bytes
...
int PrimitiveType VariableDeclarationStatement VariableDeclarationFragment MethodInvocation SimpleName binary data
length data bytes SimpleName InfixExpression SimpleName eightbit
length data bits SimpleName VariableDeclarationFragment InfixExpression SimpleName length data bytes
...
int PrimitiveType VariableDeclarationStatement VariableDeclarationFragment InfixExpression SimpleName length data bytes
