...
log SimpleName MethodInvocation StringLiteral read identification server version string {}
log SimpleName MethodInvocation SimpleName server version
debug SimpleName MethodInvocation StringLiteral read identification server version string {}
debug SimpleName MethodInvocation SimpleName server version
read identification server version string {} StringLiteral MethodInvocation SimpleName server version
server version SimpleName MethodInvocation SimpleName starts with
server version SimpleName MethodInvocation SimpleName default ssh version prefix
...
default ssh version prefix SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName server version
default ssh version prefix SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName starts with
default ssh version prefix SimpleName MethodInvocation InfixExpression MethodInvocation StringLiteral ssh . -
