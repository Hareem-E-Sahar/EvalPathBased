...
failed ( StringLiteral InfixExpression StringLiteral to read uint value
...
e SimpleName MethodInvocation MethodInvocation InfixExpression StringLiteral to read uint value
get class SimpleName MethodInvocation MethodInvocation InfixExpression StringLiteral to read uint value
get simple name SimpleName MethodInvocation InfixExpression StringLiteral to read uint value
...
) StringLiteral InfixExpression StringLiteral to read uint value
...
to read uint value StringLiteral InfixExpression MethodInvocation SimpleName e
to read uint value StringLiteral InfixExpression MethodInvocation SimpleName get message
...
stream corrupted exception SimpleName SimpleType ClassInstanceCreation InfixExpression StringLiteral to read uint value
