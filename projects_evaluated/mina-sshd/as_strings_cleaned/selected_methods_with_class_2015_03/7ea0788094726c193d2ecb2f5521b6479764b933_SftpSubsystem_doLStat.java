...
log SimpleName MethodInvocation StringLiteral received ssh fxp lstat path flags
...
debug SimpleName MethodInvocation StringLiteral received ssh fxp lstat path flags
...
received ssh fxp lstat path flags StringLiteral MethodInvocation SimpleName path
received ssh fxp lstat path flags StringLiteral MethodInvocation InfixExpression StringLiteral x
received ssh fxp lstat path flags StringLiteral MethodInvocation InfixExpression MethodInvocation SimpleName integer
received ssh fxp lstat path flags StringLiteral MethodInvocation InfixExpression MethodInvocation SimpleName to hex string
received ssh fxp lstat path flags StringLiteral MethodInvocation InfixExpression MethodInvocation SimpleName flags
...
send attrs SimpleName MethodInvocation BooleanLiteral false
...
void PrimitiveType MethodDeclaration SimpleName do l stat
...
do l stat SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName buffer
do l stat SimpleName MethodDeclaration SingleVariableDeclaration SimpleName buffer
...
do l stat SimpleName MethodDeclaration Block VariableDeclarationStatement PrimitiveType int
