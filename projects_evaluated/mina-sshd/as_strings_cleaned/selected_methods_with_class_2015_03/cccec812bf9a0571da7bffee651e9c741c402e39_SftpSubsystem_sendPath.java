...
send path StringLiteral InfixExpression SimpleName f
send path StringLiteral InfixExpression StringLiteral ) unsupported version
send path StringLiteral InfixExpression SimpleName version
f SimpleName InfixExpression StringLiteral ) unsupported version
f SimpleName InfixExpression SimpleName version
) unsupported version StringLiteral InfixExpression SimpleName version
illegal state exception SimpleName SimpleType ClassInstanceCreation InfixExpression StringLiteral send path
illegal state exception SimpleName SimpleType ClassInstanceCreation InfixExpression SimpleName f
