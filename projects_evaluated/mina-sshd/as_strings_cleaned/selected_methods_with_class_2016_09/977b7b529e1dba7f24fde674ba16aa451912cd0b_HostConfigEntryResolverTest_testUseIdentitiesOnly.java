...
provider SimpleName VariableDeclarationFragment ClassInstanceCreation SimpleType SimpleName abstract key pair provider
...
assert same SimpleName MethodInvocation StringLiteral unexpected session key pairs provider
...
assert same SimpleName MethodInvocation MethodInvocation SimpleName get key pair provider
unexpected session key pairs provider StringLiteral MethodInvocation SimpleName provider
...
provider SimpleName MethodInvocation MethodInvocation SimpleName session
provider SimpleName MethodInvocation MethodInvocation SimpleName get key pair provider
