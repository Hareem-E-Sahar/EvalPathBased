...
log SimpleName MethodInvocation StringLiteral send cmd len id
...
trace SimpleName MethodInvocation StringLiteral send cmd len id
...
send cmd len id StringLiteral MethodInvocation MethodInvocation SimpleName get client channel
send cmd len id StringLiteral MethodInvocation MethodInvocation SimpleName sftp constants
send cmd len id StringLiteral MethodInvocation MethodInvocation SimpleName get command message name
send cmd len id StringLiteral MethodInvocation MethodInvocation SimpleName cmd
send cmd len id StringLiteral MethodInvocation SimpleName len
send cmd len id StringLiteral MethodInvocation SimpleName id
...
get client channel SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName cmd
...
sftp constants SimpleName MethodInvocation MethodInvocation SimpleName len
get command message name SimpleName MethodInvocation MethodInvocation SimpleName len
cmd SimpleName MethodInvocation MethodInvocation SimpleName len
...
cmd SimpleName MethodInvocation MethodInvocation SimpleName id
...
buffer utils SimpleName MethodInvocation InfixExpression QualifiedName integerbytes
buffer utils SimpleName MethodInvocation InfixExpression SimpleName len
...
write int SimpleName MethodInvocation InfixExpression QualifiedName integerbytes
write int SimpleName MethodInvocation InfixExpression SimpleName len
...
dos SimpleName MethodInvocation InfixExpression QualifiedName integerbytes
dos SimpleName MethodInvocation InfixExpression SimpleName len
...
integerbytes QualifiedName InfixExpression MethodInvocation SimpleName work buf
len SimpleName InfixExpression MethodInvocation SimpleName work buf
