...
key exchange SimpleName MethodInvocation SimpleName get group kex opcode name
...
key exchange SimpleName MethodInvocation SimpleName get group kex opcode name
key exchange SimpleName MethodInvocation SimpleName expected
get group kex opcode name SimpleName MethodInvocation SimpleName expected
key exchange SimpleName MethodInvocation SimpleName get group kex opcode name
key exchange SimpleName MethodInvocation SimpleName cmd
get group kex opcode name SimpleName MethodInvocation SimpleName cmd
protocol error expected packet StringLiteral InfixExpression MethodInvocation SimpleName key exchange
...
key exchange SimpleName MethodInvocation InfixExpression StringLiteral got
...
key exchange SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName key exchange
key exchange SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName get group kex opcode name
key exchange SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName cmd
get group kex opcode name SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName key exchange
...
expected SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName key exchange
...
got StringLiteral InfixExpression MethodInvocation SimpleName key exchange
...
elength QualifiedName InfixExpression QualifiedName bytesize
...
session SimpleName MethodInvocation InfixExpression QualifiedName elength
...
create buffer SimpleName MethodInvocation InfixExpression QualifiedName elength
create buffer SimpleName MethodInvocation InfixExpression QualifiedName bytesize
ssh constantsssh msg kex dh gex init QualifiedName MethodInvocation InfixExpression QualifiedName elength
ssh constantsssh msg kex dh gex init QualifiedName MethodInvocation InfixExpression QualifiedName bytesize
...
buffer SimpleName Assignment MethodInvocation InfixExpression QualifiedName elength
...
key exchange SimpleName MethodInvocation SimpleName cmd
get group kex opcode name SimpleName MethodInvocation SimpleName cmd
unknown command value StringLiteral InfixExpression MethodInvocation SimpleName key exchange
