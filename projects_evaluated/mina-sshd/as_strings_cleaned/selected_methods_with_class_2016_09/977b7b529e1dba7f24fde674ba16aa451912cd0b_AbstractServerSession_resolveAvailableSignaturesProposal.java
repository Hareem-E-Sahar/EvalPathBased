...
proposed manager SimpleName InfixExpression MethodInvocation SimpleName get factory manager
...
get factory manager SimpleName MethodInvocation InfixExpression MethodInvocation StringLiteral mismatched signatures proposed factory manager
...
supported SimpleName VariableDeclarationFragment MethodInvocation SimpleName named resource
...
provided SimpleName Assignment ConditionalExpression MethodInvocation SimpleName kpp
provided SimpleName Assignment ConditionalExpression MethodInvocation SimpleName get key types
...
log SimpleName MethodInvocation StringLiteral resolve available signatures proposal failed ({}) to get key types {}
...
warn SimpleName MethodInvocation StringLiteral resolve available signatures proposal failed ({}) to get key types {}
...
resolve available signatures proposal failed ({}) to get key types {} StringLiteral MethodInvocation MethodInvocation MethodInvocation SimpleName e
resolve available signatures proposal failed ({}) to get key types {} StringLiteral MethodInvocation MethodInvocation MethodInvocation SimpleName get class
resolve available signatures proposal failed ({}) to get key types {} StringLiteral MethodInvocation MethodInvocation SimpleName get simple name
resolve available signatures proposal failed ({}) to get key types {} StringLiteral MethodInvocation MethodInvocation SimpleName e
resolve available signatures proposal failed ({}) to get key types {} StringLiteral MethodInvocation MethodInvocation SimpleName get message
...
resolve available signatures proposal StringLiteral InfixExpression StringLiteral ) fetch key types failure details
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation InfixExpression StringLiteral resolve available signatures proposal
log SimpleName MethodInvocation InfixExpression StringLiteral ) fetch key types failure details
log SimpleName MethodInvocation SimpleName e
debug SimpleName MethodInvocation InfixExpression StringLiteral resolve available signatures proposal
debug SimpleName MethodInvocation InfixExpression StringLiteral ) fetch key types failure details
debug SimpleName MethodInvocation SimpleName e
resolve available signatures proposal StringLiteral InfixExpression MethodInvocation SimpleName e
) fetch key types failure details StringLiteral InfixExpression MethodInvocation SimpleName e
...
log SimpleName MethodInvocation SimpleName is debug enabled
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation StringLiteral resolve available signatures proposal {} not in supported list {}
log SimpleName MethodInvocation SimpleName provided
log SimpleName MethodInvocation SimpleName key type
debug SimpleName MethodInvocation StringLiteral resolve available signatures proposal {} not in supported list {}
debug SimpleName MethodInvocation SimpleName provided
debug SimpleName MethodInvocation SimpleName key type
debug SimpleName MethodInvocation SimpleName supported
resolve available signatures proposal {} not in supported list {} StringLiteral MethodInvocation SimpleName provided
resolve available signatures proposal {} not in supported list {} StringLiteral MethodInvocation SimpleName key type
resolve available signatures proposal {} not in supported list {} StringLiteral MethodInvocation SimpleName supported
provided SimpleName MethodInvocation SimpleName key type
provided SimpleName MethodInvocation SimpleName supported
key type SimpleName MethodInvocation SimpleName supported
