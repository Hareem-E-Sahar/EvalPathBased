...
log SimpleName MethodInvocation StringLiteral do real pathid ssh fxp realpath path
...
debug SimpleName MethodInvocation StringLiteral do real pathid ssh fxp realpath path
...
do real pathid ssh fxp realpath path StringLiteral MethodInvocation MethodInvocation SimpleName get server session
do real pathid ssh fxp realpath path StringLiteral MethodInvocation SimpleName id
do real pathid ssh fxp realpath path StringLiteral MethodInvocation SimpleName path
...
control SimpleName VariableDeclarationFragment QualifiedName sftp constantsssh fxp realpath no check
int PrimitiveType VariableDeclarationStatement VariableDeclarationFragment SimpleName control
int PrimitiveType VariableDeclarationStatement VariableDeclarationFragment QualifiedName sftp constantsssh fxp realpath no check
...
integer SimpleName MethodInvocation SimpleName control
to hex string SimpleName MethodInvocation SimpleName control
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation StringLiteral do real path - control x for path
log SimpleName MethodInvocation MethodInvocation SimpleName get server session
...
log SimpleName MethodInvocation MethodInvocation SimpleName control
log SimpleName MethodInvocation SimpleName path
debug SimpleName MethodInvocation StringLiteral do real path - control x for path
debug SimpleName MethodInvocation MethodInvocation SimpleName get server session
...
debug SimpleName MethodInvocation MethodInvocation SimpleName control
debug SimpleName MethodInvocation SimpleName path
do real path - control x for path StringLiteral MethodInvocation MethodInvocation SimpleName get server session
do real path - control x for path StringLiteral MethodInvocation MethodInvocation SimpleName integer
do real path - control x for path StringLiteral MethodInvocation MethodInvocation SimpleName to hex string
do real path - control x for path StringLiteral MethodInvocation MethodInvocation SimpleName control
do real path - control x for path StringLiteral MethodInvocation SimpleName path
...
get server session SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName control
get server session SimpleName MethodInvocation MethodInvocation SimpleName path
integer SimpleName MethodInvocation MethodInvocation SimpleName path
to hex string SimpleName MethodInvocation MethodInvocation SimpleName path
control SimpleName MethodInvocation MethodInvocation SimpleName path
...
handle unknown status file attributes SimpleName MethodInvocation QualifiedName sftp constantsssh filexfer attr all
handle unknown status file attributes SimpleName MethodInvocation SimpleName options
p SimpleName MethodInvocation QualifiedName sftp constantsssh filexfer attr all
...
attrs SimpleName Assignment MethodInvocation QualifiedName sftp constantsssh filexfer attr all
...
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation StringLiteral do real path - failed ({}) to retrieve attributes of {}: {}
log SimpleName MethodInvocation MethodInvocation SimpleName get server session
...
debug SimpleName MethodInvocation StringLiteral do real path - failed ({}) to retrieve attributes of {}: {}
debug SimpleName MethodInvocation MethodInvocation SimpleName get server session
...
do real path - failed ({}) to retrieve attributes of {}: {} StringLiteral MethodInvocation MethodInvocation SimpleName get server session
do real path - failed ({}) to retrieve attributes of {}: {} StringLiteral MethodInvocation MethodInvocation MethodInvocation SimpleName e
do real path - failed ({}) to retrieve attributes of {}: {} StringLiteral MethodInvocation MethodInvocation MethodInvocation SimpleName get class
do real path - failed ({}) to retrieve attributes of {}: {} StringLiteral MethodInvocation MethodInvocation SimpleName get simple name
do real path - failed ({}) to retrieve attributes of {}: {} StringLiteral MethodInvocation SimpleName p
do real path - failed ({}) to retrieve attributes of {}: {} StringLiteral MethodInvocation MethodInvocation SimpleName e
do real path - failed ({}) to retrieve attributes of {}: {} StringLiteral MethodInvocation MethodInvocation SimpleName get message
...
get server session SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName e
...
do real path StringLiteral InfixExpression MethodInvocation SimpleName get server session
do real path StringLiteral InfixExpression StringLiteral )[
do real path StringLiteral InfixExpression SimpleName p
do real path StringLiteral InfixExpression StringLiteral ] attributes retrieval failure details
get server session SimpleName MethodInvocation InfixExpression StringLiteral )[
get server session SimpleName MethodInvocation InfixExpression SimpleName p
get server session SimpleName MethodInvocation InfixExpression StringLiteral ] attributes retrieval failure details
)[ StringLiteral InfixExpression SimpleName p
)[ StringLiteral InfixExpression StringLiteral ] attributes retrieval failure details
p SimpleName InfixExpression StringLiteral ] attributes retrieval failure details
log SimpleName MethodInvocation SimpleName trace
log SimpleName MethodInvocation InfixExpression StringLiteral do real path
...
log SimpleName MethodInvocation InfixExpression StringLiteral ] attributes retrieval failure details
log SimpleName MethodInvocation SimpleName e
trace SimpleName MethodInvocation InfixExpression StringLiteral do real path
...
trace SimpleName MethodInvocation InfixExpression StringLiteral ] attributes retrieval failure details
trace SimpleName MethodInvocation SimpleName e
do real path StringLiteral InfixExpression MethodInvocation SimpleName e
get server session SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName e
)[ StringLiteral InfixExpression MethodInvocation SimpleName e
p SimpleName InfixExpression MethodInvocation SimpleName e
] attributes retrieval failure details StringLiteral InfixExpression MethodInvocation SimpleName e
log SimpleName MethodInvocation SimpleName is debug enabled
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation StringLiteral do real path - dummy attributes for nonexisting file {}
log SimpleName MethodInvocation MethodInvocation SimpleName get server session
log SimpleName MethodInvocation SimpleName p
debug SimpleName MethodInvocation StringLiteral do real path - dummy attributes for nonexisting file {}
debug SimpleName MethodInvocation MethodInvocation SimpleName get server session
debug SimpleName MethodInvocation SimpleName p
do real path - dummy attributes for nonexisting file {} StringLiteral MethodInvocation MethodInvocation SimpleName get server session
do real path - dummy attributes for nonexisting file {} StringLiteral MethodInvocation SimpleName p
get server session SimpleName MethodInvocation MethodInvocation SimpleName p
...
log SimpleName MethodInvocation StringLiteral do real path unknown control value x for path
log SimpleName MethodInvocation MethodInvocation SimpleName get server session
log SimpleName MethodInvocation MethodInvocation SimpleName integer
log SimpleName MethodInvocation MethodInvocation SimpleName to hex string
log SimpleName MethodInvocation MethodInvocation SimpleName control
log SimpleName MethodInvocation SimpleName p
warn SimpleName MethodInvocation StringLiteral do real path unknown control value x for path
...
warn SimpleName MethodInvocation MethodInvocation SimpleName to hex string
warn SimpleName MethodInvocation MethodInvocation SimpleName control
warn SimpleName MethodInvocation SimpleName p
do real path unknown control value x for path StringLiteral MethodInvocation MethodInvocation SimpleName get server session
do real path unknown control value x for path StringLiteral MethodInvocation MethodInvocation SimpleName integer
do real path unknown control value x for path StringLiteral MethodInvocation MethodInvocation SimpleName to hex string
do real path unknown control value x for path StringLiteral MethodInvocation MethodInvocation SimpleName control
do real path unknown control value x for path StringLiteral MethodInvocation SimpleName p
get server session SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName integer
get server session SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName to hex string
get server session SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName control
get server session SimpleName MethodInvocation MethodInvocation SimpleName p
integer SimpleName MethodInvocation MethodInvocation SimpleName p
to hex string SimpleName MethodInvocation MethodInvocation SimpleName p
control SimpleName MethodInvocation MethodInvocation SimpleName p
control SimpleName SwitchStatement SwitchCase QualifiedName sftp constantsssh fxp realpath stat if
control SimpleName SwitchStatement IfStatement InfixExpression SimpleName status
control SimpleName SwitchStatement IfStatement IfStatement SimpleName status
control SimpleName SwitchStatement SwitchCase QualifiedName sftp constantsssh fxp realpath stat always
control SimpleName SwitchStatement IfStatement InfixExpression SimpleName status
control SimpleName SwitchStatement IfStatement IfStatement SimpleName status
sftp constantsssh fxp realpath stat if QualifiedName SwitchCase SwitchStatement SwitchCase QualifiedName sftp constantsssh fxp realpath stat always
sftp constantsssh fxp realpath stat always QualifiedName SwitchCase SwitchStatement SwitchCase QualifiedName sftp constantsssh fxp realpath no check
