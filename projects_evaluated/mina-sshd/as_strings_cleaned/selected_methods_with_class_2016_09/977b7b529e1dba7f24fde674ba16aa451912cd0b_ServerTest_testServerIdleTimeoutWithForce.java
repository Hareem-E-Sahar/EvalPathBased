...
abstract connection service SimpleName SimpleType ParameterizedType WildcardType ?
...
service SimpleName VariableDeclarationFragment MethodInvocation SimpleName server session
service SimpleName VariableDeclarationFragment MethodInvocation SimpleName get service
? WildcardType ParameterizedType VariableDeclarationStatement VariableDeclarationFragment SimpleName service
service SimpleName MethodInvocation SimpleName get channels
channels SimpleName VariableDeclarationFragment MethodInvocation SimpleName service
channels SimpleName VariableDeclarationFragment MethodInvocation SimpleName get channels
channels SimpleName MethodInvocation SimpleName iterator
channels SimpleName MethodInvocation MethodInvocation SimpleName next
iterator SimpleName MethodInvocation MethodInvocation SimpleName next
channel SimpleName VariableDeclarationFragment MethodInvocation MethodInvocation SimpleName channels
...
max wait nanos SimpleName VariableDeclarationFragment MethodInvocation SimpleName max timeout value
final Modifier VariableDeclarationStatement PrimitiveType long
...
final Modifier VariableDeclarationStatement VariableDeclarationFragment MethodInvocation SimpleName max timeout value
...
long PrimitiveType VariableDeclarationStatement VariableDeclarationFragment MethodInvocation SimpleName max timeout value
channel SimpleName MethodInvocation SimpleName get remote window
w remote SimpleName VariableDeclarationFragment MethodInvocation SimpleName channel
...
w remote SimpleName MethodInvocation SimpleName get size
w remote SimpleName MethodInvocation InfixExpression NumberLiteral empty
...
total nano time SimpleName InfixExpression SimpleName max wait nanos
...
assert true SimpleName MethodInvocation InfixExpression SimpleName max wait nanos
...
waiting for too long on remote window size to reach zero StringLiteral MethodInvocation InfixExpression SimpleName max wait nanos
...
l NumberLiteral MethodInvocation QualifiedName time unitminutes
system SimpleName MethodInvocation SimpleName current time millis
t SimpleName VariableDeclarationFragment MethodInvocation SimpleName system
t SimpleName VariableDeclarationFragment MethodInvocation SimpleName current time millis
long PrimitiveType VariableDeclarationStatement VariableDeclarationFragment SimpleName t
