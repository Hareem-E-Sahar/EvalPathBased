...
log SimpleName MethodInvocation SimpleName is debug enabled
pending packets SimpleName MethodInvocation SimpleName size
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation StringLiteral handle new keys dequeing {} pending packets
log SimpleName MethodInvocation MethodInvocation SimpleName pending packets
...
debug SimpleName MethodInvocation MethodInvocation SimpleName pending packets
debug SimpleName MethodInvocation MethodInvocation SimpleName size
handle new keys dequeing {} pending packets StringLiteral MethodInvocation MethodInvocation SimpleName pending packets
handle new keys dequeing {} pending packets StringLiteral MethodInvocation MethodInvocation SimpleName size
