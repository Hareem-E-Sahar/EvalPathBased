...
get factory manager SimpleName MethodInvocation MethodInvocation MethodInvocation QualifiedName server factory managermax concurrent sessions
get properties SimpleName MethodInvocation MethodInvocation QualifiedName server factory managermax concurrent sessions
get SimpleName MethodInvocation QualifiedName server factory managermax concurrent sessions
max session count as string SimpleName VariableDeclarationFragment MethodInvocation MethodInvocation SimpleName get properties
max session count as string SimpleName VariableDeclarationFragment MethodInvocation SimpleName get
max session count as string SimpleName VariableDeclarationFragment MethodInvocation QualifiedName server factory managermax concurrent sessions
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName max session count as string
integer SimpleName MethodInvocation SimpleName parse int
integer SimpleName MethodInvocation SimpleName max session count as string
parse int SimpleName MethodInvocation SimpleName max session count as string
max session count SimpleName VariableDeclarationFragment MethodInvocation SimpleName integer
max session count SimpleName VariableDeclarationFragment MethodInvocation SimpleName parse int
max session count SimpleName VariableDeclarationFragment MethodInvocation SimpleName max session count as string
int PrimitiveType VariableDeclarationStatement VariableDeclarationFragment SimpleName max session count
...
int PrimitiveType VariableDeclarationStatement VariableDeclarationFragment MethodInvocation SimpleName max session count as string
...
session SimpleName MethodInvocation StringLiteral too many concurrent connections
disconnect SimpleName MethodInvocation QualifiedName ssh constantsssh disconnect service not available
disconnect SimpleName MethodInvocation StringLiteral too many concurrent connections
ssh constantsssh disconnect service not available QualifiedName MethodInvocation StringLiteral too many concurrent connections
int PrimitiveType VariableDeclarationStatement Block VariableDeclarationStatement PrimitiveType int
get factory manager SimpleName MethodInvocation MethodInvocation SimpleName get properties
get factory manager SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName get
get properties SimpleName MethodInvocation MethodInvocation SimpleName get
get factory manager SimpleName MethodInvocation MethodInvocation MethodInvocation QualifiedName server factory managerwelcome banner
get properties SimpleName MethodInvocation MethodInvocation QualifiedName server factory managerwelcome banner
get SimpleName MethodInvocation QualifiedName server factory managerwelcome banner
welcome banner SimpleName VariableDeclarationFragment MethodInvocation MethodInvocation SimpleName get properties
welcome banner SimpleName VariableDeclarationFragment MethodInvocation SimpleName get
...
ssh constantsssh msg userauth banner QualifiedName MethodInvocation NumberLiteral empty
...
create buffer SimpleName MethodInvocation NumberLiteral empty
ssh constantsssh msg userauth success QualifiedName MethodInvocation NumberLiteral empty
buffer SimpleName Assignment MethodInvocation SimpleName session
buffer SimpleName Assignment MethodInvocation SimpleName create buffer
...
session SimpleName MethodInvocation SimpleName username
set authenticated SimpleName MethodInvocation SimpleName username
...
create buffer SimpleName MethodInvocation NumberLiteral empty
ssh constantsssh msg userauth failure QualifiedName MethodInvocation NumberLiteral empty
buffer SimpleName Assignment MethodInvocation SimpleName session
buffer SimpleName Assignment MethodInvocation SimpleName create buffer
