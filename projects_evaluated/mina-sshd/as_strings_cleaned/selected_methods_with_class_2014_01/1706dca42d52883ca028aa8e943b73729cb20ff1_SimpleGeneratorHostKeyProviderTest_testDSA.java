...
provider SimpleName MethodInvocation StringLiteral dsa
set algorithm SimpleName MethodInvocation StringLiteral dsa
...
assert equals SimpleName MethodInvocation QualifiedName key pair providerssh dss
...
key pair providerssh dss QualifiedName MethodInvocation MethodInvocation SimpleName provider
key pair providerssh dss QualifiedName MethodInvocation MethodInvocation SimpleName get key types
provider SimpleName MethodInvocation SimpleName load key
provider SimpleName MethodInvocation QualifiedName key pair providerssh dss
...
assert not null SimpleName MethodInvocation MethodInvocation QualifiedName key pair providerssh dss
provider SimpleName Assignment ClassInstanceCreation SimpleType SimpleName simple generator host key provider
provider SimpleName MethodInvocation SimpleName set algorithm
provider SimpleName MethodInvocation StringLiteral dsa
set algorithm SimpleName MethodInvocation StringLiteral dsa
provider SimpleName MethodInvocation SimpleName set key size
