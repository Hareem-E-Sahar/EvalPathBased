...
create buffer SimpleName MethodInvocation QualifiedName ssh constantsmessagessh msg service accept
create buffer SimpleName MethodInvocation NumberLiteral empty
ssh constantsmessagessh msg service accept QualifiedName MethodInvocation NumberLiteral empty
response SimpleName VariableDeclarationFragment MethodInvocation SimpleName create buffer
response SimpleName VariableDeclarationFragment MethodInvocation QualifiedName ssh constantsmessagessh msg service accept
...
cmd SimpleName MethodInvocation InfixExpression QualifiedName ssh constantsssh msg kex first
to byte SimpleName MethodInvocation InfixExpression QualifiedName ssh constantsssh msg kex first
cmd SimpleName MethodInvocation SimpleName to byte
cmd SimpleName MethodInvocation InfixExpression QualifiedName ssh constantsssh msg kex last
to byte SimpleName MethodInvocation InfixExpression QualifiedName ssh constantsssh msg kex last
...
received kex command StringLiteral InfixExpression MethodInvocation SimpleName to byte
received kex command StringLiteral InfixExpression StringLiteral while not in key exchange
cmd SimpleName MethodInvocation InfixExpression StringLiteral while not in key exchange
to byte SimpleName MethodInvocation InfixExpression StringLiteral while not in key exchange
