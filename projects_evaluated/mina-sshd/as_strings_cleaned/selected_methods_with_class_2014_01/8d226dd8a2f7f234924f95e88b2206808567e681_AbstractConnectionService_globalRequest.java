...
session SimpleName MethodInvocation QualifiedName ssh constantsmessagessh msg request success
session SimpleName MethodInvocation NumberLiteral empty
create buffer SimpleName MethodInvocation QualifiedName ssh constantsmessagessh msg request success
create buffer SimpleName MethodInvocation NumberLiteral empty
ssh constantsmessagessh msg request success QualifiedName MethodInvocation NumberLiteral empty
...
buffer SimpleName Assignment MethodInvocation QualifiedName ssh constantsmessagessh msg request success
...
session SimpleName MethodInvocation SimpleName create buffer
session SimpleName MethodInvocation QualifiedName ssh constantsmessagessh msg request failure
session SimpleName MethodInvocation NumberLiteral empty
create buffer SimpleName MethodInvocation QualifiedName ssh constantsmessagessh msg request failure
create buffer SimpleName MethodInvocation NumberLiteral empty
ssh constantsmessagessh msg request failure QualifiedName MethodInvocation NumberLiteral empty
buffer SimpleName Assignment MethodInvocation SimpleName session
buffer SimpleName Assignment MethodInvocation SimpleName create buffer
buffer SimpleName Assignment MethodInvocation QualifiedName ssh constantsmessagessh msg request failure
buffer SimpleName Assignment MethodInvocation NumberLiteral empty
session SimpleName MethodInvocation SimpleName write packet
session SimpleName MethodInvocation SimpleName buffer
write packet SimpleName MethodInvocation SimpleName buffer
