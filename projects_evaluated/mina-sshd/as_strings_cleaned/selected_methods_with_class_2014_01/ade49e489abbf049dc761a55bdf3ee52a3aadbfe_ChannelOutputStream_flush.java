ssh exception SimpleName SimpleType ClassInstanceCreation StringLiteral already closed
...
cmd SimpleName InfixExpression ConditionalExpression NumberLiteral empty
ssh constantsssh msg channel extended data QualifiedName InfixExpression ConditionalExpression NumberLiteral empty
cmd SimpleName InfixExpression ConditionalExpression NumberLiteral empty
ssh constantsssh msg channel extended data QualifiedName InfixExpression ConditionalExpression NumberLiteral empty
empty NumberLiteral ConditionalExpression NumberLiteral empty
buf SimpleName MethodInvocation SimpleName wpos
buf SimpleName MethodInvocation ConditionalExpression InfixExpression SimpleName cmd
buf SimpleName MethodInvocation ConditionalExpression InfixExpression QualifiedName ssh constantsssh msg channel extended data
buf SimpleName MethodInvocation ConditionalExpression NumberLiteral empty
buf SimpleName MethodInvocation ConditionalExpression NumberLiteral empty
wpos SimpleName MethodInvocation ConditionalExpression InfixExpression SimpleName cmd
wpos SimpleName MethodInvocation ConditionalExpression InfixExpression QualifiedName ssh constantsssh msg channel extended data
...
send {} on channel {} StringLiteral MethodInvocation SimpleName cmd
send {} on channel {} StringLiteral MethodInvocation MethodInvocation SimpleName channel
send {} on channel {} StringLiteral MethodInvocation MethodInvocation SimpleName get id
cmd SimpleName MethodInvocation MethodInvocation SimpleName channel
cmd SimpleName MethodInvocation MethodInvocation SimpleName get id
