...
debug SimpleName MethodInvocation SimpleName originator port
...
receiving request for direct tcpip host to connect port to connect originator ip address originator port StringLiteral MethodInvocation SimpleName port to connect
...
receiving request for direct tcpip host to connect port to connect originator ip address originator port StringLiteral MethodInvocation SimpleName originator port
