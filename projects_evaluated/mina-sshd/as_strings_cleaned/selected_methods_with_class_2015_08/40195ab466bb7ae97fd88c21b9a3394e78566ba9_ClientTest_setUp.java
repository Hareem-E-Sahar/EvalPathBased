...
client session holder SimpleName MethodInvocation SimpleName set
client SimpleName MethodInvocation SimpleName add session listener
client SimpleName MethodInvocation SimpleName client session listener
add session listener SimpleName MethodInvocation SimpleName client session listener
