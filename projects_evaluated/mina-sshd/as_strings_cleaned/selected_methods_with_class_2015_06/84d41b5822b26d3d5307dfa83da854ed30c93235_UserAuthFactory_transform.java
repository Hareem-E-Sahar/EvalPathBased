...
user auth factory SimpleName SimpleType SingleVariableDeclaration SimpleName input
...
public Modifier MethodDeclaration ParameterizedType SimpleType SimpleName user auth
public Modifier MethodDeclaration SimpleName transform
public Modifier MethodDeclaration SingleVariableDeclaration SimpleType SimpleName user auth factory
...
user auth SimpleName SimpleType ParameterizedType MethodDeclaration SimpleName transform
transform SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName user auth factory
