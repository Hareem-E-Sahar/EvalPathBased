...
log SimpleName MethodInvocation StringLiteral send ssh msg userauth request request publickey algo
log SimpleName MethodInvocation SimpleName algo
debug SimpleName MethodInvocation StringLiteral send ssh msg userauth request request publickey algo
debug SimpleName MethodInvocation SimpleName algo
send ssh msg userauth request request publickey algo StringLiteral MethodInvocation SimpleName algo
...
buffer SimpleName MethodInvocation SimpleName put string
buffer SimpleName MethodInvocation QualifiedName user auth public key factoryname
...
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation StringLiteral no more keys to send
debug SimpleName MethodInvocation StringLiteral no more keys to send
...
string SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName algo
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation StringLiteral send ssh msg userauth request reply publickey algo
log SimpleName MethodInvocation SimpleName algo
debug SimpleName MethodInvocation StringLiteral send ssh msg userauth request reply publickey algo
debug SimpleName MethodInvocation SimpleName algo
send ssh msg userauth request reply publickey algo StringLiteral MethodInvocation SimpleName algo
session SimpleName MethodInvocation SimpleName create buffer
session SimpleName MethodInvocation QualifiedName ssh constantsssh msg userauth request
create buffer SimpleName MethodInvocation QualifiedName ssh constantsssh msg userauth request
buffer SimpleName Assignment MethodInvocation SimpleName session
...
put string SimpleName MethodInvocation SimpleName service
bs SimpleName MethodInvocation SimpleName put string
bs SimpleName MethodInvocation QualifiedName user auth public key factoryname
put string SimpleName MethodInvocation QualifiedName user auth public key factoryname
byte PrimitiveType CastExpression NumberLiteral empty
bs SimpleName MethodInvocation SimpleName put byte
