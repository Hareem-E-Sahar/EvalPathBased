...
read StringLiteral InfixExpression SimpleName off
read StringLiteral InfixExpression StringLiteral empty
read StringLiteral InfixExpression SimpleName len
read StringLiteral InfixExpression StringLiteral ] stream is closed
off SimpleName InfixExpression StringLiteral empty
off SimpleName InfixExpression SimpleName len
off SimpleName InfixExpression StringLiteral ] stream is closed
empty StringLiteral InfixExpression SimpleName len
empty StringLiteral InfixExpression StringLiteral ] stream is closed
...
io exception SimpleName SimpleType ClassInstanceCreation InfixExpression SimpleName off
