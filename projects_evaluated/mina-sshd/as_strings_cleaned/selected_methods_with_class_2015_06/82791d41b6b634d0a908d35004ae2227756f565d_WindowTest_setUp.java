...
suppress warnings SimpleName SingleMemberAnnotation MethodDeclaration SingleVariableDeclaration PrimitiveType byte
suppress warnings SimpleName SingleMemberAnnotation MethodDeclaration SingleVariableDeclaration SimpleName cmd
syntheticaccess StringLiteral SingleMemberAnnotation MethodDeclaration SingleVariableDeclaration PrimitiveType byte
syntheticaccess StringLiteral SingleMemberAnnotation MethodDeclaration SingleVariableDeclaration SimpleName cmd
override SimpleName MarkerAnnotation MethodDeclaration Modifier public
...
arrays SimpleName MethodInvocation ClassInstanceCreation SimpleType SimpleName server user auth service factory
arrays SimpleName MethodInvocation QualifiedName server connection service factoryinstance
as list SimpleName MethodInvocation ClassInstanceCreation SimpleType SimpleName server user auth service factory
as list SimpleName MethodInvocation QualifiedName server connection service factoryinstance
server user auth service factory SimpleName SimpleType ClassInstanceCreation MethodInvocation QualifiedName server connection service factoryinstance
...
sshd SimpleName MethodInvocation MethodInvocation QualifiedName server connection service factoryinstance
...
set service factories SimpleName MethodInvocation MethodInvocation QualifiedName server connection service factoryinstance
...
arrays SimpleName MethodInvocation SimpleName as list
arrays SimpleName MethodInvocation ClassInstanceCreation SimpleType SimpleName channel session factory
arrays SimpleName MethodInvocation QualifiedName direct tcpip factoryinstance
...
named factory SimpleName SimpleType ParameterizedType MethodInvocation QualifiedName direct tcpip factoryinstance
channel SimpleName SimpleType ParameterizedType MethodInvocation QualifiedName direct tcpip factoryinstance
as list SimpleName MethodInvocation ClassInstanceCreation SimpleType SimpleName channel session factory
as list SimpleName MethodInvocation QualifiedName direct tcpip factoryinstance
channel session factory SimpleName SimpleType ClassInstanceCreation MethodInvocation QualifiedName direct tcpip factoryinstance
sshd SimpleName MethodInvocation SimpleName set channel factories
sshd SimpleName MethodInvocation MethodInvocation SimpleName arrays
sshd SimpleName MethodInvocation MethodInvocation SimpleName as list
sshd SimpleName MethodInvocation MethodInvocation QualifiedName direct tcpip factoryinstance
...
set channel factories SimpleName MethodInvocation MethodInvocation QualifiedName direct tcpip factoryinstance
