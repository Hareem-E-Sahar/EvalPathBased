...
arrays SimpleName MethodInvocation SimpleName as list
arrays SimpleName MethodInvocation ClassInstanceCreation SimpleType QualifiedName channel sessionchannel session factory
...
named factory SimpleName SimpleType ParameterizedType MethodInvocation QualifiedName tcpip server channeldirect tcpip factoryinstance
channel SimpleName SimpleType ParameterizedType MethodInvocation QualifiedName tcpip server channeldirect tcpip factoryinstance
as list SimpleName MethodInvocation ClassInstanceCreation SimpleType QualifiedName channel sessionchannel session factory
as list SimpleName MethodInvocation QualifiedName tcpip server channeldirect tcpip factoryinstance
channel sessionchannel session factory QualifiedName SimpleType ClassInstanceCreation MethodInvocation QualifiedName tcpip server channeldirect tcpip factoryinstance
sshd SimpleName MethodInvocation SimpleName set channel factories
sshd SimpleName MethodInvocation MethodInvocation SimpleName arrays
sshd SimpleName MethodInvocation MethodInvocation SimpleName as list
sshd SimpleName MethodInvocation MethodInvocation QualifiedName tcpip server channeldirect tcpip factoryinstance
...
set channel factories SimpleName MethodInvocation MethodInvocation QualifiedName tcpip server channeldirect tcpip factoryinstance
