...
auth socket SimpleName InfixExpression StringLiteral : interrupted while polling for messages
interrupted io exception SimpleName SimpleType ClassInstanceCreation InfixExpression SimpleName auth socket
interrupted io exception SimpleName SimpleType ClassInstanceCreation InfixExpression StringLiteral : interrupted while polling for messages
interrupted io exception SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName init cause
auth socket SimpleName InfixExpression ClassInstanceCreation MethodInvocation SimpleName init cause
: interrupted while polling for messages StringLiteral InfixExpression ClassInstanceCreation MethodInvocation SimpleName init cause
interrupted io exception SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName e
auth socket SimpleName InfixExpression ClassInstanceCreation MethodInvocation SimpleName e
: interrupted while polling for messages StringLiteral InfixExpression ClassInstanceCreation MethodInvocation SimpleName e
