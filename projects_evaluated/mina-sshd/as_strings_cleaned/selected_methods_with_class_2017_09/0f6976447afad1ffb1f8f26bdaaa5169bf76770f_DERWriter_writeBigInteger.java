...
bytes SimpleName ArrayAccess InfixExpression SimpleName off
bytes SimpleName ArrayAccess InfixExpression NumberLiteral empty
is positive SimpleName MethodInvocation ArrayAccess SimpleName bytes
is positive SimpleName MethodInvocation ArrayAccess InfixExpression SimpleName off
is positive SimpleName MethodInvocation ArrayAccess InfixExpression NumberLiteral empty
write SimpleName MethodInvocation NumberLiteral x
bytes SimpleName ArrayAccess SimpleName off
is positive SimpleName MethodInvocation ArrayAccess SimpleName bytes
is positive SimpleName MethodInvocation ArrayAccess SimpleName off
