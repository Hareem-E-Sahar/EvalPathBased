...
buffermax len QualifiedName InfixExpression NumberLiteral empty
upload and verify file SimpleName MethodInvocation SimpleName sftp
upload and verify file SimpleName MethodInvocation InfixExpression QualifiedName buffermax len
...
sftp SimpleName MethodInvocation InfixExpression QualifiedName buffermax len
...
buffermax len QualifiedName InfixExpression MethodInvocation StringLiteral buffer max len minus one filetxt
empty NumberLiteral InfixExpression MethodInvocation StringLiteral buffer max len minus one filetxt
upload and verify file SimpleName MethodInvocation SimpleName sftp
upload and verify file SimpleName MethodInvocation QualifiedName buffermax len
upload and verify file SimpleName MethodInvocation StringLiteral buffer max len filetxt
sftp SimpleName MethodInvocation QualifiedName buffermax len
sftp SimpleName MethodInvocation StringLiteral buffer max len filetxt
buffermax len QualifiedName MethodInvocation StringLiteral buffer max len filetxt
buffermax len QualifiedName InfixExpression NumberLiteral empty
upload and verify file SimpleName MethodInvocation SimpleName sftp
upload and verify file SimpleName MethodInvocation InfixExpression QualifiedName buffermax len
upload and verify file SimpleName MethodInvocation InfixExpression NumberLiteral empty
...
buffermax len QualifiedName InfixExpression MethodInvocation StringLiteral buffer max len plus one filetxt
empty NumberLiteral InfixExpression MethodInvocation StringLiteral buffer max len plus one filetxt
. NumberLiteral InfixExpression QualifiedName buffermax len
int PrimitiveType CastExpression ParenthesizedExpression InfixExpression NumberLiteral .
int PrimitiveType CastExpression ParenthesizedExpression InfixExpression QualifiedName buffermax len
upload and verify file SimpleName MethodInvocation SimpleName sftp
...
empty NumberLiteral InfixExpression QualifiedName buffermax len
empty NumberLiteral InfixExpression ParenthesizedExpression InfixExpression NumberLiteral empty
buffermax len QualifiedName InfixExpression ParenthesizedExpression InfixExpression NumberLiteral empty
upload and verify file SimpleName MethodInvocation SimpleName sftp
upload and verify file SimpleName MethodInvocation InfixExpression NumberLiteral empty
...
buffermax len QualifiedName InfixExpression MethodInvocation StringLiteral times buffer max len filetxt
empty NumberLiteral InfixExpression QualifiedName buffermax len
empty NumberLiteral InfixExpression ParenthesizedExpression InfixExpression NumberLiteral empty
buffermax len QualifiedName InfixExpression ParenthesizedExpression InfixExpression NumberLiteral empty
upload and verify file SimpleName MethodInvocation SimpleName sftp
