...
received ssh fxp init version StringLiteral MethodInvocation SimpleName version
...
file SimpleName MethodInvocation SimpleName is readable
...
ssh fxf creat SimpleName InfixExpression ParenthesizedExpression InfixExpression NumberLiteral empty
file SimpleName MethodInvocation SimpleName is writable
can not create StringLiteral InfixExpression SimpleName path
send status SimpleName MethodInvocation SimpleName id
send status SimpleName MethodInvocation SimpleName ssh fx permission denied
send status SimpleName MethodInvocation InfixExpression StringLiteral can not create
send status SimpleName MethodInvocation InfixExpression SimpleName path
id SimpleName MethodInvocation SimpleName ssh fx permission denied
id SimpleName MethodInvocation InfixExpression StringLiteral can not create
id SimpleName MethodInvocation InfixExpression SimpleName path
ssh fx permission denied SimpleName MethodInvocation InfixExpression StringLiteral can not create
ssh fx permission denied SimpleName MethodInvocation InfixExpression SimpleName path
file SimpleName MethodInvocation SimpleName create
...
ssh fx no such file SimpleName MethodInvocation InfixExpression StringLiteral no such file
ssh fx no such file SimpleName MethodInvocation InfixExpression SimpleName path
pflags SimpleName InfixExpression SimpleName ssh fxf trunc
pflags SimpleName InfixExpression ParenthesizedExpression InfixExpression NumberLiteral empty
ssh fxf trunc SimpleName InfixExpression ParenthesizedExpression InfixExpression NumberLiteral empty
file SimpleName MethodInvocation SimpleName is writable
can not truncate StringLiteral InfixExpression SimpleName path
send status SimpleName MethodInvocation SimpleName id
send status SimpleName MethodInvocation SimpleName ssh fx permission denied
send status SimpleName MethodInvocation InfixExpression StringLiteral can not truncate
send status SimpleName MethodInvocation InfixExpression SimpleName path
id SimpleName MethodInvocation SimpleName ssh fx permission denied
id SimpleName MethodInvocation InfixExpression StringLiteral can not truncate
id SimpleName MethodInvocation InfixExpression SimpleName path
ssh fx permission denied SimpleName MethodInvocation InfixExpression StringLiteral can not truncate
ssh fx permission denied SimpleName MethodInvocation InfixExpression SimpleName path
...
fh SimpleName MethodInvocation SimpleName get file
ssh file SimpleName VariableDeclarationFragment MethodInvocation SimpleName fh
ssh file SimpleName VariableDeclarationFragment MethodInvocation SimpleName get file
