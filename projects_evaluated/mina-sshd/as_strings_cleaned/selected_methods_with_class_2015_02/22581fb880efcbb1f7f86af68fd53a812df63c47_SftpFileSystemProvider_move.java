...
no follow links SimpleName ConditionalExpression ArrayCreation ArrayInitializer QualifiedName link optionnofollow links
no follow links SimpleName ConditionalExpression ArrayCreation NumberLiteral empty
link options SimpleName VariableDeclarationFragment ConditionalExpression SimpleName no follow links
link options SimpleName VariableDeclarationFragment ConditionalExpression ArrayCreation NumberLiteral empty
...
exists SimpleName MethodInvocation SimpleName target
...
replace existing SimpleName IfStatement IfStatement MethodInvocation SimpleName files
replace existing SimpleName IfStatement IfStatement MethodInvocation SimpleName exists
replace existing SimpleName IfStatement IfStatement MethodInvocation SimpleName target
src SimpleName MethodInvocation SimpleName get file system
...
boolean PrimitiveType VariableDeclarationStatement Block EnhancedForStatement SimpleName options
boolean PrimitiveType VariableDeclarationStatement Block EnhancedForStatement SimpleName options
boolean PrimitiveType VariableDeclarationStatement Block IfStatement SimpleName replace existing
options SimpleName EnhancedForStatement Block IfStatement SimpleName replace existing
