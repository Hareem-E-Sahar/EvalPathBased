...
log SimpleName MethodInvocation StringLiteral wait for call returning on session {} mask cond
log SimpleName MethodInvocation SimpleName mask
log SimpleName MethodInvocation SimpleName cond
trace SimpleName MethodInvocation StringLiteral wait for call returning on session {} mask cond
trace SimpleName MethodInvocation SimpleName mask
trace SimpleName MethodInvocation SimpleName cond
wait for call returning on session {} mask cond StringLiteral MethodInvocation SimpleName mask
wait for call returning on session {} mask cond StringLiteral MethodInvocation SimpleName cond
...
log SimpleName MethodInvocation SimpleName is trace enabled
log SimpleName MethodInvocation SimpleName trace
log SimpleName MethodInvocation StringLiteral wait for call timeout on session {} mask
log SimpleName MethodInvocation SimpleName mask
trace SimpleName MethodInvocation StringLiteral wait for call timeout on session {} mask
trace SimpleName MethodInvocation SimpleName mask
wait for call timeout on session {} mask StringLiteral MethodInvocation SimpleName mask
cond SimpleName MethodInvocation SimpleName add
