...
validate utils SimpleName MethodInvocation MethodInvocation SimpleName system
validate utils SimpleName MethodInvocation MethodInvocation SimpleName get property
validate utils SimpleName MethodInvocation MethodInvocation StringLiteral username
validate utils SimpleName MethodInvocation StringLiteral no local user name value
check not null and not empty SimpleName MethodInvocation MethodInvocation SimpleName system
check not null and not empty SimpleName MethodInvocation MethodInvocation SimpleName get property
check not null and not empty SimpleName MethodInvocation MethodInvocation StringLiteral username
check not null and not empty SimpleName MethodInvocation StringLiteral no local user name value
system SimpleName MethodInvocation MethodInvocation StringLiteral no local user name value
get property SimpleName MethodInvocation MethodInvocation StringLiteral no local user name value
username StringLiteral MethodInvocation MethodInvocation StringLiteral no local user name value
sb SimpleName MethodInvocation SimpleName append
...
sb SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName system
sb SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName get property
sb SimpleName MethodInvocation MethodInvocation MethodInvocation StringLiteral username
...
append SimpleName MethodInvocation MethodInvocation MethodInvocation StringLiteral username
