...
user interactionutils QualifiedName MethodInvocation SimpleName resolve user interaction
user interactionutils QualifiedName MethodInvocation SimpleName session
resolve user interaction SimpleName MethodInvocation SimpleName session
ui SimpleName VariableDeclarationFragment MethodInvocation QualifiedName user interactionutils
ui SimpleName VariableDeclarationFragment MethodInvocation SimpleName resolve user interaction
