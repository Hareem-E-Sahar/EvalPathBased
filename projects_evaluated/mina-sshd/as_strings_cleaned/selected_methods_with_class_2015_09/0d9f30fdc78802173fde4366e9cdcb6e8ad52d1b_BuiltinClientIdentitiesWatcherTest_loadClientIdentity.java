...
id SimpleName VariableDeclarationFragment MethodInvocation SimpleName find identity
id SimpleName VariableDeclarationFragment MethodInvocation SimpleName location
...
assert not null SimpleName MethodInvocation InfixExpression StringLiteral invalid location
assert not null SimpleName MethodInvocation InfixExpression SimpleName location
assert not null SimpleName MethodInvocation SimpleName id
invalid location StringLiteral InfixExpression MethodInvocation SimpleName id
location SimpleName InfixExpression MethodInvocation SimpleName id
ids map SimpleName MethodInvocation SimpleName get
ids map SimpleName MethodInvocation SimpleName id
