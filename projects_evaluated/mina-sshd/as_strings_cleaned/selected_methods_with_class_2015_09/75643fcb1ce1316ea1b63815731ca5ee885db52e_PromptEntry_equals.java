...
prompt entry SimpleName SimpleType CastExpression SimpleName obj
other SimpleName VariableDeclarationFragment CastExpression SimpleType SimpleName prompt entry
other SimpleName VariableDeclarationFragment CastExpression SimpleName obj
prompt entry SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName other
other SimpleName MethodInvocation SimpleName get prompt
objects SimpleName MethodInvocation SimpleName equals
objects SimpleName MethodInvocation MethodInvocation SimpleName get prompt
objects SimpleName MethodInvocation MethodInvocation SimpleName other
objects SimpleName MethodInvocation MethodInvocation SimpleName get prompt
equals SimpleName MethodInvocation MethodInvocation SimpleName get prompt
equals SimpleName MethodInvocation MethodInvocation SimpleName other
equals SimpleName MethodInvocation MethodInvocation SimpleName get prompt
get prompt SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName other
get prompt SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName get prompt
other SimpleName MethodInvocation SimpleName is echo
is echo SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName other
is echo SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName is echo
