...
test localhost SimpleName ClassInstanceCreation NumberLiteral empty
...
session SimpleName MethodInvocation ClassInstanceCreation SimpleName test localhost
...
start dynamic port forwarding SimpleName MethodInvocation ClassInstanceCreation SimpleName test localhost
...
dynamic SimpleName VariableDeclarationFragment MethodInvocation ClassInstanceCreation SimpleName test localhost
...
test localhost SimpleName ClassInstanceCreation MethodInvocation SimpleName dynamic
test localhost SimpleName ClassInstanceCreation MethodInvocation SimpleName get port
proxy SimpleName SimpleType ClassInstanceCreation QualifiedName proxytypesocks
proxy SimpleName SimpleType ClassInstanceCreation ClassInstanceCreation SimpleName test localhost
proxytypesocks QualifiedName ClassInstanceCreation ClassInstanceCreation SimpleType SimpleName inet socket address
proxytypesocks QualifiedName ClassInstanceCreation ClassInstanceCreation SimpleName test localhost
