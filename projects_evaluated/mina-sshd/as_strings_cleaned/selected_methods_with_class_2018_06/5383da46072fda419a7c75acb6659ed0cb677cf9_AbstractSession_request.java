...
trace enabled SimpleName IfStatement Block VariableDeclarationStatement PrimitiveType long
trace enabled SimpleName IfStatement Block VariableDeclarationStatement PrimitiveType long
trace enabled SimpleName IfStatement Block VariableDeclarationStatement PrimitiveType long
trace enabled SimpleName IfStatement Block VariableDeclarationStatement PrimitiveType long
...
boolean PrimitiveType VariableDeclarationStatement Block SynchronizedStatement SimpleName request lock
debug enabled SimpleName IfStatement Block VariableDeclarationStatement PrimitiveType boolean
debug enabled SimpleName IfStatement Block SynchronizedStatement SimpleName request lock
debug enabled SimpleName IfStatement Block IfStatement SimpleName debug enabled
boolean PrimitiveType VariableDeclarationStatement Block SynchronizedStatement SimpleName request lock
boolean PrimitiveType VariableDeclarationStatement Block IfStatement SimpleName debug enabled
request lock SimpleName SynchronizedStatement Block IfStatement SimpleName debug enabled
