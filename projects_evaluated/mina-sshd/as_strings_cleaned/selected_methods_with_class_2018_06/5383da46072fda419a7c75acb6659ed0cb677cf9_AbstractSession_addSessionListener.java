...
log SimpleName MethodInvocation StringLiteral add session listener ignore registration while session is closing
log SimpleName MethodInvocation SimpleName listener
warn SimpleName MethodInvocation StringLiteral add session listener ignore registration while session is closing
warn SimpleName MethodInvocation SimpleName listener
add session listener ignore registration while session is closing StringLiteral MethodInvocation SimpleName listener
