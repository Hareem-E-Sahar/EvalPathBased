...
seed SimpleName Assignment MethodInvocation SimpleName send kex init
seed SimpleName Assignment MethodInvocation SimpleName proposal
...
to hex SimpleName MethodInvocation SimpleName seed
: CharacterLiteral MethodInvocation SimpleName seed
log SimpleName MethodInvocation SimpleName trace
log SimpleName MethodInvocation StringLiteral send kex init proposal seed {}
log SimpleName MethodInvocation SimpleName proposal
...
log SimpleName MethodInvocation MethodInvocation SimpleName seed
trace SimpleName MethodInvocation StringLiteral send kex init proposal seed {}
trace SimpleName MethodInvocation SimpleName proposal
...
trace SimpleName MethodInvocation MethodInvocation SimpleName seed
send kex init proposal seed {} StringLiteral MethodInvocation SimpleName proposal
send kex init proposal seed {} StringLiteral MethodInvocation MethodInvocation SimpleName buffer utils
send kex init proposal seed {} StringLiteral MethodInvocation MethodInvocation SimpleName to hex
send kex init proposal seed {} StringLiteral MethodInvocation MethodInvocation CharacterLiteral :
send kex init proposal seed {} StringLiteral MethodInvocation MethodInvocation SimpleName seed
proposal SimpleName MethodInvocation MethodInvocation SimpleName buffer utils
proposal SimpleName MethodInvocation MethodInvocation SimpleName to hex
proposal SimpleName MethodInvocation MethodInvocation CharacterLiteral :
proposal SimpleName MethodInvocation MethodInvocation SimpleName seed
kex state SimpleName SynchronizedStatement Block ReturnStatement SimpleName seed
...
send kex init SimpleName MethodDeclaration Block SynchronizedStatement SimpleName kex state
