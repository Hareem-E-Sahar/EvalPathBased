...
log SimpleName MethodInvocation StringLiteral do copy dataid ssh fxp extended read readoffset readlength write writeoffset
...
log SimpleName MethodInvocation QualifiedName sftp constantsext copy data
debug SimpleName MethodInvocation StringLiteral do copy dataid ssh fxp extended read readoffset readlength write writeoffset
...
debug SimpleName MethodInvocation QualifiedName sftp constantsext copy data
debug SimpleName MethodInvocation SimpleName read handle
do copy dataid ssh fxp extended read readoffset readlength write writeoffset StringLiteral MethodInvocation MethodInvocation SimpleName get server session
do copy dataid ssh fxp extended read readoffset readlength write writeoffset StringLiteral MethodInvocation SimpleName id
do copy dataid ssh fxp extended read readoffset readlength write writeoffset StringLiteral MethodInvocation QualifiedName sftp constantsext copy data
do copy dataid ssh fxp extended read readoffset readlength write writeoffset StringLiteral MethodInvocation SimpleName read handle
do copy dataid ssh fxp extended read readoffset readlength write writeoffset StringLiteral MethodInvocation SimpleName rh
get server session SimpleName MethodInvocation MethodInvocation SimpleName id
get server session SimpleName MethodInvocation MethodInvocation QualifiedName sftp constantsext copy data
get server session SimpleName MethodInvocation MethodInvocation SimpleName read handle
get server session SimpleName MethodInvocation MethodInvocation SimpleName rh
get server session SimpleName MethodInvocation MethodInvocation SimpleName read offset
id SimpleName MethodInvocation QualifiedName sftp constantsext copy data
id SimpleName MethodInvocation SimpleName read handle
id SimpleName MethodInvocation SimpleName rh
id SimpleName MethodInvocation SimpleName read offset
id SimpleName MethodInvocation SimpleName read length
sftp constantsext copy data QualifiedName MethodInvocation SimpleName read handle
sftp constantsext copy data QualifiedName MethodInvocation SimpleName rh
sftp constantsext copy data QualifiedName MethodInvocation SimpleName read offset
sftp constantsext copy data QualifiedName MethodInvocation SimpleName read length
sftp constantsext copy data QualifiedName MethodInvocation SimpleName write handle
...
src access SimpleName InfixExpression QualifiedName sftp constantsace read data
src access SimpleName InfixExpression ParenthesizedExpression InfixExpression QualifiedName sftp constantsace read data
sftp constantsace read data QualifiedName InfixExpression ParenthesizedExpression InfixExpression QualifiedName sftp constantsace read data
src path SimpleName MethodInvocation SimpleName to string
src path SimpleName MethodInvocation SimpleName to string
access denied exception SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName src path
access denied exception SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName to string
access denied exception SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName src path
access denied exception SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName to string
access denied exception SimpleName SimpleType ClassInstanceCreation StringLiteral source file not opened for read
src path SimpleName MethodInvocation ClassInstanceCreation MethodInvocation SimpleName src path
src path SimpleName MethodInvocation ClassInstanceCreation MethodInvocation SimpleName to string
to string SimpleName MethodInvocation ClassInstanceCreation MethodInvocation SimpleName src path
to string SimpleName MethodInvocation ClassInstanceCreation MethodInvocation SimpleName to string
src path SimpleName MethodInvocation ClassInstanceCreation StringLiteral source file not opened for read
to string SimpleName MethodInvocation ClassInstanceCreation StringLiteral source file not opened for read
src path SimpleName MethodInvocation ClassInstanceCreation StringLiteral source file not opened for read
to string SimpleName MethodInvocation ClassInstanceCreation StringLiteral source file not opened for read
...
int PrimitiveType VariableDeclarationStatement VariableDeclarationFragment MethodInvocation SimpleName get access mask
dst access SimpleName InfixExpression QualifiedName sftp constantsace write data
dst access SimpleName InfixExpression ParenthesizedExpression InfixExpression QualifiedName sftp constantsace write data
sftp constantsace write data QualifiedName InfixExpression ParenthesizedExpression InfixExpression QualifiedName sftp constantsace write data
src handle SimpleName MethodInvocation SimpleName to string
src handle SimpleName MethodInvocation SimpleName to string
access denied exception SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName src handle
access denied exception SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName to string
access denied exception SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName src handle
access denied exception SimpleName SimpleType ClassInstanceCreation MethodInvocation SimpleName to string
access denied exception SimpleName SimpleType ClassInstanceCreation StringLiteral source handle not opened for write
src handle SimpleName MethodInvocation ClassInstanceCreation MethodInvocation SimpleName src handle
src handle SimpleName MethodInvocation ClassInstanceCreation MethodInvocation SimpleName to string
to string SimpleName MethodInvocation ClassInstanceCreation MethodInvocation SimpleName src handle
to string SimpleName MethodInvocation ClassInstanceCreation MethodInvocation SimpleName to string
src handle SimpleName MethodInvocation ClassInstanceCreation StringLiteral source handle not opened for write
to string SimpleName MethodInvocation ClassInstanceCreation StringLiteral source handle not opened for write
src handle SimpleName MethodInvocation ClassInstanceCreation StringLiteral source handle not opened for write
to string SimpleName MethodInvocation ClassInstanceCreation StringLiteral source handle not opened for write
...
override SimpleName MarkerAnnotation MethodDeclaration SingleMemberAnnotation StringLiteral resource
override SimpleName MarkerAnnotation MethodDeclaration Modifier protected
override SimpleName MarkerAnnotation MethodDeclaration PrimitiveType void
override SimpleName MarkerAnnotation MethodDeclaration SimpleName do copy data
