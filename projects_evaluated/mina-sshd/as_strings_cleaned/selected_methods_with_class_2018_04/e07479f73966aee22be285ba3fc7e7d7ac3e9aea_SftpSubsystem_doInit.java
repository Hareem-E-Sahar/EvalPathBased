...
log SimpleName MethodInvocation StringLiteral do initid ssh fxp init version
...
log SimpleName MethodInvocation SimpleName id
debug SimpleName MethodInvocation StringLiteral do initid ssh fxp init version
...
debug SimpleName MethodInvocation SimpleName id
do initid ssh fxp init version StringLiteral MethodInvocation MethodInvocation SimpleName get server session
do initid ssh fxp init version StringLiteral MethodInvocation SimpleName id
do initid ssh fxp init version StringLiteral MethodInvocation SimpleName id
...
buffer SimpleName Assignment MethodInvocation SimpleName prepare reply
...
listener SimpleName MethodInvocation SimpleName initialized
listener SimpleName MethodInvocation MethodInvocation SimpleName get server session
listener SimpleName MethodInvocation SimpleName version
initialized SimpleName MethodInvocation MethodInvocation SimpleName get server session
initialized SimpleName MethodInvocation SimpleName version
get server session SimpleName MethodInvocation MethodInvocation SimpleName version
