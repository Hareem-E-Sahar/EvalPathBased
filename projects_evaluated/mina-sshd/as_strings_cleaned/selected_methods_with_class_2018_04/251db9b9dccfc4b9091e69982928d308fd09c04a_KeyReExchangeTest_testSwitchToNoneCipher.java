...
verify SimpleName MethodInvocation QualifiedName time unitseconds
l NumberLiteral MethodInvocation QualifiedName time unitseconds
output debug message SimpleName MethodInvocation StringLiteral request switch to none cipher for s
output debug message SimpleName MethodInvocation SimpleName session
request switch to none cipher for s StringLiteral MethodInvocation SimpleName session
...
session SimpleName MethodInvocation QualifiedName test subsystem factoryname
create subsystem channel SimpleName MethodInvocation QualifiedName test subsystem factoryname
...
channel SimpleName VariableDeclarationFragment MethodInvocation QualifiedName test subsystem factoryname
