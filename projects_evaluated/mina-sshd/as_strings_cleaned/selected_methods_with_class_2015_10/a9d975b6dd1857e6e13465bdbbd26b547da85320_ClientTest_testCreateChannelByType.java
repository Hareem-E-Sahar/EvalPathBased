...
session SimpleName MethodInvocation QualifiedName client channelchannel subsystem
session SimpleName MethodInvocation QualifiedName sftp constantssftp subsystem name
create channel SimpleName MethodInvocation QualifiedName client channelchannel subsystem
create channel SimpleName MethodInvocation QualifiedName sftp constantssftp subsystem name
client channelchannel subsystem QualifiedName MethodInvocation QualifiedName sftp constantssftp subsystem name
...
channels SimpleName MethodInvocation MethodInvocation QualifiedName client channelchannel subsystem
...
add SimpleName MethodInvocation MethodInvocation QualifiedName client channelchannel subsystem
...
client channelchannel exec QualifiedName MethodInvocation MethodInvocation SimpleName get current test name
channels SimpleName MethodInvocation SimpleName add
channels SimpleName MethodInvocation MethodInvocation SimpleName session
channels SimpleName MethodInvocation MethodInvocation SimpleName create channel
channels SimpleName MethodInvocation MethodInvocation QualifiedName client channelchannel exec
channels SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName get current test name
add SimpleName MethodInvocation MethodInvocation SimpleName session
add SimpleName MethodInvocation MethodInvocation SimpleName create channel
add SimpleName MethodInvocation MethodInvocation QualifiedName client channelchannel exec
...
client channelchannel shell QualifiedName MethodInvocation MethodInvocation MethodInvocation SimpleName get class
client channelchannel shell QualifiedName MethodInvocation MethodInvocation SimpleName get simple name
channels SimpleName MethodInvocation SimpleName add
channels SimpleName MethodInvocation MethodInvocation SimpleName session
channels SimpleName MethodInvocation MethodInvocation SimpleName create channel
channels SimpleName MethodInvocation MethodInvocation QualifiedName client channelchannel shell
channels SimpleName MethodInvocation MethodInvocation MethodInvocation SimpleName get simple name
add SimpleName MethodInvocation MethodInvocation SimpleName session
add SimpleName MethodInvocation MethodInvocation SimpleName create channel
add SimpleName MethodInvocation MethodInvocation QualifiedName client channelchannel shell
...
abstract channel SimpleName SimpleType CastExpression SimpleName c
c SimpleName CastExpression ParenthesizedExpression MethodInvocation SimpleName get id
