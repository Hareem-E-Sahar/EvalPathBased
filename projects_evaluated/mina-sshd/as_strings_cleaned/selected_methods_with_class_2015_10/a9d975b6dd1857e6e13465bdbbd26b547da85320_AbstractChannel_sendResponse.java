...
log SimpleName MethodInvocation StringLiteral send response result wantreply
...
debug SimpleName MethodInvocation StringLiteral send response result wantreply
...
send response result wantreply StringLiteral MethodInvocation SimpleName req
send response result wantreply StringLiteral MethodInvocation SimpleName result
send response result wantreply StringLiteral MethodInvocation MethodInvocation SimpleName boolean
send response result wantreply StringLiteral MethodInvocation MethodInvocation SimpleName value of
send response result wantreply StringLiteral MethodInvocation MethodInvocation SimpleName want reply
...
result SimpleName MethodInvocation MethodInvocation SimpleName boolean
result SimpleName MethodInvocation MethodInvocation SimpleName value of
result SimpleName MethodInvocation MethodInvocation SimpleName want reply
...
buffer SimpleName MethodInvocation InfixExpression NumberLiteral empty
buffer SimpleName MethodInvocation SimpleName response buffer growth factor
ensure capacity SimpleName MethodInvocation InfixExpression NumberLiteral empty
ensure capacity SimpleName MethodInvocation InfixExpression NumberLiteral empty
ensure capacity SimpleName MethodInvocation SimpleName response buffer growth factor
empty NumberLiteral InfixExpression MethodInvocation SimpleName response buffer growth factor
empty NumberLiteral InfixExpression MethodInvocation SimpleName response buffer growth factor
