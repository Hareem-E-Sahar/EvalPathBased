...
log SimpleName MethodInvocation StringLiteral received ssh msg kex dh gex request old on {}
log SimpleName MethodInvocation SimpleName session
debug SimpleName MethodInvocation StringLiteral received ssh msg kex dh gex request old on {}
debug SimpleName MethodInvocation SimpleName session
received ssh msg kex dh gex request old on {} StringLiteral MethodInvocation SimpleName session
...
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation StringLiteral send ssh msg kex dh gex group on {}
log SimpleName MethodInvocation SimpleName session
debug SimpleName MethodInvocation StringLiteral send ssh msg kex dh gex group on {}
debug SimpleName MethodInvocation SimpleName session
send ssh msg kex dh gex group on {} StringLiteral MethodInvocation SimpleName session
...
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation StringLiteral received ssh msg kex dh gex request on {}
log SimpleName MethodInvocation SimpleName session
debug SimpleName MethodInvocation StringLiteral received ssh msg kex dh gex request on {}
debug SimpleName MethodInvocation SimpleName session
received ssh msg kex dh gex request on {} StringLiteral MethodInvocation SimpleName session
buffer SimpleName MethodInvocation SimpleName get int
...
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation StringLiteral received ssh msg kex dh gex init on {}
log SimpleName MethodInvocation SimpleName session
debug SimpleName MethodInvocation StringLiteral received ssh msg kex dh gex init on {}
debug SimpleName MethodInvocation SimpleName session
received ssh msg kex dh gex init on {} StringLiteral MethodInvocation SimpleName session
