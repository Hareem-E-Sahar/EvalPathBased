...
file SimpleName VariableDeclarationFragment MethodInvocation StringLiteral file txt
...
fail SimpleName MethodInvocation InfixExpression SimpleName file path
orgapachesshdcommonsubsystemsftpsftp exception QualifiedName SimpleType SingleVariableDeclaration SimpleName e
...
assert equals SimpleName MethodInvocation InfixExpression SimpleName file path
assert equals SimpleName MethodInvocation QualifiedName sftp constantsssh fx no such file
...
mismatched status for failed rename of StringLiteral InfixExpression MethodInvocation QualifiedName sftp constantsssh fx no such file
file path SimpleName InfixExpression MethodInvocation QualifiedName sftp constantsssh fx no such file
=> StringLiteral InfixExpression MethodInvocation QualifiedName sftp constantsssh fx no such file
file path SimpleName InfixExpression MethodInvocation QualifiedName sftp constantsssh fx no such file
...
file path SimpleName InfixExpression MethodInvocation MethodInvocation SimpleName e
file path SimpleName InfixExpression MethodInvocation MethodInvocation SimpleName get status
sftp constantsssh fx no such file QualifiedName MethodInvocation MethodInvocation SimpleName e
sftp constantsssh fx no such file QualifiedName MethodInvocation MethodInvocation SimpleName get status
sftp SimpleName MethodInvocation SimpleName write
sftp SimpleName MethodInvocation SimpleName file path
sftp SimpleName MethodInvocation QualifiedName sftp clientmin write buffer size
write SimpleName MethodInvocation SimpleName file path
...
assert equals SimpleName MethodInvocation InfixExpression StringLiteral =>
assert equals SimpleName MethodInvocation InfixExpression SimpleName file path
assert equals SimpleName MethodInvocation QualifiedName sftp constantsssh fx file already exists
assert equals SimpleName MethodInvocation MethodInvocation SimpleName e
assert equals SimpleName MethodInvocation MethodInvocation SimpleName get status
mismatched status for failed rename of StringLiteral InfixExpression MethodInvocation QualifiedName sftp constantsssh fx file already exists
file path SimpleName InfixExpression MethodInvocation QualifiedName sftp constantsssh fx file already exists
=> StringLiteral InfixExpression MethodInvocation QualifiedName sftp constantsssh fx file already exists
file path SimpleName InfixExpression MethodInvocation QualifiedName sftp constantsssh fx file already exists
mismatched status for failed rename of StringLiteral InfixExpression MethodInvocation MethodInvocation SimpleName e
mismatched status for failed rename of StringLiteral InfixExpression MethodInvocation MethodInvocation SimpleName get status
file path SimpleName InfixExpression MethodInvocation MethodInvocation SimpleName e
...
file path SimpleName InfixExpression MethodInvocation MethodInvocation SimpleName e
file path SimpleName InfixExpression MethodInvocation MethodInvocation SimpleName get status
sftp constantsssh fx file already exists QualifiedName MethodInvocation MethodInvocation SimpleName e
sftp constantsssh fx file already exists QualifiedName MethodInvocation MethodInvocation SimpleName get status
sftp SimpleName MethodInvocation SimpleName rename
sftp SimpleName MethodInvocation SimpleName file path
sftp SimpleName MethodInvocation SimpleName file path
