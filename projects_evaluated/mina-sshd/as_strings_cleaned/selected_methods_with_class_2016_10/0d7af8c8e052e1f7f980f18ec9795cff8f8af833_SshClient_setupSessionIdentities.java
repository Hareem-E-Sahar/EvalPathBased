...
file key pair provider SimpleName SimpleType TypeLiteral MethodInvocation SimpleName get simple name
get simple name SimpleName MethodInvocation InfixExpression StringLiteral client identities provider
...
provider SimpleName VariableDeclarationFragment ClassInstanceCreation SimpleType SimpleName file key pair provider
...
file key pair provider SimpleName SimpleType MethodDeclaration SimpleName setup session identities
file key pair provider SimpleName SimpleType MethodDeclaration SingleVariableDeclaration SimpleName client
file key pair provider SimpleName SimpleType MethodDeclaration SingleVariableDeclaration SimpleName identities
file key pair provider SimpleName SimpleType MethodDeclaration SingleVariableDeclaration SimpleName stdin
file key pair provider SimpleName SimpleType MethodDeclaration SingleVariableDeclaration SimpleName stdout
