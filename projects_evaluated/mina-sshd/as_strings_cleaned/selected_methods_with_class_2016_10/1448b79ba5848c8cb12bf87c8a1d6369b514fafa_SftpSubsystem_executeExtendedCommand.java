...
buffer SimpleName MethodInvocation SimpleName id
do open ssh hard link SimpleName MethodInvocation SimpleName buffer
do open ssh hard link SimpleName MethodInvocation SimpleName id
buffer SimpleName MethodInvocation SimpleName id
log SimpleName MethodInvocation SimpleName is debug enabled
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation StringLiteral execute extended command received unsupported ssh fxp extended
...
debug SimpleName MethodInvocation StringLiteral execute extended command received unsupported ssh fxp extended
debug SimpleName MethodInvocation MethodInvocation SimpleName get server session
debug SimpleName MethodInvocation SimpleName extension
execute extended command received unsupported ssh fxp extended StringLiteral MethodInvocation MethodInvocation SimpleName get server session
execute extended command received unsupported ssh fxp extended StringLiteral MethodInvocation SimpleName extension
get server session SimpleName MethodInvocation MethodInvocation SimpleName extension
...
sftp constantsext space available QualifiedName SwitchCase SwitchStatement SwitchCase QualifiedName hard link extension parsername
