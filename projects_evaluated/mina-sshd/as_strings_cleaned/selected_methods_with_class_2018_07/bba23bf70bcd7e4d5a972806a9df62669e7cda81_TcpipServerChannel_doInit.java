...
sshd socket address SimpleName SimpleType ClassInstanceCreation SimpleName originator ip address
sshd socket address SimpleName SimpleType ClassInstanceCreation SimpleName originator port
originator ip address SimpleName ClassInstanceCreation SimpleName originator port
originator address SimpleName Assignment ClassInstanceCreation SimpleType SimpleName sshd socket address
originator address SimpleName Assignment ClassInstanceCreation SimpleName originator ip address
originator address SimpleName Assignment ClassInstanceCreation SimpleName originator port
sshd socket address SimpleName SimpleType ClassInstanceCreation SimpleName host to connect
sshd socket address SimpleName SimpleType ClassInstanceCreation SimpleName port to connect
host to connect SimpleName ClassInstanceCreation SimpleName port to connect
tunnel entrance SimpleName Assignment ClassInstanceCreation SimpleType SimpleName sshd socket address
tunnel entrance SimpleName Assignment ClassInstanceCreation SimpleName host to connect
tunnel entrance SimpleName Assignment ClassInstanceCreation SimpleName port to connect
tunnel exit SimpleName Assignment SimpleName address
...
debug enabled SimpleName IfStatement Block ReturnStatement SimpleName f
