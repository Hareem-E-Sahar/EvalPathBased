...
destroy - mark as closed StringLiteral MethodInvocation SimpleName session
...
destroying SimpleName MethodInvocation SimpleName session
...
destroy failed ({}) to announce destruction event {} StringLiteral MethodInvocation SimpleName session
...
destroy StringLiteral InfixExpression SimpleName session
destroy StringLiteral InfixExpression StringLiteral ) destruction announcement failure details
session SimpleName InfixExpression StringLiteral ) destruction announcement failure details
log SimpleName MethodInvocation SimpleName debug
...
session SimpleName InfixExpression StringLiteral ) - cancel pending future
session SimpleName InfixExpression SimpleName result
...
session SimpleName InfixExpression StringLiteral ) - shutdown executor service - runners count
session SimpleName InfixExpression MethodInvocation SimpleName runners
...
session SimpleName InfixExpression StringLiteral ) closing the file system is not supported
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation InfixExpression StringLiteral destroy
log SimpleName MethodInvocation InfixExpression SimpleName session
...
session SimpleName InfixExpression StringLiteral )
session SimpleName InfixExpression StringLiteral to close file system
...
destroy SimpleName MethodDeclaration Block IfStatement SimpleName debug enabled
