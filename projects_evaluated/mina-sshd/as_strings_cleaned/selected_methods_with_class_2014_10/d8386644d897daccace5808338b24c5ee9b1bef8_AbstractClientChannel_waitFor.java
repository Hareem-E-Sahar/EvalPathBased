...
mask SimpleName ArrayInitializer SimpleName cond
...
log SimpleName MethodInvocation ArrayCreation ArrayInitializer SimpleName cond
trace SimpleName MethodInvocation StringLiteral wait for call returning on channel {} mask cond
trace SimpleName MethodInvocation ArrayCreation ArrayInitializer SimpleName mask
trace SimpleName MethodInvocation ArrayCreation ArrayInitializer SimpleName cond
wait for call returning on channel {} mask cond StringLiteral MethodInvocation ArrayCreation ArrayInitializer SimpleName mask
wait for call returning on channel {} mask cond StringLiteral MethodInvocation ArrayCreation ArrayInitializer SimpleName cond
...
trace SimpleName MethodInvocation ArrayCreation ArrayInitializer SimpleName mask
trace SimpleName MethodInvocation ArrayCreation ArrayInitializer SimpleName cond
waiting for lock on channel {} mask cond StringLiteral MethodInvocation ArrayCreation ArrayInitializer SimpleName mask
waiting for lock on channel {} mask cond StringLiteral MethodInvocation ArrayCreation ArrayInitializer SimpleName cond
timeout SimpleName InfixExpression NumberLiteral empty
...
int PrimitiveType VariableDeclarationStatement Block IfStatement SimpleName eof
