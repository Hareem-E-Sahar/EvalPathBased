...
os SimpleName MethodInvocation ArrayCreation ArrayType PrimitiveType byte
os SimpleName MethodInvocation ArrayCreation InfixExpression NumberLiteral empty
os SimpleName MethodInvocation ArrayCreation InfixExpression NumberLiteral empty
write SimpleName MethodInvocation ArrayCreation ArrayType PrimitiveType byte
write SimpleName MethodInvocation ArrayCreation InfixExpression NumberLiteral empty
write SimpleName MethodInvocation ArrayCreation InfixExpression NumberLiteral empty
...
is SimpleName MethodInvocation ArrayCreation ArrayType PrimitiveType byte
is SimpleName MethodInvocation ArrayCreation InfixExpression NumberLiteral empty
is SimpleName MethodInvocation ArrayCreation InfixExpression NumberLiteral empty
read SimpleName MethodInvocation ArrayCreation ArrayType PrimitiveType byte
read SimpleName MethodInvocation ArrayCreation InfixExpression NumberLiteral empty
read SimpleName MethodInvocation ArrayCreation InfixExpression NumberLiteral empty
is SimpleName MethodInvocation SimpleName read
