...
handling host event event type StringLiteral InfixExpression MethodInvocation MethodInvocation SimpleName event
handling host event event type StringLiteral InfixExpression MethodInvocation MethodInvocation SimpleName get type
handling host event event type StringLiteral InfixExpression MethodInvocation SimpleName name
handling host event event type StringLiteral InfixExpression StringLiteral event
handling host event event type StringLiteral InfixExpression MethodInvocation SimpleName event
handling host event event type StringLiteral InfixExpression MethodInvocation SimpleName to string
...
log SimpleName MethodInvocation InfixExpression StringLiteral handling host event event type
...
debug SimpleName MethodInvocation InfixExpression StringLiteral handling host event event type
...
host state SimpleName SimpleType VariableDeclarationStatement VariableDeclarationFragment SimpleName old state
...
cant handle host event at current state StringLiteral InfixExpression StringLiteral host
event SimpleName MethodInvocation SimpleName get type
cant handle host event at current state StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName get host name
host StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName get host name
cant handle host event at current state StringLiteral InfixExpression InfixExpression StringLiteral current state
host StringLiteral InfixExpression InfixExpression StringLiteral current state
cant handle host event at current state StringLiteral InfixExpression InfixExpression SimpleName old state
host StringLiteral InfixExpression InfixExpression SimpleName old state
cant handle host event at current state StringLiteral InfixExpression InfixExpression StringLiteral event type
host StringLiteral InfixExpression InfixExpression StringLiteral event type
cant handle host event at current state StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName event
cant handle host event at current state StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName get type
host StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName event
host StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName get type
...
log SimpleName MethodInvocation InfixExpression InfixExpression StringLiteral cant handle host event at current state
...
error SimpleName MethodInvocation InfixExpression InfixExpression StringLiteral cant handle host event at current state
error SimpleName MethodInvocation InfixExpression InfixExpression StringLiteral host
...
log SimpleName MethodInvocation SimpleName is debug enabled
host transitioned to a new state StringLiteral InfixExpression StringLiteral host
event SimpleName MethodInvocation SimpleName get type
event SimpleName MethodInvocation MethodInvocation SimpleName name
get type SimpleName MethodInvocation MethodInvocation SimpleName name
host transitioned to a new state StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName get host name
host StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName get host name
host transitioned to a new state StringLiteral InfixExpression InfixExpression StringLiteral old state
host StringLiteral InfixExpression InfixExpression StringLiteral old state
host transitioned to a new state StringLiteral InfixExpression InfixExpression SimpleName old state
host StringLiteral InfixExpression InfixExpression SimpleName old state
host transitioned to a new state StringLiteral InfixExpression InfixExpression StringLiteral current state
host StringLiteral InfixExpression InfixExpression StringLiteral current state
host transitioned to a new state StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName get state
host StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName get state
...
event StringLiteral InfixExpression SimpleName event
log SimpleName MethodInvocation SimpleName debug
log SimpleName MethodInvocation InfixExpression InfixExpression StringLiteral host transitioned to a new state
log SimpleName MethodInvocation InfixExpression InfixExpression StringLiteral host
log SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName get host name
...
log SimpleName MethodInvocation InfixExpression StringLiteral event
log SimpleName MethodInvocation InfixExpression SimpleName event
debug SimpleName MethodInvocation InfixExpression InfixExpression StringLiteral host transitioned to a new state
...
handle event SimpleName MethodDeclaration SingleVariableDeclaration SimpleType SimpleName host event
