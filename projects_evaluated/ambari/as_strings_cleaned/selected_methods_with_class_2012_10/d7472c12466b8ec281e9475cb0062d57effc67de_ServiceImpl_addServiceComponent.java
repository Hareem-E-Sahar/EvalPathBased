...
components SimpleName MethodInvocation MethodInvocation SimpleName component
components SimpleName MethodInvocation MethodInvocation SimpleName get name
contains key SimpleName MethodInvocation MethodInvocation SimpleName component
contains key SimpleName MethodInvocation MethodInvocation SimpleName get name
cannot add duplicate service component StringLiteral InfixExpression StringLiteral cluster name
cluster SimpleName MethodInvocation SimpleName get cluster name
cluster SimpleName MethodInvocation SimpleName get cluster id
component SimpleName MethodInvocation SimpleName get name
cannot add duplicate service component StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName cluster
cannot add duplicate service component StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName get cluster name
cluster name StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName cluster
cluster name StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName get cluster name
cannot add duplicate service component StringLiteral InfixExpression InfixExpression StringLiteral cluster id
cluster name StringLiteral InfixExpression InfixExpression StringLiteral cluster id
cannot add duplicate service component StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName cluster
cannot add duplicate service component StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName get cluster id
cluster name StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName cluster
cluster name StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName get cluster id
cannot add duplicate service component StringLiteral InfixExpression InfixExpression StringLiteral service name
cluster name StringLiteral InfixExpression InfixExpression StringLiteral service name
cannot add duplicate service component StringLiteral InfixExpression InfixExpression SimpleName service name
cluster name StringLiteral InfixExpression InfixExpression SimpleName service name
cluster SimpleName MethodInvocation InfixExpression StringLiteral cluster id
get cluster name SimpleName MethodInvocation InfixExpression StringLiteral cluster id
cluster SimpleName MethodInvocation InfixExpression MethodInvocation SimpleName cluster
...
add service component SimpleName MethodDeclaration SimpleType SimpleName ambari exception
component SimpleName SingleVariableDeclaration MethodDeclaration SimpleType SimpleName ambari exception
