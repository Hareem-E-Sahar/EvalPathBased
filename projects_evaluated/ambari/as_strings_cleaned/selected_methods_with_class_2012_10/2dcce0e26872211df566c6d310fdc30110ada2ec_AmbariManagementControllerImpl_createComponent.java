...
sc SimpleName Assignment MethodInvocation SimpleName s
sc SimpleName Assignment MethodInvocation SimpleName get service component
sc SimpleName Assignment MethodInvocation MethodInvocation SimpleName request
sc SimpleName Assignment MethodInvocation MethodInvocation SimpleName get component name
service component already exists StringLiteral InfixExpression StringLiteral within cluster
service component already exists StringLiteral InfixExpression StringLiteral cluster name
...
service component already exists StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName cluster
service component already exists StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName get cluster name
...
cluster name StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName get cluster name
service component already exists StringLiteral InfixExpression InfixExpression StringLiteral cluster id
...
service component already exists StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName cluster
service component already exists StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName get cluster id
within cluster StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName cluster
...
service component already exists StringLiteral InfixExpression InfixExpression StringLiteral service name
within cluster StringLiteral InfixExpression InfixExpression StringLiteral service name
cluster name StringLiteral InfixExpression InfixExpression StringLiteral service name
service component already exists StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName s
service component already exists StringLiteral InfixExpression InfixExpression MethodInvocation SimpleName get name
